...
###Load your SPI Image here####
memory download -file $EMUL_FC_DIR/bdk/thunder-emmc-ascii.img -instance tb.fc_wrapper.spi_mt25ql512a.sf_core.mem_0.i_memArray -apply
...
# Set GPIOs for SPI0 boot CS0, then CS1
# SPI0 CS0 = 2
reg setvalue tb.fc_wrapper.gpi_gpio_r[2:0]  0x2
# SPI0 CS1 = 3
reg setvalue tb.fc_wrapper.gpi_gpio_r[13:12]  0x1
reg setvalue tb.fc_wrapper.gpi_gpio_r[3]  0x1
