...
memory download -file  $EMUL_FC_DIR/bdk/bdk-boot.hex -instance tb.fc_wrapper.fc.dcp0.ddr01.lmc.mem -apply
...
#-- CSR configuration
memory download -file $EMUL_FC_DIR/preload/emul_fast_boot.exe.bin.bnk0_rom0 -instance tb.fc_wrapper.fc.roc.cpc.cpc.mem.rom.boot_rom.bnk0_rom0.rom -apply
memory download -file $EMUL_FC_DIR/preload/emul_fast_boot.exe.bin.bnk0_rom1 -instance tb.fc_wrapper.fc.roc.cpc.cpc.mem.rom.boot_rom.bnk0_rom1.rom -apply
memory download -file $EMUL_FC_DIR/preload/emul_fast_boot.exe.bin.bnk1_rom0 -instance tb.fc_wrapper.fc.roc.cpc.cpc.mem.rom.boot_rom.bnk1_rom0.rom -apply
memory download -file $EMUL_FC_DIR/preload/emul_fast_boot.exe.bin.bnk1_rom1 -instance tb.fc_wrapper.fc.roc.cpc.cpc.mem.rom.boot_rom.bnk1_rom1.rom -apply
...
reg setvalue {tb.fc_wrapper.fc.pcl.clu0.ap0.ap_frontend.ap_issue.ap_issue_ctl.ap_issue_csr.tbv_reset_address[63:0]} 0x2800000

# -- Core reset
trigger download $EMUL_DIR/utils/pp_reset.trigger -position 70
run
waitfor trigger
trigger delete
