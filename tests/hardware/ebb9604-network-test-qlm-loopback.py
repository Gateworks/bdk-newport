...
def run_traffic_gen(cnx):
    ...
    for port in port_list:
        ...
        try:
            ...
            return "FAIL-SCAN"
        try:
            perf_results = test_trafficgen.run_perf_test(cnx, [port])
...
def run_test(cnx):
    ...
    print
    print "---"
    print "EBB9604 with QLM loopbacks on QLM3, DLM4+DLM5, QLM6, QLM7"
    print "---"
...
main("ebb9604-network-test-qlm-loopback.log")
