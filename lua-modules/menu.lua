...
menu.node = octeontx.MASTER_NODE
...
-- If multiple nodes aren't available, sets menu.node to octeontx.MASTER_NODE. The
...
::retry::
        if not pending_input then
            ...
            if octeontx.csr and (pending_input:sub(1,3) == "csr") then
