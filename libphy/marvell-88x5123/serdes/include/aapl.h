...
#define aapl_log_printf(aapl, type, function, line, msg, arg, ...) aapl_log_printf_full(aapl, type, function, __AVAGO_FILENAME__, line, msg, arg)
...
#define aapl_fail(aapl, function, line, msg, arg, ...) aapl_fail_full(aapl, function, __AVAGO_FILENAME__, line, msg, arg)
#else /* WIN32*/
#if (!defined MV_HWS_BIN_HEADER)
        ...
        #define aapl_fail(aapl, function, line, msg, arg...) aapl_fail_full(aapl, function, __AVAGO_FILENAME__, line, msg, arg)
            ...
            #define aapl_fail(aapl, function, line, msg, arg...) aapl_fail_full(aapl, function)
        #else
            /* In FW side we do not contain the extra arguments in the log message*/
            #define aapl_log_printf(aapl, type, function, line, msg, arg...) aapl_log_printf_full(aapl, type, function, msg)
            #define aapl_fail(aapl, function, line, msg, arg...) aapl_fail_full(aapl, function, msg)
        #endif /* MICRO_INIT */
    #endif /* MV_HWS_REDUCED_BUILD_EXT_CM3 */
#else
    /** TODO - is there a need to handle MV_HWS_BIN_HEADER case? */
    #define aapl_log_printf(aapl, type, function, line, msg, arg...)
#endif /* (!defined MV_HWS_BIN_HEADER) */
#define aapl_check_ip_type(aapl, addr, function, line, error, args, arg...) aapl_check_ip_type_reduce(aapl, addr, error, args, arg)
#define aapl_check_firmware_rev(aapl, addr, function, line, error, args, arg...) aapl_check_firmware_rev_reduce(aapl, addr,  error, args, arg)
#define  aapl_check_process(aapl, addr, function, line, error, args, arg...)  (TRUE)
#endif
...
#else /* (!defined MV_HWS_BIN_HEADER) */
...
/** For CM3_BOBK device AAPL_MAX_RINGS should be defined as 1 */
/** For both modes: CPSS and MICRO_INIT. */
#define AAPL_MAX_RINGS 2
#endif
...
#endif /* MV_HWS_REDUCED_BUILD_EXT_CM3 */
#define AAPL_SERDES_INT_TIMEOUT        50000 /**< Maximum number of SBus reads to check for completion of SPICO interrupt command */
...
#define AVAGO_MG_ACCESS_THRESHOLD      5000     /**< Maximum "nop" to wait before any MG access */
#elif defined CM3
#ifdef MICRO_INIT
/*for micro init on cm3 enlarge the threshold. needed for loading FW at init.*/
#define AVAGO_MG_ACCESS_THRESHOLD      1000     /**< Maximum "nop" to wait before any MG access */
#else
#define AVAGO_MG_ACCESS_THRESHOLD      0        /**< Maximum "nop" to wait before any MG access */
#endif
#elif defined INTEL64_CPU
#define AVAGO_MG_ACCESS_THRESHOLD      50000    /**< Maximum "nop" to wait before any MG access */
#else
#define AVAGO_MG_ACCESS_THRESHOLD      12000    /**< Maximum "nop" to wait before any MG access */
#endif
...
#      define AAPL_REALLOC(ptr,sz) hdrealloc(ptr,sz)    /* AAPL uses this for realloc */
