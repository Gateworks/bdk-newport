...
EXT void spico_burst_upload(Aapl_t *aapl, uint sbus, uint reg, uint rom_size, const short *rom);
EXT int spico_upload_image(Aapl_t *aapl, uint sbus_addr, int words, const short rom[]);
