...
/* In FW side we do not contain the extra arguments in the log message*/
    ...
    EXT void aapl_log_printf_full(Aapl_t *aapl, Aapl_log_type_t log_sel, const char *caller, char* fileName, int line, const char * fmt, ...);
    EXT int  aapl_fail_full(Aapl_t *aapl, const char *caller, char * fileName, int line, const char *fmt, ...);
#else
        ...
        EXT int  aapl_fail_full(Aapl_t *aapl, const char *caller);
    #else
        /* In FW side we do not contain the extra arguments in the log message*/
        EXT void aapl_log_printf_full(Aapl_t *aapl, Aapl_log_type_t log_sel, const char *caller, const char * fmt);
        EXT int  aapl_fail_full(Aapl_t *aapl, const char *caller, const char *fmt);
    #endif
#endif
