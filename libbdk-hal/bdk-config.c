...
static bdk_config_info_t config_info[__BDK_CONFIG_END] = {
    ...
    [BDK_CONFIG_NETWORK_LED_LINK_SLOW] = {
        .format = "NETWORK-LED-LINK-SLOW.N%d.CGX%d.P%d", /* Parameters: Node, CGX, Port */
        .ctype = BDK_CONFIG_TYPE_STR,
    },
    [BDK_CONFIG_NETWORK_LED_LINK_FAST] = {
        .format = "NETWORK-LED-LINK-FAST.N%d.CGX%d.P%d", /* Parameters: Node, CGX, Port */
        .ctype = BDK_CONFIG_TYPE_STR,
    },
    [BDK_CONFIG_NETWORK_LED_ACTIVITY] = {
        .format = "NETWORK-LED-ACTIVITY.N%d.CGX%d.P%d", /* Parameters: Node, CGX, Port */
        .ctype = BDK_CONFIG_TYPE_STR,
    },
    [BDK_CONFIG_NETWORK_LED_ID] = {
        .format = "NETWORK-LED-ID.N%d.CGX%d.P%d", /* Parameters: Node, CGX, Port */
        .ctype = BDK_CONFIG_TYPE_STR,
    },
    [BDK_CONFIG_NETWORK_PORT] = {
        .format = "NETWORK-PORT.N%d.CGX%d.P%d", /* Parameters: Node, CGX, Port */
        .ctype = BDK_CONFIG_TYPE_STR,
    },
    [BDK_CONFIG_NETWORK_FLAGS] = {
        .format = "NETWORK-FLAGS.N%d.CGX%d.P%d", /* Parameters: Node, CGX, Port */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0, /* 0 = no flags, see help */
        .min_value = 0,
        .max_value = 0xffffffffll,
    },
    [BDK_CONFIG_NETWORK_LANE_ORDER] = {
        .format = "NETWORK-LANE-ORDER.N%d.CGX%d", /* Parameters: Node, CGX */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0x3210, /* 4 hex digits mapping lanes */
        .min_value = 0x0123,
        .max_value = 0x3333,
    },
    ...
    [BDK_CONFIG_BOOT_DEVICE] = {
        .format = "BOOT-DEVICE.N%d", /* String from of RST_BOOT_METHOD_E */
        .ctype = BDK_CONFIG_TYPE_STR,
    },
    [BDK_CONFIG_TRACE] = {
    ...
    [BDK_CONFIG_PCIE_PRESET_REQUEST_VECTOR] = {
        ...
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0x312, /* Value for PCIERCX_GEN3_EQ_CTL/PCIERCX_CFG554[PRV] */
        .min_value = 0,
        .max_value = 0xffff,
    },
    [BDK_CONFIG_PCIE_GEN2_DEEMPHASIS] = {
        .format = "PCIE-GEN2-DEEMPHASIS.N%d.PORT%d", /* Parameters: Node, Port */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0, /* Value for PCIERCX_LINK_CTL2[SDE] */
        .min_value = 0,
        .max_value = 1,
    },
    ...
    [BDK_CONFIG_PCIE_TX_PRESET_OVERRIDE_VECTOR] = {
        .format = "PCIE-TX-PRESET-TAP-OVERRIDE-VECTOR.N%d.PORT%d", /* Parameters: Node, Port */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0x393, /* Transmit Preset Vector To Use For GEN3  Tap Override 36412 */
        .min_value = 1,
        .max_value = 0x7FF,
    },
    [BDK_CONFIG_PCIE_ENDPOINT_TX_PRESET_OVERRIDE] = {
        .format = "PCIE-TX-PRESET-EP-OVERRIDE.N%d.PORT%d", /* Parameters: Node, Port */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0x4, /* Transmit Preset Override EP Mode Only Errata 36412 */
        .min_value = 0,
        .max_value = 10,
     },
     [BDK_CONFIG_PCIE_IDLE_REFSET_VALUE] = {
         .format = "PCIE-IDLE-REFSET-VALUE.N%d.QLM%d", /* Parameters: Node, QLM */
         .ctype = BDK_CONFIG_TYPE_INT,
         .default_value = 0x6, /* Electrical Idle Detect see page 2574 of HRM for values */
         .min_value = 0,
         .max_value = 0x1F,
      },
     [BDK_CONFIG_PCIE_RC_OVERRIDE_DETECT] = {
         .format = "PCIE-RC-OVERRIDE-DETECT.N%d.PORT%d", /* Parameters: Node, Port */
         .ctype = BDK_CONFIG_TYPE_INT,
         .default_value = 0, /* Flag to Override Rx Detect on Slot   */
         .min_value = 0,
         .max_value = 1,
     },
    ...
    [BDK_CONFIG_PCIE_EP_NUM_PFS] = {
        .format = "PCIE-EP-NUM-PFS.N%d.PORT%d", /* Parameters: Node, Port, see PCIEEPX_HIDE_PF */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 1, /* Normally 1 PF is plenty */
        .min_value = 1,
        .max_value = 16, /* Hardware supports up to 16 PFs */
    },
    [BDK_CONFIG_PCIE_EP_ID] = {
        .format = "PCIE-EP-ID.N%d.PORT%d", /* Parameters: Node, Port, see PCIEEPX_ID */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0xb200177d, /* Default for CN96XX */
        .min_value = 0,
        .max_value = 0xffffffff, /* 32 bit field */
    },
    [BDK_CONFIG_PCIE_EP_REV] = {
        .format = "PCIE-EP-REV.N%d.PORT%d", /* Parameters: Node, Port, see PCIEEPX_REV */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0x0b800000, /* Default for CN96XX */
        .min_value = 0,
        .max_value = 0xffffffff, /* 32 bit field */
    },
    [BDK_CONFIG_PCIE_EP_SUBSYS] = {
        .format = "PCIE-EP-SUBSYS.N%d.PORT%d", /* Parameters: Node, Port, see PCIEEPX_SUBSYS */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0xb200177d, /* Default for CN96XX */
        .min_value = 0,
        .max_value = 0xffffffff, /* 32 bit field */
    ...
    [BDK_CONFIG_PCIE_EP_BAR_SIZE] = {
        .format = "PCIE-EP-BAR%d-SIZE.N%d.PORT%d",  /* Parameters: BAR(0,2,4), Node, Port, see PCIEEPX_BAR* */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = -1, /* Default varies per BAR */
        .min_value = -1,
        .max_value = 33, /* Max of 8TB */
    },
    [BDK_CONFIG_PCIE_EP_ROM_SIZE] = {
        .format = "PCIE-EP-ROM-SIZE.N%d.PORT%d",  /* Parameters: Node, Port, see PCIEEPX_EROM_MASK and PEMX_EROM_SIZE */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0, /* Default to ROM disabled */
        .min_value = 0, /* Min is 64KB, but we need to allow zero */
        .max_value = 19, /* PSPI is limited to 512KB. NCB could go to 4MB, but we only support PSPI */
    },
    [BDK_CONFIG_PCIE_EP_NUM_VFS] = {
        .format = "PCIE-EP-NUM-VFS.N%d.PORT%d",   /* Parameters: Node, Port, see PCIEEPX_SRIOV_FO */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 128, /* Default to no SRIOV */
        .min_value = 0,
        .max_value = 240, /* Max of 16 */
    },
    [BDK_CONFIG_PCIE_EP_SRIOV_DEV] = {
        .format = "PCIE-EP-SRIOV-DEV.N%d.PORT%d", /* Parameters: Node, Port, see PCIEEPX_SRIOV_DEV */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0xb203, /* Default for CN96XX */
        .min_value = 0,
        .max_value = 0xffff, /* 16 bit field */
    },
    [BDK_CONFIG_PCIE_EP_SRIOV_BAR_SIZE] = {
        .format = "PCIE-EP-SRIOV-BAR%d.N%d.PORT%d", /* Parameters: BAR(0, 2, 4), Node, Port, see PCIEEPX_SRIOV_BAR */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = -1, /* Default varies per BAR */
        .min_value = 0,
        .max_value = 26, /* Max of 64MB */
    },
    ...
    [BDK_CONFIG_QLM_VOLTAGE] = {
        .format = "QLM-VOLTAGE.N%d", /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 900, /* 900mV */
        .min_value = 0,
        .max_value = 1200,
    },
    [BDK_CONFIG_QLM_MODE] = {
        .format = "QLM-MODE.N%d.QLM%d.LANE%d", /* Parameters: Node, QLM, Lane */
        .ctype = BDK_CONFIG_TYPE_STR,
    },
    [BDK_CONFIG_QLM_FREQ] = {
        .format = "QLM-FREQ.N%d.QLM%d.LANE%d", /* Parameters: Node, QLM, Lane */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0, /* Mhz */
        .min_value = 0,
        .max_value = 25781,
    ...
    [BDK_CONFIG_QLM_CLK] = {
        ...
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = BDK_QLM_CLK_LAST, /* 2 = External */
        .min_value = 0,
        .max_value = BDK_QLM_CLK_LAST,
    },
    [BDK_CONFIG_QLM_CLK_TERM] = {
        .format = "QLM-CLK-TERM.N%d.QLM%d", /* Parameters: Node, QLM */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = -1, /* Power down */
        .min_value = -1,
        .max_value = 3,
    },
    [BDK_CONFIG_QLM_TUNING_TX_SWING] = {
        .format = "QLM-TUNING-TX-SWING.N%d.QLM%d.LANE%d", /* Parameters: Node, QLM, Lane (CN8XXX only) */
        .ctype = BDK_CONFIG_TYPE_INT,
    ...
    [BDK_CONFIG_QLM_TUNING_TX_PREMPTAP] = {
        .format = "QLM-TUNING-TX-PREMPTAP.N%d.QLM%d.LANE%d", /* Parameters: Node, QLM, Lane (CN8XXX only) */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = -1, /* Default of no tuning */
        .min_value = -1,
        .max_value = 511,
    ...
    [BDK_CONFIG_QLM_TUNING_TX_GAIN] = {
        .format = "QLM-TUNING-TX-GAIN.N%d.QLM%d.LANE%d", /* Parameters: Node, QLM, Lane (CN8XXX only) */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = -1, /* Default of no tuning */
        .min_value = -1,
        .max_value = 7,
    ...
    [BDK_CONFIG_QLM_TUNING_TX_VBOOST] = {
        .format = "QLM-TUNING-TX-VBOOST.N%d.QLM%d.LANE%d", /* Parameters: Node, QLM, Lane (CN8XXX only) */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = -1, /* Default of no tuning */
        .min_value = -1,
        .max_value = 1,
    ...
    [BDK_CONFIG_QLM_CHANNEL_LOSS] = {
        .format = "QLM-CHANNEL-LOSS.N%d.QLM%d", /* Parameters: Node, QLM (CN8XXX only) */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = -1, /* Default will use recommended defaults */
        .min_value = -1,
        .max_value = 40,
    },
    [BDK_CONFIG_QLM_TUNING_TX_MAIN] = {
        .format = "QLM-TUNING-TX-MAIN.%s.%d.N%d.QLM%d.LANE%d", /* Parameters: QLM mode, QLM speed, Node, QLM, Lane (CN9XXX only) */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = -1, /* Default will use recommended defaults */
        .min_value = -1,
        .max_value = 48,
    ...
    [BDK_CONFIG_QLM_TUNING_TX_PRE] = {
        .format = "QLM-TUNING-TX-PRE.%s.%d.N%d.QLM%d.LANE%d", /* Parameters: QLM mode, QLM speed, Node, QLM, Lane (CN9XXX only) */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = -1, /* Default will use recommended defaults */
        .min_value = -1,
        .max_value = 12,
    ...
    [BDK_CONFIG_QLM_TUNING_TX_POST] = {
        .format = "QLM-TUNING-TX-POST.%s.%d.N%d.QLM%d.LANE%d", /* Parameters: QLM mode, QLM speed, Node, QLM, Lane (CN9XXX only) */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = -1, /* Default will use recommended defaults */
        .min_value = -1,
        .max_value = 16,
    ...
    [BDK_CONFIG_QLM_TUNING_TX_BS] = {
        .format = "QLM-TUNING-TX-BS.%s.%d.N%d.QLM%d.LANE%d", /* Parameters: QLM mode, QLM speed, Node, QLM, Lane (CN9XXX only) */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = -1, /* Default will use recommended defaults */
        .min_value = -1,
        .max_value = 63,
    ...
    [BDK_CONFIG_QLM_TUNING_RX_PREVGA_GN_ADAPT] = {
        .format = "QLM-LANE-RX-PREVGA-GN-ADAPT.N%d.QLM%d.LANE%d", /* Parameters: Node, QLM, Lane */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = -1, /* S/W default is selected */
        .min_value = -1,
        .max_value = 1,
    },
    [BDK_CONFIG_QLM_TUNING_RX_PREVGA_GN_OVRD] = {
        .format = "QLM-LANE-RX-PREVGA-GN-OVRD.N%d.QLM%d.LANE%d", /* Parameters: Node, QLM, Lane */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = -1, /* S/W default is selected */
        .min_value = -1,
        .max_value = 7,
    ...
    [BDK_CONFIG_QLM_LANE_RX_POLARITY] = {
        .format = "QLM-LANE-RX-POLARITY.N%d.QLM%d.LANE%d", /* Parameters: Node, QLM, Lane */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0, /* Default no polarity inversion */
        .min_value = 0,
        .max_value = 1,
    },
    [BDK_CONFIG_QLM_LANE_TX_POLARITY] = {
        .format = "QLM-LANE-TX-POLARITY.N%d.QLM%d.LANE%d", /* Parameters: Node, QLM, Lane */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0, /* Default no polarity inversion */
        .min_value = 0,
        .max_value = 1,
    ...
    [BDK_CONFIG_QLM_RX_ADAPTATION] = {
        .format = "QLM-RX-ADAPTATION.N%d.QLM%d.LANE%d", /* Parameters: Node, QLM, Lane */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 1, /* 1 = Do RX adatation by default */
        .min_value = 0,
        .max_value = 1,
    },
    ...
    [BDK_CONFIG_DDR_CUSTOM_RLEVEL_COMP_OFFSET] = {
        ...
        .ctype = BDK_CONFIG_TYPE_INT, // UDIMM or RDIMM
        .default_value = 0, // was: 2, primarily for DDR3
        .min_value = 0,
        .max_value = 0xffff,
    },
    ...
    [BDK_CONFIG_DDR_CUSTOM_DRAM_CONNECTION] = {
        .format = "DDR-CONFIG-CUSTOM-DRAM-CONNECTION.LMC%d.N%d", /* Parameters: LMC, Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0,
        .min_value = 0,
        .max_value = 1,
    ...
    [BDK_CONFIG_DDR_CUSTOM_DBI_MODE] = {
        .format = "DDR-CONFIG-CUSTOM-DBI-MODE.LMC%d.N%d", /* Parameters: LMC, Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0,
        .min_value = 0,
        .max_value = 1,
    ...
    [BDK_CONFIG_DDR_CUSTOM_PARITY_MODE] = {
        .format = "DDR-CONFIG-CUSTOM-PARITY-MODE.LMC%d.N%d", /* Parameters: LMC, Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0,
        .min_value = 0,
        .max_value = 1,
    ...
    [BDK_CONFIG_DDR_CUSTOM_DATA_INVERT] = {
        .format = "DDR-CONFIG-CUSTOM-DATA-INVERT.LMC%d.N%d", /* Parameters: LMC, Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0,
        .min_value = 0,
        .max_value = 1,
    ...
    [BDK_CONFIG_VRM_TEMP_TRIP] = {
        ...
        .max_value = 140, /* Degrees C. Max die temp plus 5 for uncertainty of measurement */
    },
    ...
    [BDK_CONFIG_RCLK_FREQ_MAX] = {
        .format = "RCLK-FREQ-MAX.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 500, /* MHz */
        .min_value = 500, /* MHz */
        .max_value = 3300, /* MHz */
    },
    [BDK_CONFIG_RCLK_FREQ_MIN] = {
        .format = "RCLK-FREQ-MIN.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 500, /* MHz */
        .min_value = 500, /* MHz */
        .max_value = 3300, /* MHz */
    ...
    [BDK_CONFIG_SCLK_FREQ] = {
        .format = "SCLK-FREQ.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 500, /* MHz */
        .min_value = 500, /* MHz */
        .max_value = 1200, /* MHz */
    ...
    [BDK_CONFIG_CPTCLK_FREQ] = {
        .format = "CPTCLK-FREQ.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 800, /* MHz */
        .min_value = 200, /* MHz */
        .max_value = 1600, /* MHz */
    },
    [BDK_CONFIG_BCLK_FREQ_MAX] = {
        .format = "BCLK-FREQ-MAX.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 500, /* MHz */
        .min_value = 300, /* MHz */
        .max_value = 1000, /* MHz */
    ...
    [BDK_CONFIG_BCLK_FREQ_MIN] = {
        .format = "BCLK-FREQ-MIN.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 500, /* MHz */
        .min_value = 300, /* MHz */
        .max_value = 1000, /* MHz */
    ...
    [BDK_CONFIG_DSPCLK_FREQ_MAX] = {
        .format = "DSPCLK-FREQ-MAX.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 500, /* MHz */
        .min_value = 300, /* MHz */
        .max_value = 1000, /* MHz */
    ...
    [BDK_CONFIG_DSPCLK_FREQ_MIN] = {
        .format = "DSPCLK-FREQ-MIN.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 500, /* MHz */
        .min_value = 300, /* MHz */
        .max_value = 1000, /* MHz */
    ...
    [BDK_CONFIG_VDD_CORE_TOLERANCE] = {
        .format = "VDD-CORE-TOLERANCE.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 8, /* mV */
        .min_value = 0, /* mV */
        .max_value = 100, /* mV */
    ...
    [BDK_CONFIG_VDD_CORE_RIPPLE] = {
        .format = "VDD-CORE-RIPPLE.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 21, /* mV */
        .min_value = -100, /* mV */
        .max_value = 100, /* mV */
    ...
    [BDK_CONFIG_VDD_CORE_COMPENSATION] = {
        .format = "VDD-CORE-COMPENSATION.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 100, /* % */
        .min_value = 1, /* % */
        .max_value = 1000, /* % */
    ...
    [BDK_CONFIG_VDD_SYS_TOLERANCE] = {
        .format = "VDD-SYS-TOLERANCE.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 8, /* mV */
        .min_value = 0, /* mV */
        .max_value = 100, /* mV */
    ...
    [BDK_CONFIG_VDD_SYS_RIPPLE] = {
        .format = "VDD-SYS-RIPPLE.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 21, /* mV */
        .min_value = -100, /* mV */
        .max_value = 100, /* mV */
    ...
    [BDK_CONFIG_VDD_SYS_COMPENSATION] = {
        .format = "VDD-SYS-COMPENSATION.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 100, /* % */
        .min_value = 1, /* % */
        .max_value = 1000, /* % */
    ...
    [BDK_CONFIG_DVFS_POWER_BUDGET] = {
        .format = "DVFS-POWER-BUDGET.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 100, /* Watts */
        .min_value = 0, /* Watts */
        .max_value = 150, /* Watts */
    },
    [BDK_CONFIG_DVFS_POWER_CONTROL_MODE] = {
        .format = "DVFS-POWER-CONTROL-MODE.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = BDK_CPC_DVFS_MODE_E_DVFS_OFF, /* Encoded CPC_DVFS_MODE_E */
        .min_value = BDK_CPC_DVFS_MODE_E_POWER_CAPPED, /* Encoded CPC_DVFS_MODE_E */
        .max_value = BDK_CPC_DVFS_MODE_E_DVFS_OFF, /* Encoded CPC_DVFS_MODE_E */
    },
    [BDK_CONFIG_DVFS_THERMAL_HOT] = {
        .format = "DVFS-THERMAL-HOT.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 100, /* Celsius */
        .min_value = 0, /* Celsius */
        .max_value = 140, /* Celsius */
    },
    [BDK_CONFIG_DVFS_THERMAL_HOT_BACKOFF] = {
        .format = "DVFS-THERMAL-HOT-BACKOFF.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 50, /* Percent */
        .min_value = 0, /* Percent */
    ...
    [BDK_CONFIG_SCP_FAILSAFE_TIMEOUT] = {
        .format = "SCP-FAILSAFE-TIMEOUT.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0, /* Seconds */
        .min_value = 0, /* Seconds */
        .max_value = 60, /* Seconds */
    },
    [BDK_CONFIG_SCP_UART_NUM] = {
        .format = "SCP-UART-NUM.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 1, /* Uart number */
        .min_value = 0, /* Uart number */
        .max_value = 0xf, /* Uart disabled */
    },
    [BDK_CONFIG_SCP_MCP_DISABLE] = {
        .format = "SCP-MCP-DISABLE.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0, /* Enabled */
        .min_value = 0, /* Enabled */
        .max_value = 1, /* Disabled */
    },
    [BDK_CONFIG_SCP_FORCE_SECONDARY_BOOT] = {
        .format = "SCP-FORCE-SECONDARY-BOOT.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0, /* Disabled */
        .min_value = 0, /* Disabled */
        .max_value = 1, /* Enabled */
    },
    [BDK_CONFIG_SCP_WAKEUP_MODE] = {
        .format = "SCP-WAKEUP-MODE.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 1, /* See CPC_WAKEUP_MODE_E */
        .min_value = 0, /* See CPC_WAKEUP_MODE_E */
        .max_value = 2, /* See CPC_WAKEUP_MODE_E */
    },
    [BDK_CONFIG_SCP_ACTIVE_THRESHOLD] = {
        .format = "SCP-ACTIVE-THRESHOLD.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 1000, /* Percent * 1000 */
        .min_value = 1, /* Percent * 1000 */
        .max_value = 32700, /* Percent * 1000 */
    },
    [BDK_CONFIG_SCP_FAIL_TIMEOUT] = {
        .format = "SCP-FAIL-TIMEOUT.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 10, /* Seconds */
        .min_value = 1, /* Seconds */
        .max_value = 600, /* Seconds */
    },
    [BDK_CONFIG_SCP_FAIL_ACTION] = {
        .format = "SCP-FAIL-ACTION.N%d",  /* Parameters: Node */
        .ctype = BDK_CONFIG_TYPE_INT,
        .default_value = 0, /* Encoded, 0=continue, 1=reboot, 2=halt */
        .min_value = 0, /* Encoded, 0=continue, 1=reboot, 2=halt */
        .max_value = 2, /* Encoded, 0=continue, 1=reboot, 2=halt */
    },
    ...
    [BDK_CONFIG_ATTESTATION_IMAGE_LIST] = {
        .format = "ATTESTATION-IMAGE-LIST",  /* No parameters */
        .ctype = BDK_CONFIG_TYPE_STR_LIST,
        .default_value = 0, /* Hardware default */
    },
};
 ...
 * @return The value of the configuration item, or def_value if the item is not set
 */
const char *bdk_config_get_str_va(bdk_config_t cfg_item, va_list args)
{
    /* Make sure the correct access function was called */
 ...
 *                 parameters are listed following cfg_item.
 */
void bdk_config_append_str(const char *value, bdk_config_t cfg_item, ...)
{
    /* Make sure the correct access function was called */
    if (config_info[cfg_item].ctype != BDK_CONFIG_TYPE_STR_LIST)
        bdk_fatal("bdk_config_append_str() called for %s, not a string list\n",
            config_info[cfg_item].format);
    ...
    int status = fdt_appendprop_string(config_fdt, config_node, name, value);

    if ((status < 0) && (status != -FDT_ERR_NOTFOUND))
        bdk_fatal("Failed to append %s=%s in FDT\n", name, value);
}
...
uint64_t __bdk_config_export_to_mem(void)
{
    ...
    {
        /* Address must be in cache area */
        int cache_size = bdk_dram_get_top_of_cache();
        void *cache_ptr = bdk_phys_to_ptr(cache_size - fdt_space);
        if (cache_ptr < fdt_ptr)
            fdt_ptr = cache_ptr;
        if (fdt_ptr < end_ptr)
        {
...
{
    int offset = fdt_path_offset(fdt, "/" BDK_DEVICE_TREE_ROOT); /* Find our node */
    if (offset < 0)
        return -1;
    free(config_fdt);
    config_fdt = fdt;
...
int bdk_config_expand_defaults(void *fdt)
{
    ...
    int fdt_node = fdt_path_offset(fdt, "/" BDK_DEVICE_TREE_ROOT); /* Find our node */
    if (fdt_node < 0)
    {
...
static void config_setup_fdt(void)
{
    ...
    config_node = fdt_add_subnode(config_fdt, 0, BDK_DEVICE_TREE_ROOT);
    if (config_node < 0)
        bdk_fatal("Unable to create %s node in FDT\n", BDK_DEVICE_TREE_ROOT);
}
...
static int config_parse_fdt(const void *fdt, const char *base_path)
{
    ...
    while (offset >= 0)
    {
        ...
        /* Don't copy Attestation information as it is built as we run */
        if (strcmp(name, config_info[BDK_CONFIG_ATTESTATION_IMAGE_LIST].format) != 0)
...
{
    uint64_t ftd_size = 0;
    bdk_signed_flags_t sign_flags = BDK_SIGNED_FLAG_NOT_ENCRYPTED;
    if (offset)
    ...
    if (config_parse_fdt(fdt, "/" BDK_DEVICE_TREE_ROOT))
    {
        free(fdt);
        return -1;
    }
...
void __bdk_config_init(void)
{
    ...
    /* Register X1 is expected to be a device tree when we boot. Check that
        ...
        ((__bdk_init_reg_x1 & 0xfff) == 0)) /* Aligned on a 4KB boundary */
    {
        ...
        else
        {
            ...
            if (crc32 == correct_crc32)
            {
                ...
                result = fdt_path_offset(fdt, "/" BDK_DEVICE_TREE_ROOT); /* Find our node */
            }
            else
            {
    ...
    if (bdk_is_platform(BDK_PLATFORM_ASIM))
    {
        ...
        else if (bdk_is_model(OCTEONTX_CN96XX_PASS1_X))
            bdk_config_set_str("ASIM-CN96XX-A0", BDK_CONFIG_BOARD_MODEL);
        else if (bdk_is_model(OCTEONTX_CN96XX_PASS3_X))
            bdk_config_set_str("ASIM-CN96XX-C0", BDK_CONFIG_BOARD_MODEL);
        else if (bdk_is_model(OCTEONTX_CNF95XX_PASS1_X))
            bdk_config_set_str("ASIM-CNF95XX-A0", BDK_CONFIG_BOARD_MODEL);
        else if (bdk_is_model(OCTEONTX_CNF95XX_PASS2_X))
            bdk_config_set_str("ASIM-CNF95XX-B0", BDK_CONFIG_BOARD_MODEL);
        else if (bdk_is_model(OCTEONTX_LOKI))
            bdk_config_set_str("ASIM-LOKI", BDK_CONFIG_BOARD_MODEL);
        else if (bdk_is_model(OCTEONTX_CN98XX))
            bdk_config_set_str("ASIM-CN98XX", BDK_CONFIG_BOARD_MODEL);
    }
    else if (bdk_is_platform(BDK_PLATFORM_EMULATOR))
    {
        if (bdk_is_model(OCTEONTX_CN83XX))
            ...
            bdk_config_set_str("EMUL-CN96XX", BDK_CONFIG_BOARD_MODEL);
        else if (bdk_is_model(OCTEONTX_CNF95XX))
            bdk_config_set_str("EMUL-CNF95XX", BDK_CONFIG_BOARD_MODEL);
        else if (bdk_is_model(OCTEONTX_LOKI))
            bdk_config_set_str("EMUL-LOKI", BDK_CONFIG_BOARD_MODEL);
        else if (bdk_is_model(OCTEONTX_CN98XX))
            bdk_config_set_str("EMUL-CN98XX", BDK_CONFIG_BOARD_MODEL);
    }
    ...
    {
        char filename[64];
        snprintf(filename, sizeof(filename), "/fatfs/dtb/%s-%s.dtb", model, revision);
        if (config_load_file(filename, 0) == 0)
            goto done;
    }
    ...
    {
        char filename[64];
        snprintf(filename, sizeof(filename), "/fatfs/dtb/%s.dtb", model);
        if (config_load_file(filename, 0) == 0)
            goto done;
    }
