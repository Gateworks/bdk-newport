...
/*! \brief Preprocessor variable to relate field to word number in structure msmLineCrcCorruptionDisable in AQ_MsmSystemGeneralControlRegister_EUR */
#define AQ_MsmSystemGeneralControlRegister_EUR_msmLineCrcCorruptionDisable 1
/*! \brief Preprocessor variable to relate field to bit position in structure msmLineCrcCorruptionDisable in AQ_MsmSystemGeneralControlRegister_EUR */
#define bits_AQ_MsmSystemGeneralControlRegister_EUR_msmLineCrcCorruptionDisable u1.bits_1
/*! \brief Preprocessor variable to relate field to word position in structure msmLineCrcCorruptionDisable in AQ_MsmSystemGeneralControlRegister_EUR */
#define word_AQ_MsmSystemGeneralControlRegister_EUR_msmLineCrcCorruptionDisable u1.word_1
...
/*! \brief Preprocessor variable to relate field to word number in structure msmLineTxIpgReserved in AQ_MsmLineTxIpgControlRegister_EUR */
#define AQ_MsmLineTxIpgControlRegister_EUR_msmLineTxIpgReserved 1
/*! \brief Preprocessor variable to relate field to bit position in structure msmLineTxIpgReserved in AQ_MsmLineTxIpgControlRegister_EUR */
#define bits_AQ_MsmLineTxIpgControlRegister_EUR_msmLineTxIpgReserved u1.bits_1
/*! \brief Preprocessor variable to relate field to word position in structure msmLineTxIpgReserved in AQ_MsmLineTxIpgControlRegister_EUR */
#define word_AQ_MsmLineTxIpgControlRegister_EUR_msmLineTxIpgReserved u1.word_1
...
/*! \brief Preprocessor variable to relate field to word number in structure reserved_1 in AQ_GlobalCableDiagnosticStatus_EUR */
#define AQ_GlobalCableDiagnosticStatus_EUR_reserved_1 6
/*! \brief Preprocessor variable to relate field to bit position in structure reserved_1 in AQ_GlobalCableDiagnosticStatus_EUR */
#define bits_AQ_GlobalCableDiagnosticStatus_EUR_reserved_1 u6.bits_6
/*! \brief Preprocessor variable to relate field to word position in structure reserved_1 in AQ_GlobalCableDiagnosticStatus_EUR */
#define word_AQ_GlobalCableDiagnosticStatus_EUR_reserved_1 u6.word_6
...
/*! \brief Preprocessor variable to relate field to word number in structure reservedAlarms in AQ_GlobalAlarms_EUR */
#define AQ_GlobalAlarms_EUR_reservedAlarms 1
/*! \brief Preprocessor variable to relate field to bit position in structure reservedAlarms in AQ_GlobalAlarms_EUR */
#define bits_AQ_GlobalAlarms_EUR_reservedAlarms u1.bits_1
/*! \brief Preprocessor variable to relate field to word position in structure reservedAlarms in AQ_GlobalAlarms_EUR */
#define word_AQ_GlobalAlarms_EUR_reservedAlarms u1.word_1
...
/*! \brief Preprocessor variable to relate field to word number in structure reservedAlarmsMask in AQ_GlobalInterruptMask_EUR */
#define AQ_GlobalInterruptMask_EUR_reservedAlarmsMask 1
/*! \brief Preprocessor variable to relate field to bit position in structure reservedAlarmsMask in AQ_GlobalInterruptMask_EUR */
#define bits_AQ_GlobalInterruptMask_EUR_reservedAlarmsMask u1.bits_1
/*! \brief Preprocessor variable to relate field to word position in structure reservedAlarmsMask in AQ_GlobalInterruptMask_EUR */
#define word_AQ_GlobalInterruptMask_EUR_reservedAlarmsMask u1.word_1
