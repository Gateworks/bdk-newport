...
typedef struct 
{
  ...
  union
  {
    struct
    {
                    /*! \brief 01.0007.5:0 ROS PMA Device Type [5:0]
                 ...
                 <B>Notes:</B>
                        This is always set to 0x09 as the PHY is a 10GBASE-T device.
                          ...
                          */
      unsigned int   pmaDeviceType : 6;    /* 01.0007.5:0  ROS      Default = 0x09 */
                     /* [5:0]
                        5 4 3 2 1 0
                        1 1 0 0 0 1 = 5GBASE-T PMA/PMD type
                        1 1 0 0 0 0 = 2.5GBASE-T PMA/PMD type
                        ...
                        0 0 0 0 0 1 = 10GBASE-EW PMA/PMD type
                        0 0 0 0 0 0 = 10GBASE-CX4 PMA/PMD type  */
                    /*! \brief 01.0007.F:6 ROS Reserved_7 [F:6]
  ...
  */
      unsigned int   reserved7 : 10;    /* 01.0007.F:6  ROS      Default = 0x000 */
                     /* Reserved bits 15 to 6  */
    } bits_0;
    uint16_t word_0;
  } u0;
...
typedef struct 
{
  ...
  */
      unsigned int   _5gbase_tAbility : 1;    /* 01.0015.1  ROS      Default = 0x1 */
                     /* 1 = PMA/PMD is able to perform 5GBASE-T
                        0 = PMA/PMD is not able to perform 5GBASE-T  */
                    /*! \brief 01.0015.F:2 R/WPD Reserved_15 [F:2]
                        ...
                        Reserved bits [15:2]
  */
      unsigned int   reserved15 : 14;    /* 01.0015.F:2  R/WPD      Provisionable Default = 0x0000 */
                     /* Reserved bits [15:2]  */
    } bits_0;
    uint16_t word_0;
  } u0;
...
} AQ_PmaTransmitVendorLASI_InterruptMask_EUR;
