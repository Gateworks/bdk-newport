...
)
{
  ...
  */
  /* REGDOC: Read bitfield (HHD/APPIA/EUR: 1D.C305.0) */
  AQ_API_Get(port->PHY_ID, AQ_GbePhyWolControl, wakeUpFrameDetectionEnable, wakeUpFrameEnable);
  ...
  /* REGDOC: Read bitfield (HHD/APPIA/EUR: 1D.C338.0) */
  AQ_API_Get(port->PHY_ID, AQ_GbePhyWolControl, magicPacketFrameDetectionEnable, i);
...
)
{
  ...
  uint16_t j, wakeUpMaskActive[5], wakeUpFrameEnable;
  uint16_t i, lsw, msw;
  ...
  wakeUpMaskActive[0] = ((configuration->wakeUpFrame[0].filter0
                       || configuration->wakeUpFrame[0].filter1
                       || configuration->wakeUpFrame[0].filter2
                       || configuration->wakeUpFrame[0].filter3) && configuration->wakeUpFrame[0].enable) ? 1 : 0;
  wakeUpMaskActive[1] = ((configuration->wakeUpFrame[1].filter0
                       || configuration->wakeUpFrame[1].filter1
                       || configuration->wakeUpFrame[1].filter2
                       || configuration->wakeUpFrame[1].filter3) && configuration->wakeUpFrame[1].enable) ? 1 : 0;
  wakeUpMaskActive[2] = ((configuration->wakeUpFrame[2].filter0
                       || configuration->wakeUpFrame[2].filter1
                       || configuration->wakeUpFrame[2].filter2
                       || configuration->wakeUpFrame[2].filter3) && configuration->wakeUpFrame[2].enable) ? 1 : 0;
  wakeUpMaskActive[3] = ((configuration->wakeUpFrame[3].filter0
                       || configuration->wakeUpFrame[3].filter1
                       || configuration->wakeUpFrame[3].filter2
                       || configuration->wakeUpFrame[3].filter3) && configuration->wakeUpFrame[3].enable) ? 1 : 0;
  wakeUpMaskActive[4] = ((configuration->wakeUpFrame[4].filter0
                       || configuration->wakeUpFrame[4].filter1
                       || configuration->wakeUpFrame[4].filter2
                       || configuration->wakeUpFrame[4].filter3) && configuration->wakeUpFrame[4].enable) ? 1 : 0;
  wakeUpFrameEnable = (wakeUpMaskActive[0] | wakeUpMaskActive[1] | wakeUpMaskActive[2]
                     | wakeUpMaskActive[3] | wakeUpMaskActive[4]) ? 1 : 0;
  /* REGDOC: Read-Modify-Write bitfield (HHD/APPIA/EUR: 1D.C305.0) */
  AQ_API_Set(port->PHY_ID, AQ_GbePhyWolControl, wakeUpFrameDetectionEnable, wakeUpFrameEnable);
  ...
  */
  ...
  /* REGDOC: Read-Modify-Write bitfield (HHD/APPIA/EUR: 1D.C338.0) */
  AQ_API_Set(port->PHY_ID, AQ_GbePhyWolControl, magicPacketFrameDetectionEnable, i);
...
/* declare a prototype for AQ_API_DetermineFLASH_TypeStandalone() which is found below */
...
/* declare a prototype for AQ_API_ReadFlashImageOfKnownFLASH() which is found below */
...
)
{
  ...
  AQ_API_Set(port->PHY_ID, AQ_AutonegotiationReservedVendorProvisioning, wolEnable, 0);
  /* REGDOC: Read-Modify-Write bitfield (HHD/APPIA/EUR: 1D.C305.0) */
  AQ_API_Set(port->PHY_ID, AQ_GbePhyWolControl, wakeUpFrameDetectionEnable, 0);
  /* REGDOC: Read-Modify-Write bitfield (HHD/APPIA/EUR: 1D.C338.0) */
  AQ_API_Set(port->PHY_ID, AQ_GbePhyWolControl, magicPacketFrameDetectionEnable, 0);
...
)
{
  ...
  AQ_API_Variable(AQ_PcsReceiveXfi1VendorState)
  AQ_API_Variable(AQ_PcsTransmitXfi1VendorState)
    ...
    case AQ_API_10G_SOM_XFI:
      switch (port->device)
      {
        ...
        case AQ_DEVICE_HHD:
          ...
          {
            /*get the good Tx Ethernet frames*/
            /* REGDOC: Read bitfield (HHD/APPIA/EUR: 03.E871.9:0) */
            AQ_API_Get(port->PHY_ID, AQ_PcsReceiveXfi1VendorState, xfi1GoodFrameCounterMSW, msw);
            /* REGDOC: Read bitfield (HHD/APPIA/EUR: 03.E870.F:0) */
            AQ_API_Get(port->PHY_ID, AQ_PcsReceiveXfi1VendorState, xfi1GoodFrameCounterLSW, lsw);
            connectionStatus->sysIntfGoodTxEthernetFrames = (msw << 16) | lsw;
          
            /*get the bad Tx Ethernet frames*/
            /* REGDOC: Read bitfield (HHD/APPIA/EUR: 03.E873.9:0) */
            AQ_API_Get(port->PHY_ID, AQ_PcsReceiveXfi1VendorState, xfi1BadFrameCounterMSW, msw);
            /* REGDOC: Read bitfield (HHD/APPIA/EUR: 03.E872.F:0) */
            AQ_API_Get(port->PHY_ID, AQ_PcsReceiveXfi1VendorState, xfi1BadFrameCounterLSW, lsw);
            connectionStatus->sysIntfBadTxEthernetFrames = (msw << 16) | lsw;
          
            /*get the good Rx Ethernet frames*/
            /* REGDOC: Read bitfield (HHD/APPIA/EUR: 03.C871.9:0) */
            AQ_API_Get(port->PHY_ID, AQ_PcsTransmitXfi1VendorState, xfi1GoodFrameCounterMSW, msw);
            /* REGDOC: Read bitfield (HHD/APPIA/EUR: 03.C870.F:0) */
            AQ_API_Get(port->PHY_ID, AQ_PcsTransmitXfi1VendorState, xfi1GoodFrameCounterLSW, lsw);
            connectionStatus->sysIntfGoodRxEthernetFrames = (msw << 16) | lsw;
          
            /*get the bad Rx Ethernet frames*/
            /* REGDOC: Read bitfield (HHD/APPIA/EUR: 03.C873.9:0) */
            AQ_API_Get(port->PHY_ID, AQ_PcsTransmitXfi1VendorState, xfi1BadFrameCounterMSW, msw);
            /* REGDOC: Read bitfield (HHD/APPIA/EUR: 03.C872.F:0) */
            AQ_API_Get(port->PHY_ID, AQ_PcsTransmitXfi1VendorState, xfi1BadFrameCounterLSW, lsw);
            connectionStatus->sysIntfBadRxEthernetFrames = (msw << 16) | lsw;
          }
          else
          {
...
)
{
  ...
  /* REGDOC: Read bitfield (HHD/APPIA/EUR: 07.0021.B) */
  AQ_API_Get(port->PHY_ID, AQ_Autonegotiation10GBaseT_StatusRegister, linkPartner10GBaseT_Ability, i);
  linkPartnerStatus->_10GBASE_T = i ? True : False;
    ...
    if (AQ_API_BitfieldOfLocalStruct(AQ_GlobalChip_wideVendorInterruptFlags, globalChip_wideVendorInterruptFlags, gbeVendorAlarmInterrupt))
    {
      ...
      if (AQ_API_BitfieldOfLocalStruct(AQ_GbePhyVendorGlobalInterruptFlags, gbePhyVendorGlobalInterruptFlags, vendorSpecificSgmiiTxAlarms_1Interrupt))
      {
        ...
        if (AQ_API_BitfieldOfLocalStruct(AQ_GbePhySgmiiTxAlarms, gbePhyTxAlarms, sgmii0MagicPacketFrameDetected)) alarmStatus->autonegotiationAlarms.wakeUpPacketDetected = True;
            /* REGDOC: Get local representation of bitfield (APPIA: 1D.E020.0) (HHD/EUR: 1D.EC20.0) */
        if (AQ_API_BitfieldOfLocalStruct(AQ_GbePhySgmiiTxAlarms, gbePhyTxAlarms, sgmii1WakeUpFrameDetected)) alarmStatus->autonegotiationAlarms.wakeUpFrameDetected = True;
            /* REGDOC: Get local representation of bitfield (APPIA: 1D.E020.1) (HHD/EUR: 1D.EC20.1) */
        if (AQ_API_BitfieldOfLocalStruct(AQ_GbePhySgmiiTxAlarms, gbePhyTxAlarms, sgmii1MagicPacketFrameDetected)) alarmStatus->autonegotiationAlarms.wakeUpPacketDetected = True;
      }
      ...
      if (AQ_API_BitfieldOfLocalStruct(AQ_GbePhyVendorGlobalInterruptFlags, gbePhyVendorGlobalInterruptFlags, vendorSpecificSgmiiRxAlarms_1Interrupt))
      {
        ...
        if (AQ_API_BitfieldOfLocalStruct(AQ_GbePhySgmiiRxAlarms, gbePhyRxAlarms, sgmii0RxLossOfSignal)) alarmStatus->SGMII0_Alarms.lossOfSignal = True;
            /* REGDOC: Get local representation of bitfield (APPIA: 1D.E010.0) (HHD/EUR: 1D.EC10.0) */
        if (AQ_API_BitfieldOfLocalStruct(AQ_GbePhySgmiiRxAlarms, gbePhyRxAlarms, sgmii1RxCodeViolationError)) alarmStatus->SGMII1_Alarms.codeViolationError = True;
            /* REGDOC: Get local representation of bitfield (APPIA: 1D.E010.1) (HHD/EUR: 1D.EC10.1) */
        if (AQ_API_BitfieldOfLocalStruct(AQ_GbePhySgmiiRxAlarms, gbePhyRxAlarms, sgmii1RxRunningDisparityError)) alarmStatus->SGMII1_Alarms.runningDisparityError = True;
            /* REGDOC: Get local representation of bitfield (APPIA: 1D.E010.3) (HHD/EUR: 1D.EC10.3) */
        if (AQ_API_BitfieldOfLocalStruct(AQ_GbePhySgmiiRxAlarms, gbePhyRxAlarms, sgmii1RxLossOfSignal)) alarmStatus->SGMII1_Alarms.lossOfSignal = True;
      }
    }
    ...
    if (AQ_API_BitfieldOfLocalStruct(AQ_GlobalChip_wideVendorInterruptFlags, globalChip_wideVendorInterruptFlags, pcsVendorAlarmInterrupt))
    {
      ...
      if (AQ_API_BitfieldOfLocalStruct(AQ_PcsVendorGlobalInterruptFlags, pcsVendorGlobalInterruptFlags, vendorSpecificRxAlarms_6Interrupt))
      {
        ...
        if (AQ_API_BitfieldOfLocalStruct(AQ_PcsReceiveVendorAlarms, pcsReceiveVendorAlarms, xfi0Invalid_66bCharacterReceived)) alarmStatus->XFI0_Alarms.invalid66B_Block = True;
            /* REGDOC: Get local representation of bitfield (HHD/APPIA/EUR: 03.EC05.B) */
        if (AQ_API_BitfieldOfLocalStruct(AQ_PcsReceiveVendorAlarms, pcsReceiveVendorAlarms, xfi1Invalid_66bCharacterReceived)) alarmStatus->XFI1_Alarms.invalid66B_Block = True;
      }
      ...
      if (AQ_API_BitfieldOfLocalStruct(AQ_PcsVendorGlobalInterruptFlags, pcsVendorGlobalInterruptFlags, vendorSpecificRxAlarms_7Interrupt))
      {
        ...
        if (AQ_API_BitfieldOfLocalStruct(AQ_PcsReceiveVendorAlarms, pcsReceiveVendorAlarms, xfi0HighBerStatus)) alarmStatus->XFI0_Alarms.highBer = True;
             /* REGDOC: Get local representation of bitfield (HHD/APPIA/EUR: 03.EC06.4) */
        if (!AQ_API_BitfieldOfLocalStruct(AQ_PcsReceiveVendorAlarms, pcsReceiveVendorAlarms, xfi1BlockLockStatus)) alarmStatus->XFI1_Alarms.lossOfBlockLock = True;
            /* REGDOC: Get local representation of bitfield (HHD/APPIA/EUR: 03.EC06.5) */
        if (AQ_API_BitfieldOfLocalStruct(AQ_PcsReceiveVendorAlarms, pcsReceiveVendorAlarms, xfi1HighBerStatus)) alarmStatus->XFI1_Alarms.highBer = True;
      }
    }
  }
...
)
{
  ...
  /* REGDOC: Read bitfield (HHD/APPIA/EUR: 1D.F410.0) */
  AQ_API_Get(port->PHY_ID, AQ_GbePhySgmiiRxInterruptMask, sgmii1RxCodeViolationErrorMask, i);
  alarmControl->SGMII1_AlarmMask.codeViolationError = i ? True : False;
  /* REGDOC: Read bitfield (HHD/APPIA/EUR: 1D.F410.1) */
  AQ_API_Get(port->PHY_ID, AQ_GbePhySgmiiRxInterruptMask, sgmii1RxRunningDisparityErrorMask, i);
  alarmControl->SGMII1_AlarmMask.runningDisparityError = i ? True : False;
  /* REGDOC: Read bitfield (HHD/APPIA/EUR: 1D.F410.3) */
  AQ_API_Get(port->PHY_ID, AQ_GbePhySgmiiRxInterruptMask, sgmii1RxLossOfSignalMask, i);
  ...
  /* REGDOC: Read bitfield (HHD/APPIA/EUR: 1D.F420.0) */
  AQ_API_Get(port->PHY_ID, AQ_GbePhySgmiiTxInterruptMask, sgmii1WakeUpFrameDetectedMask, i);
  alarmControl->autonegotiationAlarmMask.wakeUpFrameDetected = i ? True : False;
  /* REGDOC: Read bitfield (HHD/APPIA/EUR: 1D.F420.1) */
  AQ_API_Get(port->PHY_ID, AQ_GbePhySgmiiTxInterruptMask, sgmii1MagicPacketFrameDetectedMask, i);
  alarmControl->autonegotiationAlarmMask.wakeUpPacketDetected = i ? True : False;
  ...
  /* REGDOC: Read bitfield (HHD/APPIA/EUR: 03.F405.B) */
  AQ_API_Get(port->PHY_ID, AQ_PcsReceiveVendorInterruptMask, xfi1Invalid_66bCharacterReceivedMask, i);
  alarmControl->XFI1_AlarmMask.invalid66B_Block = i ? True : False;
  /* REGDOC: Read bitfield (HHD/APPIA/EUR: 03.F406.4) */
  AQ_API_Get(port->PHY_ID, AQ_PcsReceiveVendorInterruptMask, xfi1BlockLockStatusMask, i);
  alarmControl->XFI1_AlarmMask.lossOfBlockLock = i ? True : False;
  /* REGDOC: Read bitfield (HHD/APPIA/EUR: 03.F406.5) */
  AQ_API_Get(port->PHY_ID, AQ_PcsReceiveVendorInterruptMask, xfi1HighBerStatusMask, i);
...
)
{
  ...
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1D.F410.0) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GbePhySgmiiRxInterruptMask, gbePhyRxInterruptMask, sgmii1RxCodeViolationErrorMask, alarmControl->SGMII1_AlarmMask.codeViolationError ? 1 : 0);
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1D.F410.1) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GbePhySgmiiRxInterruptMask, gbePhyRxInterruptMask, sgmii1RxRunningDisparityErrorMask, alarmControl->SGMII1_AlarmMask.runningDisparityError ? 1 : 0);
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1D.F410.3) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GbePhySgmiiRxInterruptMask, gbePhyRxInterruptMask, sgmii1RxLossOfSignalMask, alarmControl->SGMII1_AlarmMask.lossOfSignal ? 1 : 0);
  ...
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1D.F420.0) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GbePhySgmiiTxInterruptMask, gbePhyTxInterruptMask, sgmii1WakeUpFrameDetectedMask, alarmControl->autonegotiationAlarmMask.wakeUpFrameDetected ? 1 : 0);
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1D.F420.1) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GbePhySgmiiTxInterruptMask, gbePhyTxInterruptMask, sgmii1MagicPacketFrameDetectedMask, alarmControl->autonegotiationAlarmMask.wakeUpPacketDetected ? 1 : 0);
  ...
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 03.F405.B) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_PcsReceiveVendorInterruptMask, pcsReceiveVendorInterruptMask, xfi1Invalid_66bCharacterReceivedMask, alarmControl->XFI1_AlarmMask.invalid66B_Block ? 1 : 0);
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 03.F406.4) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_PcsReceiveVendorInterruptMask, pcsReceiveVendorInterruptMask, xfi1BlockLockStatusMask, alarmControl->XFI1_AlarmMask.lossOfBlockLock ? 1 : 0);
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 03.F406.5) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_PcsReceiveVendorInterruptMask, pcsReceiveVendorInterruptMask, xfi1HighBerStatusMask, alarmControl->XFI1_AlarmMask.highBer ? 1 : 0);
  ...
  switch (port->device)
  {
    ...
    case AQ_DEVICE_EUR:
      ...
      AQ_API_WriteRegister_DeviceRestricted(HHD_EUR, port->PHY_ID, AQ_PhyXS_Receive_xauiTx_VendorInterruptMask, 1, 
          AQ_API_WordOfLocalStruct_DeviceRestricted(HHD, phyXS_Receive_xauiTx_VendorInterruptMask, 1));
      break;
  }  
 ...
 * control of the address length, and sets the FLASH clock frequency to 
 * 10 MHz. */
void AQ_TakeControlOfFLASH
(
    /*! The target PHY port.*/
  AQ_API_Port* port,
    /*! OUT: A pointer to uint16_t for storing the state of freezeNvrCrc */
...
)
{
  ...
  (*globalNVR_InterfacePrevious_word0) = 
    /* REGDOC: Read register (HHD/APPIA/EUR: 1E.0100) */
    AQ_API_ReadRegister(port->PHY_ID, AQ_GlobalNvrInterface, 0);
  /* REGDOC: Read bitfield (HHD/APPIA/EUR: 1E.0100.D) */
  AQ_API_Get(port->PHY_ID, AQ_GlobalNvrInterface, freezeNvrCrc, *NVR_CRC_Freeze);

  /* freeze the NVR CRC to preserve the image load CRC */
  /* REGDOC: Read-Modify-Write bitfield (HHD/APPIA/EUR: 1E.0100.D) */
  AQ_API_Set(port->PHY_ID, AQ_GlobalNvrInterface, freezeNvrCrc, 1);
  ...
  /* set the clock speed on the SPI to ~10 MHz and set the address length override so we can control the FLASH */
  ...
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrProvisioning, 
      globalNVR_Provisioning, nvrClockDivide, 0x10);
...
(
    /*! The target PHY port.*/
  AQ_API_Port* port,
    /*! IN: A pointer to the value of freezeNvrCrc that will be restored.*/
  uint16_t *NVR_CRC_Freeze,                                     
...
)
{
  ...
  /* REGDOC: Read-Modify-Write bitfield (HHD/APPIA/EUR: 1E.0100.D) */
  AQ_API_Set(port->PHY_ID, AQ_GlobalNvrInterface, freezeNvrCrc,*NVR_CRC_Freeze);
...
unsigned int AQ_FLASH_Ready (
    /*! The target PHY port.*/
  AQ_API_Port* port,
    /*! the maximum amount of time in seconds for the operation to take */
  uint16_t maxTime,
    /*! the 16-bit setting for AQ_GlobalNvrInterface.u0.word_0 to read the status register */
  uint16_t readStatusRegisterIF,
    /*! the 16-bit setting for AQ_GlobalNvrProvisioning.u0.word_0 to read the status register */
  uint16_t readStatusRegisterProv,
    /*! the 8 bit status register mask to isolate the RDY/BUSY* bit */
  uint16_t readStatusRegisterMask,
    /*! the polarity of the ready answer: 1 = Ready, 0 = Ready* */
  uint16_t readStatusRegisterPolarity
)
{
  AQ_API_DeclareLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface)
  ...
  /* REGDOC: Write register (HHD/APPIA/EUR: 1E.C450) */
  AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrProvisioning, 0, readStatusRegisterProv);
  while (1)
  {
    /* execute the status register instruction */
    /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100) */
    AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 0, readStatusRegisterIF);
    ...
    /* read the status register */
                     /* REGDOC: Read register (HHD/APPIA/EUR: 1E.0100 + 5) */
    statusRegister = AQ_API_ReadRegister(port->PHY_ID, AQ_GlobalNvrInterface, 5);
    if (readStatusRegisterPolarity)
    {
      /* busy when bit is zero */
      if ((statusRegister & readStatusRegisterMask) != 0) break;
    }
    else
    {
  ...
  #ifdef AQ_TIME_T_EXISTS
    if ((time(NULL) - startTime) >= maxTime) return AQ_RET_FLASH_READINESS_TIMEOUT;  /* time out */
  #else
    ...
    */
    ...
    {
      if (++secondsCounter >= maxTime) return AQ_RET_FLASH_READINESS_TIMEOUT;  /* time out */
      count = 0;
    }
  #endif
  }
...
)
{
  ...
  /* AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrProvisioning, globalNVR_Provisioning, nvrDummyLength, 0); */
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.C450.A:8) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrProvisioning, globalNVR_Provisioning, nvrDataLength, 3);            /* newer devices use 2-byte Device ID, followed by optional Extended Device ID */
  readDeviceID_Prov = AQ_API_WordOfLocalStruct(globalNVR_Provisioning, 0);
  ...
  if (AQ_FLASH_InterfaceReady (port) == AQ_RET_FLASHINTF_READY)
  {
    ...
    else if (manufacturerID == 0xC2)
    {
      ...
      {
        /* 4M - match is confirmed: exit */
        *flashType = AQ_API_F_MX25V4005C;
      #ifdef AQ_VERBOSE
        printf("FLASH type = Macronix MX25V4005C\n");
      #endif
        return AQ_RET_OK;
      }
    }
...
)
{
  ...
  AQ_TakeControlOfFLASH(port, &NVR_CRC_Freeze, &globalNVR_InterfacePrevious_word0, 
      &globalNVR_ProvisioningPrevious_word0, &globalNVR_ProvisioningPrevious_word1, 
      &globalControlPrevious_word1);
  retval = AQ_API_DetermineFLASH_Type(port, flashType);
  AQ_ReturnControlOfFLASH(port, &NVR_CRC_Freeze, &globalNVR_InterfacePrevious_word0, 
      &globalNVR_ProvisioningPrevious_word0, &globalNVR_ProvisioningPrevious_word1,
      &globalControlPrevious_word1);
...
(  
  ...
  AQ_API_Port* port,
    /*! The FLASH type */
  AQ_API_FLASH flashType,
  uint16_t* chipEraseOpcode,               /*!< OUT */
  uint16_t* writeEnableOpcode,             /*!< OUT */
  uint16_t* writeStatusOpcode,             /*!< OUT */
  uint16_t* disableProtData,               /*!< OUT */
  uint16_t* readStatusOpcode,              /*!< OUT */
  uint16_t* readStatusRegisterMask,        /*!< OUT */
  uint16_t* readStatusRegisterPolarity,    /*!< OUT */
  uint16_t* readOpcode,                    /*!< OUT */
  uint16_t* programOpcode,                 /*!< OUT */
  uint16_t* pageSize,                      /*!< OUT */
  uint16_t* maxOperationTime,              /*!< OUT */
  uint16_t* writeEnableIF,                 /*!< OUT */
  uint16_t* writeEnableProv,               /*!< OUT */
  uint16_t* chipEraseIF,                   /*!< OUT */
  uint16_t* chipEraseProv,                 /*!< OUT */
  uint16_t* disableProtIF,                 /*!< OUT */
  uint16_t* disableProtProv,               /*!< OUT */
  uint16_t* readStatusRegisterIF,          /*!< OUT */
  uint16_t* readStatusRegisterProv,        /*!< OUT */
  uint16_t* nonburstRead4_IF,              /*!< OUT */
  uint16_t* nonburstRead4_Prov,            /*!< OUT */
  uint16_t* burstRead4_IF,                 /*!< OUT */
  uint16_t* burstRead4_Prov,               /*!< OUT */
  uint16_t* burstWrite4_IF,                /*!< OUT */
  uint16_t* burstWrite4_Prov,              /*!< OUT */
  uint16_t* read1_IF,                      /*!< OUT */
  uint16_t* read1_Prov,                    /*!< OUT */
  uint16_t* endBurst_IF,                   /*!< OUT */
  uint16_t* execOp_IF,                     /*!< OUT */
  uint16_t* set256_IF,                     /*!< OUT */
  uint16_t* set256_Prov,                   /*!< OUT */
  uint32_t* flashSize                      /*!< OUT */
)
{
  AQ_API_DeclareLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface)
  AQ_API_DeclareLocalStruct(AQ_GlobalNvrProvisioning, globalNVR_Provisioning)
  ...
  *chipEraseOpcode = 0x62;
  *writeEnableOpcode = 0x06;
  *writeStatusOpcode = 0x01;
  *disableProtData = 0x00;
  *readStatusOpcode = 0x05;
  *readStatusRegisterMask = 0x01;
  *readStatusRegisterPolarity = 0;
  *readOpcode = 0x03;
  *programOpcode = 0x02;
  *pageSize = 0x80;
  *maxOperationTime = 10;              /* The maximum operation time in seconds.  The estimated maximum time is 3 */
  *writeEnableIF = 0x00;
  *writeEnableProv = 0x00;
  *chipEraseIF = 0x00;
  *chipEraseProv = 0x00;
  *disableProtIF = 0x00;
  *disableProtProv = 0x00;
  *readStatusRegisterIF = 0x00;
  *readStatusRegisterProv = 0x00;
  *nonburstRead4_IF = 0x00;
  *nonburstRead4_Prov = 0x00;
  *burstRead4_IF = 0x00;
  *burstRead4_Prov = 0x00;
  *burstWrite4_IF = 0x00;
  *burstWrite4_Prov = 0x00;
  *read1_IF = 0x00;
  *read1_Prov = 0x00;
  *endBurst_IF = 0x00;
  *execOp_IF = 0x00;
  *flashSize = 0x00;
  ...
  switch (flashType)
  {
    case AQ_API_F_AT25F512A:
      ...
      *programOpcode = 0x02;
      *pageSize = 0x80;       /* 128 */
      *maxOperationTime = 10;  /* Maximum time should be 2.2s */
      *flashSize = 0x10000;    /* 64K */
      break;

    case AQ_API_F_AT45DB041D:
      /* Atmel smart 512K */
      *readStatusOpcode = 0xD7;
      *readStatusRegisterMask = 0x80;
      *readStatusRegisterPolarity = 1;
      *readOpcode = 0x03;
      *programOpcode = 0x82;   /* using buffer write with direct program and erase */
      *pageSize = 0x100;       /* 256 */
      *maxOperationTime = 10;   /* Maximum time should be 35 ms */
      *flashSize = 0x80000;    /* 512K */
      break;
    ...
    case AQ_API_F_M25P05A:
      ...
      *programOpcode = 0x02;
      *pageSize = 0x100;       /* 256 */
      *maxOperationTime = 10;   /* Maximum time should be 6s */
      *flashSize = 0x10000;    /* 64K */
      break;
    ...
    case AQ_API_F_AT25DF021A:
      ...
      *pageSize = 0x100;       /* 256 */
      *maxOperationTime = 10;
      *flashSize = 0x40000;    /* 256K */
      break;
      
    case AQ_API_F_AT25DF041A:
    case AQ_API_F_M25P40:
    case AQ_API_F_MX25V4005C:
      ...
      *programOpcode = 0x02;
      *pageSize = 0x100;       /* 256 */
      *maxOperationTime = 10;   /* AQ_API_F_MX25V4005C is 7.5s, the rest are 10s */
      *flashSize = 0x80000;    /* 512K */
      break;
  ...
  if ((flashType != AQ_API_F_AT45DB041D) && (flashType != AQ_API_F_AT45DB321E))
  {
    /* disable protection */
    AQ_API_AssignWordOfLocalStruct(globalNVR_Interface, 0, 0x0000);
    /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.7:0) */
    AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrOpcode, *writeStatusOpcode);
       /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.A) */
    /* AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrBurst, 0); */
       /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.E) */
    ...
    /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.F) */
    AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrExecuteOperation, 1);
    *disableProtIF = AQ_API_WordOfLocalStruct(globalNVR_Interface, 0);
    ...
    *disableProtProv = AQ_API_WordOfLocalStruct(globalNVR_Provisioning, 0);

    /* write enable */
    AQ_API_AssignWordOfLocalStruct(globalNVR_Interface, 0, 0x0000);
    /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.7:0) */
    AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrOpcode, *writeEnableOpcode);
       /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.A) */
    /* AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrBurst, 0); */
       /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.E) */
    /* AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrWriteMode, 0); */       /* 0 = read */
    /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.F) */
    AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrExecuteOperation, 1);
    *writeEnableIF = AQ_API_WordOfLocalStruct(globalNVR_Interface, 0);
    ...
    /* AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrProvisioning, globalNVR_Provisioning, nvrDummyLength, 0); */
       /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.C450.A:8) */
    /* AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrProvisioning, globalNVR_Provisioning, nvrDataLength, 0); */
    *writeEnableProv = AQ_API_WordOfLocalStruct(globalNVR_Provisioning, 0);

    /* chip erase */
    AQ_API_AssignWordOfLocalStruct(globalNVR_Interface, 0, 0x0000);
    /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.7:0) */
    AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrOpcode, *chipEraseOpcode);
       /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.A) */
    /* AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrBurst, 0); */
       /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.E) */
    /* AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrWriteMode, 0); */       /* 0 = read */
    /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.F) */
    AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrExecuteOperation, 1);
    *chipEraseIF = AQ_API_WordOfLocalStruct(globalNVR_Interface, 0);
    ...
    /* AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrProvisioning, globalNVR_Provisioning, nvrDummyLength, 0); */
       /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.C450.A:8) */
    /* AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrProvisioning, globalNVR_Provisioning, nvrDataLength, 0); */
    *chipEraseProv = AQ_API_WordOfLocalStruct(globalNVR_Provisioning, 0);
  }

  /* read status register */
  AQ_API_AssignWordOfLocalStruct(globalNVR_Interface, 0, 0x0000);
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.7:0) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrOpcode, *readStatusOpcode);
     /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.A) */
  /* AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrBurst, 0); */
     /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.E) */
  /* AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrWriteMode, 0); */       /* 0 = read */
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.F) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrExecuteOperation, 1);
  *readStatusRegisterIF = AQ_API_WordOfLocalStruct(globalNVR_Interface, 0);
  ...
  *readStatusRegisterProv = AQ_API_WordOfLocalStruct(globalNVR_Provisioning, 0);
  ...
  AQ_API_AssignWordOfLocalStruct(globalNVR_Interface, 0, 0x0000);
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.7:0) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrOpcode, *readOpcode);
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.A) */
  ...
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.F) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrExecuteOperation, 1);
  *burstRead4_IF = AQ_API_WordOfLocalStruct(globalNVR_Interface, 0);
  ...
  *burstRead4_Prov = AQ_API_WordOfLocalStruct(globalNVR_Provisioning, 0);
  ...
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.F) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrExecuteOperation, 1);
  *nonburstRead4_IF = AQ_API_WordOfLocalStruct(globalNVR_Interface, 0);
  *nonburstRead4_Prov = *burstRead4_Prov;
  ...
  *burstWrite4_IF = AQ_API_WordOfLocalStruct(globalNVR_Interface, 0);
  ...
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.C450.A:8) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrProvisioning, globalNVR_Provisioning, nvrDataLength, 4);
  *burstWrite4_Prov = AQ_API_WordOfLocalStruct(globalNVR_Provisioning, 0);
  ...
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.F) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrExecuteOperation, 1);
  *read1_IF = AQ_API_WordOfLocalStruct(globalNVR_Interface, 0);
  ...
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.C450.A:8) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrProvisioning, globalNVR_Provisioning, nvrDataLength, 1);
  *read1_Prov = AQ_API_WordOfLocalStruct(globalNVR_Provisioning, 0);
  ...
  *endBurst_IF = AQ_API_WordOfLocalStruct(globalNVR_Interface, 0);
  ...
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.F) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrExecuteOperation, 1); 
  *execOp_IF = AQ_API_WordOfLocalStruct(globalNVR_Interface, 0);
  ...
  /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.0100.F) */
  AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrInterface, globalNVR_Interface, nvrExecuteOperation, 1);
  *set256_IF = AQ_API_WordOfLocalStruct(globalNVR_Interface, 0);
  ...
  /* AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrProvisioning, globalNVR_Provisioning, nvrDummyLength, 0); */
     /* REGDOC: Assign to local representation of bitfield (HHD/APPIA/EUR: 1E.C450.A:8) */
  /* AQ_API_AssignBitfieldOfLocalStruct(AQ_GlobalNvrProvisioning, globalNVR_Provisioning, nvrDataLength, 0); */
  *set256_Prov = AQ_API_WordOfLocalStruct(globalNVR_Provisioning, 0);
...
)
{
  ...
  if (AQ_API_GetFlashParametersForKnownFLASH(
        ...
        &disableProtData,
        &readStatusOpcode,
        &readStatusRegisterMask,
        &readStatusRegisterPolarity,
        &readOpcode,
        &programOpcode,
        &pageSize,
        &maxOperationTime,
        ...
        &disableProtIF,
        &disableProtProv,
        &readStatusRegisterIF,
        &readStatusRegisterProv,
        &nonburstRead4_IF,
        &nonburstRead4_Prov,
        &burstRead4_IF,
        &burstRead4_Prov,
        ...
        &set256_IF,
        &set256_Prov,
        &flashSize) == AQ_RET_FLASH_TYPE_BAD) return AQ_RET_FLASH_TYPE_BAD;

  /* check to make sure the image size minus the 2 CRC bytes is not greater than the size of the FLASH */
  if (*imageSizePointer > flashSize + 2) return AQ_RET_FLASH_IMAGE_TOO_LARGE;
  ...
  if ((flashType != AQ_API_F_AT45DB041D) && (flashType != AQ_API_F_AT45DB321E))
  {
    ...
    /* REGDOC: Write register (HHD/APPIA/EUR: 1E.C450) */
    AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrProvisioning, 0, writeEnableProv);
    /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100) */
    AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 0, writeEnableIF);

    if (AQ_FLASH_Ready(port, maxOperationTime, readStatusRegisterIF, 
          readStatusRegisterProv, readStatusRegisterMask, 
          readStatusRegisterPolarity) == AQ_RET_FLASH_READINESS_TIMEOUT) 
    ...
    /* REGDOC: Write register (HHD/APPIA/EUR: 1E.C450) */
    AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrProvisioning, 0, disableProtProv);
    /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 3) */
    AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 3, disableProtData);       /* nvrAddressLSW */
    /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100) */
    AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 0, disableProtIF);
    ...
    /* REGDOC: Write register (HHD/APPIA/EUR: 1E.C450) */
    AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrProvisioning, 0, chipEraseProv);
    /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100) */
    AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 0, chipEraseIF);
  ...
  else
  {
    ...
    if ((statusRegister & 0x01) == 0)
    {
      ...
      /* execute the command */
      /* REGDOC: Write register (HHD/APPIA/EUR: 1E.C450) */
      AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrProvisioning, 0, set256_Prov);
      /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 2) */
      AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 2, 0x002A);       /* nvrAddressMSW */
      /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 3) */
      AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 3, 0x80A6);       /* nvrAddressLSW */
      /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100) */
      AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 0, set256_IF);
    ...
    #ifdef AQ_VERBOSE
      printf("Device page size is now set to 256 /512 bytes\n  - complete this operation by cycling the FLASH power supply");
    #endif
  ...
  pagePointer = 0x000000;
  addressPointer = 0x000000;
#ifdef AQ_VERBOSE
  ...
  countPendingOps = 0;
#endif
  while (addressPointer < imageSize-2)
  {
    /* 
    ...
    /* REGDOC: Write register (HHD/APPIA/EUR: 1E.C450) */
    AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrProvisioning, 0, burstWrite4_Prov);

    /* set the page start address: note this directly tracks the bytes in the image, so it is directly usable here */
    /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 2) */
    AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 2,((addressPointer >> 16) & 0xFF)); /* nvrAddressMSW */
    /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 3) */
    AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 3,(addressPointer & 0xFFFF));       /* nvrAddressLSW */
    ...
    #else
      /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 4) */
      AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 4, dataMSW);
      /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 5) */
      AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 5, dataLSW);
      /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100) */
    ...
    switch (bytesLeftInPage)
    {
      case 1:
        ...
        /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 5) */
        AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 5, dataWord);   
      ...
      case 3:
        ...
        /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 4) */
        AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 4, dataWord);   
        dataWord = (image[addressPointer+1] << 8) | image[addressPointer];
        /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 5) */
        AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 5, dataWord);   
        addressPointer += 3;
   ...
   * failure code. 
   */
  retval = AQ_API_VerifyFlashImageOfKnownFLASH(port, imageSizePointer, image, flashType);
...
)
{
  ...
  AQ_TakeControlOfFLASH(port, &NVR_CRC_Freeze, &globalNVR_InterfacePrevious_word0, 
      &globalNVR_ProvisioningPrevious_word0, &globalNVR_ProvisioningPrevious_word1, 
      &globalControlPrevious_word1);
  retcode = AQ_API_DetermineFLASH_Type(port, &flashType);
  ...
  retcode = AQ_API_WriteAndVerifyFlashImageOfKnownFLASH(port, flashType, imageSizePointer, image);
...
)
{
  ...
  switch (port->device)
  {
    ...
    case AQ_DEVICE_EUR:
      /* REGDOC: Write register (HHD/APPIA/EUR: 1E.C450) */
      AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrProvisioning, 0, burstRead4_Prov);
      break;

    case AQ_DEVICE_HHD:
      /* REGDOC: Write register (HHD/APPIA/EUR: 1E.C450) */
      AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrProvisioning, 0, nonburstRead4_Prov);
      break;
  }

  /* set the starting read address */
  /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 2) */
  AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 2, 0x0000);      /* nvrAddressMSW */
  /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 3) */
  AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 3, 0x0000);      /* nvrAddressLSW */
  ...
  imageDWordSize = (imageSize - 1 - 2) >> 2;
  ...
  for (i = 0; i < imageDWordSize; i++)      /* stop one prior to the end to allow the burst flag to be lowered */
  {
    ...
    switch (port->device)
    {
      ...
      case AQ_DEVICE_EUR:
        /* burst read method */
        AQ_API_BlockWriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 0, burstRead4_IF);
      ...
      case AQ_DEVICE_HHD:
        ...
        AQ_API_BlockWriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 0, nonburstRead4_IF);
        AQ_API_BlockReadRegister(port->PHY_ID, AQ_GlobalNvrInterface, 5);      /* LSW */
        AQ_API_BlockReadRegister(port->PHY_ID, AQ_GlobalNvrInterface, 4);      /* MSW */
    ...
    if (countPendingOps >= AQ_API_MDIO_MaxBlockOperations() - numOpsPerDwordRead) 
    {
      ...
      {
      #ifdef AQ_VERBOSE
        if (image[image_readBack_index] != (asyncReadResults[j] & 0xff)) printf("  Mismatch on byte 0x%X: Read 0x%X - Should be: 0x%X\n", image_readBack_index, asyncReadResults[j] & 0xff, image[image_readBack_index]);
      #endif
        crc16Calculated = ((crc16Calculated & 0xFF) << 8) ^ AQ_CRC16Table[(crc16Calculated >> 8) ^ (asyncReadResults[j] & 0xff)];
        image_readBack_index++;
        
      #ifdef AQ_VERBOSE
        if (image[image_readBack_index] != (asyncReadResults[j] >> 8)) printf("  Mismatch on byte 0x%X: Read 0x%X - Should be: 0x%X\n", image_readBack_index, asyncReadResults[j] >> 8, image[image_readBack_index]);
      #endif
        crc16Calculated = ((crc16Calculated & 0xFF) << 8) ^ AQ_CRC16Table[(crc16Calculated >> 8) ^ (asyncReadResults[j] >> 8)];
        image_readBack_index++;
      }
      countPendingReadResults = 0;
    }
    ...
    switch (port->device)
    {
      ...
      case AQ_DEVICE_EUR:
        /* burst read method */
        /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100) */
        AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 0, burstRead4_IF);
        break;
      ...
      case AQ_DEVICE_HHD:
        ...
        /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100) */
        AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 0, nonburstRead4_IF);
        break;
    }
  ...
  /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 2) */
  AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 2, (imageDWordSize * 4) >> 16);
  /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 3) */
  AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 3, (imageDWordSize * 4) & 0xFFFF);
  /* REGDOC: Read-Modify-Write bitfield (HHD/APPIA/EUR: 1E.0100.F) */
  AQ_API_Set(port->PHY_ID, AQ_GlobalNvrInterface, nvrExecuteOperation, 1);
  ...
  switch ((imageSize-2) & 0x3)
  {
    case 0x0:     /* this is actually 0x4! */
      /* read the 4 bytes of data and update the CRC-16*/
      /* REGDOC: Read bitfield (HHD/APPIA/EUR: 1E.0105.F:0) */
      AQ_API_Get(port->PHY_ID, AQ_GlobalNvrInterface, nvrDataLSW, j);
      
    #ifdef AQ_VERBOSE
      if (image[4*i] != (j & 0xFF)) printf("  Mismatch on byte 0x%X: Read 0x%X - Should be: 0x%X\n", (4*i), (j & 0xFF), image[4*i]);
      if (image[4*i+1] != (j >> 8)) printf("  Mismatch on byte 0x%X: Read 0x%X - Should be: 0x%X\n", (4*i+1), (j >> 8), image[4*i+1]);
    #endif
  
      crc16Calculated = ((crc16Calculated & 0xFF) << 8) ^ AQ_CRC16Table[(crc16Calculated >> 8) ^ (j & 0xFF)];
      crc16Calculated = ((crc16Calculated & 0xFF) << 8) ^ AQ_CRC16Table[(crc16Calculated >> 8) ^ (j >> 8)];
      /* REGDOC: Read bitfield (HHD/APPIA/EUR: 1E.0104.F:0) */
      AQ_API_Get(port->PHY_ID, AQ_GlobalNvrInterface, nvrDataMSW, j);
      
    #ifdef AQ_VERBOSE
      if (image[4*i+2] != (j & 0xFF)) printf("  Mismatch on byte 0x%X: Read 0x%X - Should be: 0x%X\n", (4*i+2), (j & 0xFF), image[4*i+2]);
      if (image[4*i+3] != (j >> 8))   printf("  Mismatch on byte 0x%X: Read 0x%X - Should be: 0x%X\n", (4*i+3), (j >> 8), image[4*i+3]);
    #endif
  ...
  if (crc16Calculated != crc16) return AQ_RET_FLASH_IMAGE_MISMATCH;     /* error on burning FLASH */
...
)
{
  ...
  retcode = AQ_API_VerifyFlashImageOfKnownFLASH(port, imageSizePointer, image, flashType);
...
)
{
  ...
  retcode = AQ_API_ReadFlashImageOfKnownFLASH(port, flashType, startAddress, imageSizePointer, image);
...
)
{
  ...
  /* set the starting read address */
  /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 2) */
  AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 2, (*startAddress) >> 16);    /* nvrAddressMSW */
  /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 3) */
  AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 3, (*startAddress) & 0xffff); /* nvrAddressLSW */
  ...
  /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 2) */
  AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 2, 
      ((*startAddress) + (imageDWordSize * 4)) >> 16);    /* nvrAddressMSW */
  /* REGDOC: Write register (HHD/APPIA/EUR: 1E.0100 + 3) */
  AQ_API_WriteRegister(port->PHY_ID, AQ_GlobalNvrInterface, 3, 
...
{
  AQ_API_Variable(AQ_GlobalDaisyChainStatus)
  ...
  information->flashLoadCRC = 0x0000;
      
  /* load the FLASH CRC */
  /* REGDOC: Read bitfield (HHD/APPIA/EUR: 1E.C842.F:0) */
  AQ_API_Get(port->PHY_ID, AQ_GlobalDaisyChainStatus, rxDaisyChainCalculatedCrc, information->flashLoadCRC);
  ...
  /* get the FLASH type */
  retval = AQ_API_DetermineFLASH_TypeStandalone(port, &information->flashType);
      ...
      (information->flashType != AQ_API_F_Indeterminate))
  {
    ...
    if ((retval = AQ_API_ReadFlashImageOfKnownFLASH(port, information->flashType, 
          &startAddress, &size, image)) == AQ_RET_OK)
    {
            ...
            &startAddress, &size, image)) == AQ_RET_OK)
      {
        ...
        if ((retval = AQ_API_ReadFlashImageOfKnownFLASH(port, information->flashType, 
              &pointer, &size, versionString)) == AQ_RET_OK)
        {
          /* success */
          for (i = 0; i < 61; i++)
          {
...
{
  AQ_API_DeclareLocalStruct_DeviceRestricted(HHD, AQ_PifMailboxControl, pmc)
  ...
  /* REGDOC: Write register (HHD: 1E.C47C + 3) */
  AQ_API_WriteRegister_DeviceRestricted(HHD, port->PHY_ID, 
      AQ_PifMailboxControl, 3, 0);

  /* Write the target address */
  /* REGDOC: Write register (HHD: 1E.C47C) */
  AQ_API_WriteRegister_DeviceRestricted(HHD, port->PHY_ID, 
      AQ_PifMailboxControl, 0, address);

  /* Write the data */
  /* REGDOC: Write register (HHD: 1E.C47C + 1) */
  AQ_API_WriteRegister_DeviceRestricted(HHD, port->PHY_ID, 
      AQ_PifMailboxControl, 1, data);

  /* Write the target MMD and "write" command-type */
  AQ_API_AssignWordOfLocalStruct_DeviceRestricted(HHD,pmc, 2, 0);
  /* REGDOC: Assign to local representation of bitfield (HHD: 1E.C47E.7:0) */
  AQ_API_AssignBitfieldOfLocalStruct_DeviceRestricted(HHD, 
      AQ_PifMailboxControl, pmc, pifMailboxMMD, MMD);
  /* Command 2 means "write" */
  /* REGDOC: Assign to local representation of bitfield (HHD: 1E.C47E.B:8) */
  AQ_API_AssignBitfieldOfLocalStruct_DeviceRestricted(HHD, 
      AQ_PifMailboxControl, pmc, pifMailboxCommandType, 2);
  /* REGDOC: Assign to local representation of bitfield (HHD: 1E.C47E.C) */
  AQ_API_AssignBitfieldOfLocalStruct_DeviceRestricted(HHD, 
      AQ_PifMailboxControl, pmc, serviceSecondRegister, 0);
  /* REGDOC: Write register (HHD: 1E.C47C + 2) */
  AQ_API_WriteRegister_DeviceRestricted(HHD, port->PHY_ID, 
      AQ_PifMailboxControl, 2, 
      AQ_API_WordOfLocalStruct_DeviceRestricted(HHD, pmc, 2));
  ...
  while (1)
  {
    AQ_API_AssignWordOfLocalStruct_DeviceRestricted(HHD, pmc, 3, 
        /* REGDOC: Read register (HHD: 1E.C47C + 3) */
        AQ_API_ReadRegister_DeviceRestricted(HHD, port->PHY_ID, 
          AQ_PifMailboxControl, 3));
                    /* REGDOC: Get local representation of bitfield (HHD: 1E.C47F.3:0) */
    commandStatus = AQ_API_BitfieldOfLocalStruct_DeviceRestricted(HHD,
...
)
{
  ...
  while (1)
  {
    ...
    if (commandStatus == 1)
    {
              /* REGDOC: Read register (HHD: 1E.C47C + 1) */
      *data = AQ_API_ReadRegister_DeviceRestricted(HHD, port->PHY_ID, 
...
)
{
  ...
  while (1)
  {
    ...
    {
                   /* REGDOC: Read register (HHD: 1E.C47C + 1) */
      *data_reg1 = AQ_API_ReadRegister_DeviceRestricted(HHD, port->PHY_ID, 
          AQ_PifMailboxControl, 1);
                   /* REGDOC: Read register (HHD: 04.E41D + 1) */
      *data_reg2 = AQ_API_ReadRegister_DeviceRestricted(HHD, port->PHY_ID, 
...
{
  AQ_API_DeclareLocalStruct_DeviceRestricted(HHD, 
   ...
   * we use the PIF mailbox to delegate the reads/writes to the FW. */
  ...
  /* REGDOC: Assign to local representation of bitfield (HHD: 1E.8080.F:C) */
  AQ_API_AssignBitfieldOfLocalStruct_DeviceRestricted(HHD, 
      AQ_MssIngressLutAddressControlRegister, tableSelReg, mssIngressLutSelect, tableID);
  /* REGDOC: Assign to local representation of bitfield (HHD: 1E.8080.8:0) */
  AQ_API_AssignBitfieldOfLocalStruct_DeviceRestricted(HHD, 
  ...
  /* REGDOC: Assign to local representation of bitfield (HHD: 1E.8081.E) */
  AQ_API_AssignBitfieldOfLocalStruct_DeviceRestricted(HHD, 
      AQ_MssIngressLutControlRegister, readWriteReg, mssIngressLutRead, 0);
  /* REGDOC: Assign to local representation of bitfield (HHD: 1E.8081.F) */
  AQ_API_AssignBitfieldOfLocalStruct_DeviceRestricted(HHD, 
...
)
{
  ...
  /* Select the table and row index to write to */
  /* REGDOC: Assign to local representation of bitfield (HHD: 1E.5080.F:C) */
  AQ_API_AssignBitfieldOfLocalStruct_DeviceRestricted(HHD, 
      AQ_MssEgressLutAddressControlRegister, tableSelReg, mssEgressLutSelect, tableID);
  /* REGDOC: Assign to local representation of bitfield (HHD: 1E.5080.8:0) */
  AQ_API_AssignBitfieldOfLocalStruct_DeviceRestricted(HHD, 
      AQ_MssEgressLutAddressControlRegister, tableSelReg, mssEgressLutAddress, tableIndex);

  /* Set the write bit to copy the raw record data buffer into the table */
  /* REGDOC: Assign to local representation of bitfield (HHD: 1E.5081.E) */
  AQ_API_AssignBitfieldOfLocalStruct_DeviceRestricted(HHD, 
      AQ_MssEgressLutControlRegister, readWriteReg, mssEgressLutRead, 0);
  /* REGDOC: Assign to local representation of bitfield (HHD: 1E.5081.F) */
  AQ_API_AssignBitfieldOfLocalStruct_DeviceRestricted(HHD, 
