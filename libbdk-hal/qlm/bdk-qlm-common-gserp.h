...
***********************license end**************************************/
#ifndef __BDK_QLM_COMMON_GSERP_H__
#define __BDK_QLM_COMMON_GSERP_H__
 ...
 * @return State data
 */
extern bdk_qlm_state_lane_t __bdk_qlm_gserp_get_state(bdk_node_t node, int qlm, int lane);
 ...
 */
extern int __bdk_qlm_gserp_set_mode(bdk_node_t node, int qlm, int lane, bdk_qlm_modes_t mode, int baud_mhz, bdk_qlm_mode_flags_t flags);
 ...
 */
extern int __bdk_qlm_gserp_measure_refclock(bdk_node_t node, int qlm);
 ...
 * @return Zero on success, negative on failure
 */
extern int __bdk_qlm_gserp_reset(bdk_node_t node, int qlm);
 ...
 * @return Zero on success, negative on failure
 */
extern int __bdk_qlm_gserp_enable_prbs(bdk_node_t node, int qlm, int prbs, bdk_qlm_direction_t dir);
 ...
 * @return Zero on success, negative on failure
 */
extern int __bdk_qlm_gserp_disable_prbs(bdk_node_t node, int qlm);
 ...
 */
extern uint64_t __bdk_qlm_gserp_get_prbs_errors(bdk_node_t node, int qlm, int lane, int clear);
 ...
 * @param lane   Which lane
 */
extern void __bdk_qlm_gserp_inject_prbs_error(bdk_node_t node, int qlm, int lane);
 ...
 * @return Zero on success, negative on failure
 */
extern int __bdk_qlm_gserp_enable_loop(bdk_node_t node, int qlm, bdk_qlm_loop_t loop);
 ...
 * @return Zero on success, negative on failure
 */
extern int __bdk_qlm_gserp_tune_lane_tx(bdk_node_t node, int qlm, int lane, int tx_cmain, int tx_cpre, int tx_cpost, int tx_bs, int tx_unused);
 ...
 * @return Zero on success, negative on failure
 */
extern int __bdk_qlm_gserp_get_tune_lane_tx(bdk_node_t node, int qlm, int lane, int *tx_cmain, int *tx_cpre, int *tx_cpost, int *tx_bs, int *tx_unused);
 ...
 */
extern int __bdk_qlm__gserp_rx_equalization(bdk_node_t node, int qlm, int qlm_lane);
 ...
 */
extern void __bdk_qlm_gserp_display_settings(bdk_node_t node, int qlm, int qlm_lane, bool show_tx, bool show_rx);
 ...
 * @return Zero on success, negative on failure
 */
extern int __bdk_qlm_gserp_eye_capture(bdk_node_t node, int qlm, int lane, int show_data, bdk_qlm_eye_t *eye_data);

/**
 * Initialize the QLM layer
 */
extern void __bdk_qlm_gserp_init(bdk_node_t node);
 ...
 */
extern void __bdk_qlm_setup_pem_reset_gserp(bdk_node_t node, int pem, int is_endpoint);

#endif /* __BDK_QLM_COMMON_GSERP_H__ */
