...
#define GSERP_MIN 0 /* QLM0 => GSERP0 */
#define GSERP_MAX 8 /* QLM8 => GSERP8 */
#define GSERR_MIN 9 /* QLM9 => GSERR0 */
#define GSERR_MAX 13 /* QLM13 => GSERR4 */
...
static int map_qlm_to_pem(int qlm, bdk_qlm_modes_t mode)
{
    ...
    switch (qlm)
    {
        case 0: /* PEM0 across QLM0-3 */
            ...
            break;
        case 1: /* Only used if PEM0 is x8 or x16 */
            switch (mode)
            {
            ...
            break;
        case 2: /* PEM1 across QLM2-3 */
            switch (mode)
            {
                case BDK_QLM_MODE_PCIE_X1 ... BDK_QLM_MODE_PCIE_X8:
                    return 1; /* PEM1 up to 8 lanes */
            ...
            break;
        case 3: /* Only used if PEM0 is x16 or PEM1 is x8 */
            switch (mode)
            {
                case BDK_QLM_MODE_PCIE_X8:
                    return 1; /* PEM1 8 lanes */
                case BDK_QLM_MODE_PCIE_X16:
                    return 0; /* PEM0 16 lanes */
                default:
                    break;
            ...
            break;
        case 4: /* PEM2 across QLM4-7 */
            switch (mode)
            {
                case BDK_QLM_MODE_PCIE_X1 ... BDK_QLM_MODE_PCIE_X16:
                    return 2; /* PEM2 up to 16 lanes */
                default:
                    break;
            }
            break;
        case 5: /* Only used if PEM2 is x8 or x16 */
            switch (mode)
            {
                case BDK_QLM_MODE_PCIE_X8 ... BDK_QLM_MODE_PCIE_X16:
                    return 2; /* PEM2 8 or 16 lanes */
                default:
                    break;
            }
            break;
        case 6: /* PEM3 across QLM6-7 */
            switch (mode)
            {
                case BDK_QLM_MODE_PCIE_X1 ... BDK_QLM_MODE_PCIE_X8:
                    return 3; /* PEM3 up to 8 lanes */
                case BDK_QLM_MODE_PCIE_X16:
                    return 2; /* PEM2 16 lanes */
                default:
                    break;
            }
            break;
        case 7: /* Only used if PEM2 is x16 or PEM3 is x8 */
            switch (mode)
            {
                case BDK_QLM_MODE_PCIE_X8:
                    return 3; /* PEM3 8 lanes */
                case BDK_QLM_MODE_PCIE_X16:
                    return 2; /* PEM2 16 lanes */
                default:
                    break;
    ...
    switch (iftype)
    {
        case BDK_IF_CGX:
        {
            switch (interface)
            {
                case 0 ... 4:
                {
                    bdk_qlm_state_lane_t state = __bdk_qlm_gserr_get_state(node, interface, 0);
                    if (state.s.cgx)
        ...
        case BDK_IF_PCIE: /* PCIe */
        {
            ...
            switch (interface)
            {
                ...
                case 1:
                    qlm = 2;
                    not_x16 = true; /* If x16 we're disabled */
                    break;
                case 2:
                    qlm = 4;
                    break;
            ...
            if (qlm >= 0)
            {
                bdk_qlm_state_lane_t state = __bdk_qlm_gserp_get_state(node, qlm - GSERP_MIN, 0);
                if (state.s.pcie && !(not_x16 && (state.s.mode == BDK_QLM_MODE_PCIE_X16)))
                    return qlm;
            }
            return -1;
        }
        default: /* Not supported by CN98XX */
            return -1;
    }
}
...
static const bdk_qlm_mode_desc_t pcie_qlm_x4[] = {
    /* PEM - 4 lane mode */
...
static const bdk_qlm_mode_desc_t pcie_qlm_x8[] = {
    /* PEM - 4 lane mode */
    {BDK_QLM_MODE_PCIE_X4,      BDK_QLM_MODE_FLAG_NONE, BDK_QLM_CLK_COMMON_1, 2500},
    {BDK_QLM_MODE_PCIE_X4,      BDK_QLM_MODE_FLAG_NONE, BDK_QLM_CLK_COMMON_1, 5000},
    {BDK_QLM_MODE_PCIE_X4,      BDK_QLM_MODE_FLAG_NONE, BDK_QLM_CLK_COMMON_1, 8000},
...
static const bdk_qlm_mode_desc_t pcie_qlm_x16[] = {
    /* PEM - 4 lane mode */
    {BDK_QLM_MODE_PCIE_X4,      BDK_QLM_MODE_FLAG_NONE, BDK_QLM_CLK_COMMON_1, 2500},
    {BDK_QLM_MODE_PCIE_X4,      BDK_QLM_MODE_FLAG_NONE, BDK_QLM_CLK_COMMON_1, 5000},
    {BDK_QLM_MODE_PCIE_X4,      BDK_QLM_MODE_FLAG_NONE, BDK_QLM_CLK_COMMON_1, 8000},
...
static const bdk_qlm_mode_desc_t eth_qlms[] = {
    /* CGX0 */
...
static const bdk_qlm_mode_desc_t* qlm_get_mode_desc(bdk_node_t node, int qlm)
{
    switch (qlm)
    {
        case 0: return pcie_qlm_x16;    /* PEM0 across QLM0-3 */
        case 1: return NULL;            /* Only used if PEM0 is x8 or x16 */
        case 2: return pcie_qlm_x8;     /* PEM1 across QLM2-3 */
        case 3: return NULL;            /* Only used if PEM0 is x16 or PEM1 is x8 */
        case 4: return pcie_qlm_x16;    /* PEM2 across QLM4-7 */
        case 5: return NULL;            /* Only used if PEM2 is x8 or x16 */
        case 6: return pcie_qlm_x8;     /* PEM3 across QLM6-7 */
        case 7: return NULL;            /* Only used if PEM2 is x16 or PEM3 is x8 */
        case 8: return pcie_qlm_x4;     /* PEM4 on QLM8 */
        case GSERR_MIN ... GSERR_MAX: return eth_qlms;
        default: return NULL;
    }
}
...
{
    /* Which CGX maps to a specific QLM
       CGX0: QLM9,  GSERR0
       CGX1: QLM10, GSERR1
       CGX2: QLM11, GSERR2
       CGX3: QLM12, GSERR3
    ...
    *is_upper = false;
    switch (qlm)
    {
        case GSERR_MIN ... GSERR_MAX:
            return qlm - GSERR_MIN;
        default:
            return -1;
    }
}
...
const bdk_qlm_ops_t bdk_qlm_ops_cn98xx = {
    .chip_model = OCTEONTX_CN98XX,
    .init = qlm_init,
    .get_num = qlm_get_num,
