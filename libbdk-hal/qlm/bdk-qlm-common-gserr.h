...
***********************license end**************************************/
#ifndef __BDK_QLM_COMMON_GSERR_H__
#define __BDK_QLM_COMMON_GSERR_H__
 ...
 * @return State data
 */
extern bdk_qlm_state_lane_t __bdk_qlm_gserr_get_state(bdk_node_t node, int qlm, int lane);
 ...
 */
extern int __bdk_qlm_gserr_set_mode(bdk_node_t node, int qlm, int lane, bdk_qlm_modes_t mode, int baud_mhz, bdk_qlm_mode_flags_t flags);
 ...
 */
extern int __bdk_qlm_gserr_measure_refclock(bdk_node_t node, int qlm);
 ...
 * @return Zero on success, negative on failure
 */
extern int __bdk_qlm_gserr_reset(bdk_node_t node, int qlm);
 ...
 * @return Zero on success, negative on failure
 */
extern int __bdk_qlm_gserr_enable_prbs(bdk_node_t node, int qlm, int prbs, bdk_qlm_direction_t dir);
 ...
 * @return Zero on success, negative on failure
 */
extern int __bdk_qlm_gserr_disable_prbs(bdk_node_t node, int qlm);
 ...
 */
extern uint64_t __bdk_qlm_gserr_get_prbs_errors(bdk_node_t node, int qlm, int lane, int clear);
 ...
 * @param lane   Which lane
 */
extern void __bdk_qlm_gserr_inject_prbs_error(bdk_node_t node, int qlm, int lane);
 ...
 * @return Zero on success, negative on failure
 */
extern int __bdk_qlm_gserr_enable_loop(bdk_node_t node, int qlm, bdk_qlm_loop_t loop);
 ...
 * @return Zero on success, negative on failure
 */
extern int __bdk_qlm_gserr_tune_lane_tx(bdk_node_t node, int qlm, int lane, int tx_cmain, int tx_cpre, int tx_cpost, int tx_bs, int tx_unused);
 ...
 * @return Zero on success, negative on failure
 */
extern int __bdk_qlm_gserr_get_tune_lane_tx(bdk_node_t node, int qlm, int lane, int *tx_cmain, int *tx_cpre, int *tx_cpost, int *tx_bs, int *tx_unused);
 ...
 */
extern int __bdk_qlm__gserr_rx_equalization(bdk_node_t node, int qlm, int qlm_lane);
 ...
 */
extern void __bdk_qlm_gserr_display_settings(bdk_node_t node, int qlm, int qlm_lane, bool show_tx, bool show_rx);
 ...
 * @return Zero on success, negative on failure
 */
extern int __bdk_qlm_gserr_eye_capture(bdk_node_t node, int qlm, int lane, int show_data, bdk_qlm_eye_t *eye_data);

/**
 * Initialize the QLM layer
 */
extern void __bdk_qlm_gserr_init(bdk_node_t node);

#endif /* __BDK_QLM_COMMON_GSERR_H__ */
