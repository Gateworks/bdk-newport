...
#define SwapBytes16(x) bdk_cpu_to_be16(x)
#define SwapBytes32(x) bdk_cpu_to_be32(x)
#define SwapBytes64(x) bdk_cpu_to_be64(x)

static inline UINT64 WriteUnaligned64(UINT64 *tgt,const uint64_t value) __attribute__((always_inline));
static inline uint32_t WriteUnaligned32(uint32_t *tgt,const uint32_t value) __attribute__((always_inline));
static inline uint16_t WriteUnaligned16(uint16_t *tgt,const uint16_t value) __attribute__((always_inline));
static inline UINT64 ReadUnaligned64(const UINT64 *tgt) __attribute__((always_inline));
static inline uint32_t ReadUnaligned32(const uint32_t *tgt) __attribute__((always_inline));

static inline UINT64 WriteUnaligned64(UINT64 *tgt,const uint64_t value)
{
    *tgt = value;
    return value;
}

static inline uint32_t WriteUnaligned32(uint32_t *tgt,const uint32_t value)
{
    *tgt = value;
    return value;
}

static inline uint16_t WriteUnaligned16(uint16_t *tgt,const uint16_t value)
{
    *tgt = value;
    return value;
}
static inline UINT64 ReadUnaligned64(const UINT64 *tgt) { return *tgt;}
static inline uint32_t ReadUnaligned32(const uint32_t *tgt) { return *tgt;}
