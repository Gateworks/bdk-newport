 ...
 */
#define BDK_MIO_PTP_EXT_SEL_E_BCN_MUX_CLK (2)
#define BDK_MIO_PTP_EXT_SEL_E_BTS_REF_CLK (1)
#define BDK_MIO_PTP_EXT_SEL_E_GPIO (0)
#define BDK_MIO_PTP_EXT_SEL_E_QLM_REFX_CN8(a) (0x38 + (a))
#define BDK_MIO_PTP_EXT_SEL_E_QLM_REFX_CN96XX(a) (0x38 + (a))
#define BDK_MIO_PTP_EXT_SEL_E_QLM_REFX_CN98XX(a) (0x10 + (a))
#define BDK_MIO_PTP_EXT_SEL_E_QLM_REFX_CNF95XX(a) (0x38 + (a))
#define BDK_MIO_PTP_EXT_SEL_E_QLM_REFX_LOKI(a) (0x38 + (a))
...
static inline uint64_t BDK_MIO_PTP_CLKEN_FUNC(void)
{
    ...
    __bdk_csr_fatal("MIO_PTP_CLKEN", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_mio_ptp_clock_cfg
{
    ...
    /* struct bdk_mio_ptp_clock_cfg_s cn96xxp1; */
    struct bdk_mio_ptp_clock_cfg_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_43_63        : 21;
        uint64_t sysck                 : 1;  /**< [ 42: 42](RO/H) PTP SYSCK; reflects ptp__sysck. */
    ...
    /* struct bdk_mio_ptp_clock_cfg_cn96xxp3 cn98xx; */
    /* struct bdk_mio_ptp_clock_cfg_s cnf95xxp1; */
    /* struct bdk_mio_ptp_clock_cfg_cn96xxp3 cnf95xxp2; */
    /* struct bdk_mio_ptp_clock_cfg_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_MIO_PTP_MSIX_PBAX(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_PTP_MSIX_PBAX", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_mio_ptp_msix_vecx_addr
{
    ...
    /* struct bdk_mio_ptp_msix_vecx_addr_s cn96xxp1; */
    struct bdk_mio_ptp_msix_vecx_addr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
    ...
    /* struct bdk_mio_ptp_msix_vecx_addr_cn96xxp3 cn98xx; */
    /* struct bdk_mio_ptp_msix_vecx_addr_cn96xxp3 cnf95xx; */
    /* struct bdk_mio_ptp_msix_vecx_addr_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_MIO_PTP_MSIX_VECX_ADDR(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_PTP_MSIX_VECX_ADDR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_PTP_MSIX_VECX_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_PTP_MSIX_VECX_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_PTP_SYSCK_HI_INCR_FUNC(void)
{
    ...
    __bdk_csr_fatal("MIO_PTP_SYSCK_HI_INCR", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_PTP_SYSCK_LO_INCR_FUNC(void)
{
    ...
    __bdk_csr_fatal("MIO_PTP_SYSCK_LO_INCR", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_PTP_SYSCK_THRESH_HI_FUNC(void)
{
    ...
    __bdk_csr_fatal("MIO_PTP_SYSCK_THRESH_HI", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_PTP_SYSCK_THRESH_LO_FUNC(void)
{
    ...
    __bdk_csr_fatal("MIO_PTP_SYSCK_THRESH_LO", 0, 0, 0, 0, 0, 0, 0);
}
