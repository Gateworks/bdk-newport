 ...
 */
#define BDK_ECAM_BAR_E_ECAMX_PF_BAR0_CN8(a) (0x87e048000000ll + 0x1000000ll * (a))
#define BDK_ECAM_BAR_E_ECAMX_PF_BAR0_CN8_SIZE 0x100000ull
#define BDK_ECAM_BAR_E_ECAMX_PF_BAR0_CN9(a) (0x87e078000000ll + 0x1000000ll * (a))
#define BDK_ECAM_BAR_E_ECAMX_PF_BAR0_CN9_SIZE 0x100000ull
#define BDK_ECAM_BAR_E_ECAMX_PF_BAR2_CN8(a) (0x848000000000ll + 0x1000000000ll * (a))
#define BDK_ECAM_BAR_E_ECAMX_PF_BAR2_CN8_SIZE 0x1000000000ull
#define BDK_ECAM_BAR_E_ECAMX_PF_BAR2_CN9(a) (0x878000000000ll + 0x1000000000ll * (a))
#define BDK_ECAM_BAR_E_ECAMX_PF_BAR2_CN9_SIZE 0x1000000000ull
...
union bdk_ecam_cfg_addr_s
{
    ...
    struct bdk_ecam_cfg_addr_s_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_ecam_cfg_addr_s_cn8 cn81xx; */
...
{
    if (bdk_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=255)))
        return 0x87e048030000ll + 0x1000000ll * ((a) & 0x0) + 8ll * ((b) & 0xff);
    if (bdk_is_model(OCTEONTX_CN83XX) && ((a<=1) && (b<=255)))
        return 0x87e048030000ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0xff);
    __bdk_csr_fatal("ECAMX_BUSX_NSDIS", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ECAMX_BUSX_SDIS(unsigned long a, unsigned long b)
{
    ...
    __bdk_csr_fatal("ECAMX_BUSX_SDIS", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ECAMX_BUSX_SKILL(unsigned long a, unsigned long b)
{
    ...
    __bdk_csr_fatal("ECAMX_BUSX_SKILL", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ECAMX_CONST(unsigned long a)
{
    ...
    __bdk_csr_fatal("ECAMX_CONST", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ECAMX_DEVX_NSDIS(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_CN83XX) && ((a<=1) && (b<=31)))
        return 0x87e048070000ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1f);
    __bdk_csr_fatal("ECAMX_DEVX_NSDIS", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ECAMX_DEVX_SDIS(unsigned long a, unsigned long b)
{
    ...
    __bdk_csr_fatal("ECAMX_DEVX_SDIS", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ECAMX_DEVX_SKILL(unsigned long a, unsigned long b)
{
    ...
    __bdk_csr_fatal("ECAMX_DEVX_SKILL", 2, a, b, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && ((a==0) && ((b==0) || (b==1) || (b==2)) && (c<=255)))
        return 0x87e078020000ll + 0x1000000ll * ((a) & 0x0) + 0x800ll * ((b) & 0x3) + 8ll * ((c) & 0xff);
    __bdk_csr_fatal("ECAMX_DOMX_BUSX_PERMIT", 3, a, b, c, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && ((a==0) && (b<=63)))
        return 0x87e078000400ll + 0x1000000ll * ((a) & 0x0) + 8ll * ((b) & 0x3f);
    __bdk_csr_fatal("ECAMX_DOMX_CONST", 2, a, b, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && ((a==0) && ((b==0) || (b==1) || (b==2)) && (c<=31)))
        return 0x87e078040000ll + 0x1000000ll * ((a) & 0x0) + 0x800ll * ((b) & 0x3) + 8ll * ((c) & 0x1f);
    __bdk_csr_fatal("ECAMX_DOMX_DEVX_PERMIT", 3, a, b, c, 0, 0, 0);
}
 ...
 * PCC_DEV_CON_E::MRML (all devices sharing the secondary RSL bus with MRML).
 *
 * Index {b} corresponds to the ECAM address's domain (address's
...
static inline uint64_t BDK_ECAMX_DOMX_RSLX_PERMIT(unsigned long a, unsigned long b, unsigned long c)
{
    ...
    __bdk_csr_fatal("ECAMX_DOMX_RSLX_PERMIT", 3, a, b, c, 0, 0, 0);
}
...
static inline uint64_t BDK_ECAMX_NOP_OF(unsigned long a)
{
    ...
    __bdk_csr_fatal("ECAMX_NOP_OF", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ECAMX_NOP_ONF(unsigned long a)
{
    ...
    __bdk_csr_fatal("ECAMX_NOP_ONF", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ECAMX_NOP_ZF(unsigned long a)
{
    ...
    __bdk_csr_fatal("ECAMX_NOP_ZF", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ECAMX_NOP_ZNF(unsigned long a)
{
    ...
    __bdk_csr_fatal("ECAMX_NOP_ZNF", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ECAMX_RSLX_NSDIS(unsigned long a, unsigned long b)
{
    ...
    __bdk_csr_fatal("ECAMX_RSLX_NSDIS", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ECAMX_RSLX_SDIS(unsigned long a, unsigned long b)
{
    ...
    __bdk_csr_fatal("ECAMX_RSLX_SDIS", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ECAMX_RSLX_SKILL(unsigned long a, unsigned long b)
{
    ...
    __bdk_csr_fatal("ECAMX_RSLX_SKILL", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ECAMX_SCRATCH(unsigned long a)
{
    ...
    __bdk_csr_fatal("ECAMX_SCRATCH", 1, a, 0, 0, 0, 0, 0);
}
