...
static inline uint64_t BDK_PCCVF_XXX_AER_CAP_HDR_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x140;
    __bdk_csr_fatal("PCCVF_XXX_AER_CAP_HDR", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PCCVF_XXX_AER_COR_MASK_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x154;
    __bdk_csr_fatal("PCCVF_XXX_AER_COR_MASK", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PCCVF_XXX_AER_COR_STATUS_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x150;
    __bdk_csr_fatal("PCCVF_XXX_AER_COR_STATUS", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PCCVF_XXX_AER_UNCOR_MASK_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x148;
    __bdk_csr_fatal("PCCVF_XXX_AER_UNCOR_MASK", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PCCVF_XXX_AER_UNCOR_SEVER_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x14c;
    __bdk_csr_fatal("PCCVF_XXX_AER_UNCOR_SEVER", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PCCVF_XXX_AER_UNCOR_STATUS_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x144;
    __bdk_csr_fatal("PCCVF_XXX_AER_UNCOR_STATUS", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PCCVF_XXX_ARI_CAP_HDR_FUNC(void)
{
    ...
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x170;
    __bdk_csr_fatal("PCCVF_XXX_ARI_CAP_HDR", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PCCVF_XXX_E_DEV_CTL_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x78;
    __bdk_csr_fatal("PCCVF_XXX_E_DEV_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_pccvf_xxx_msix_table
{
    ...
    /* struct bdk_pccvf_xxx_msix_table_s cn8; */
    struct bdk_pccvf_xxx_msix_table_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t msixtoffs             : 29; /**< [ 31:  3](RO) MSI-X table offset register. Offset of the MSI-X table, as a number of eight-byte
...
static inline uint64_t BDK_PCCVF_XXX_VSEC_CAP_HDR_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x100;
    __bdk_csr_fatal("PCCVF_XXX_VSEC_CAP_HDR", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PCCVF_XXX_VSEC_CTL_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x108;
    __bdk_csr_fatal("PCCVF_XXX_VSEC_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PCCVF_XXX_VSEC_ID_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x104;
    __bdk_csr_fatal("PCCVF_XXX_VSEC_ID", 0, 0, 0, 0, 0, 0, 0);
}
