...
static inline uint64_t BDK_MDN_BISR_REPAIR_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x28;
    __bdk_csr_fatal("MDN_BISR_REPAIR", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_BIST_ACTIVE_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0xc;
    __bdk_csr_fatal("MDN_BIST_ACTIVE", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_BIST_ADDR_MASK_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x4c;
    __bdk_csr_fatal("MDN_BIST_ADDR_MASK", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_BIST_CONFIG_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0;
    __bdk_csr_fatal("MDN_BIST_CONFIG", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_BIST_CONTROL_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 4;
    __bdk_csr_fatal("MDN_BIST_CONTROL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_BIST_FAIL_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x10;
    __bdk_csr_fatal("MDN_BIST_FAIL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_BIST_REPAIRABLE_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x14;
    __bdk_csr_fatal("MDN_BIST_REPAIRABLE", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_BIST_STATUS_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 8;
    __bdk_csr_fatal("MDN_BIST_STATUS", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_CONST_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x40;
    __bdk_csr_fatal("MDN_CONST", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_DEBUG_DATAX(unsigned long a)
{
    ...
    __bdk_csr_fatal("MDN_DEBUG_DATAX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_DEBUG_DEFECT_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x1c;
    __bdk_csr_fatal("MDN_DEBUG_DEFECT", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_DEBUG_MARCH_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x20;
    __bdk_csr_fatal("MDN_DEBUG_MARCH", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_DEBUG_SKID_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x24;
    __bdk_csr_fatal("MDN_DEBUG_SKID", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_ECC_CONFIG_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x2c;
    __bdk_csr_fatal("MDN_ECC_CONFIG", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_ECC_IRQ_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x30;
    __bdk_csr_fatal("MDN_ECC_IRQ", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_ECC_STATUS_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x34;
    __bdk_csr_fatal("MDN_ECC_STATUS", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_ECC_STATUS_RC_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x38;
    __bdk_csr_fatal("MDN_ECC_STATUS_RC", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_ENUM_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x44;
    __bdk_csr_fatal("MDN_ENUM", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MDN_SCRATCH_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x3c;
    __bdk_csr_fatal("MDN_SCRATCH", 0, 0, 0, 0, 0, 0, 0);
}
