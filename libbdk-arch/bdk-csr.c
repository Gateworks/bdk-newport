    ...
    switch (type)
    {
        ...
        case BDK_CSR_TYPE_PCICONFIGRC:
        {
            ...
            switch (busnum)
            {
                case 0:
                    if (bdk_is_model(OCTEONTX_CN83XX))
                        ...
                        dev_con.u = BDK_PCC_DEV_CON_E_PCIERC0_CN9;
                    else
                ...
                case 1:
                    if (bdk_is_model(OCTEONTX_CN83XX))
                        ...
                        dev_con.u = BDK_PCC_DEV_CON_E_PCIERC1_CN9;
                    else
                        bdk_fatal("Update PCICONFIG in %s\n", __FUNCTION__);
                    break;
                case 2:
                    if (bdk_is_model(OCTEONTX_CN83XX))
                        ...
                        dev_con.u = BDK_PCC_DEV_CON_E_PCIERC2_CN9;
                    else
                        bdk_fatal("Update PCICONFIG in %s\n", __FUNCTION__);
                    break;
                case 3:
                    if (bdk_is_model(OCTEONTX_CN83XX))
                        dev_con.u = BDK_PCC_DEV_CON_E_PCIERC3_CN8;
                    else if (bdk_is_model(OCTEONTX_CN9XXX))
                        dev_con.u = BDK_PCC_DEV_CON_E_PCIERC3_CN9;
                    else
                        bdk_fatal("Update PCICONFIG in %s\n", __FUNCTION__);
                    break;
                default:
            ...
            if (bdk_is_model(OCTEONTX_CN8XXX))
                ...
                return bdk_pcie_config_read32(node, 100 + dev_con.cn9.dmn, dev_con.s.bus, dev_con.s.func >> 3, dev_con.s.func & 7, address);
        }
    ...
    switch (type)
    {
        ...
        case BDK_CSR_TYPE_PCICONFIGRC:
        {
            ...
            if (bdk_is_model(OCTEONTX_CN8XXX))
                ...
                bdk_pcie_config_write32(node, 100 + dev_con.cn9.dmn, dev_con.s.bus, dev_con.s.func >> 3, dev_con.s.func & 7, address, value);
            break;
        }
        case BDK_CSR_TYPE_PCICONFIGEP:
        {
...
void __bdk_csr_fatal(const char *name, int num_args, unsigned long arg1, unsigned long arg2, unsigned long arg3, unsigned long arg4, unsigned long arg5, unsigned long arg6)
{
    switch (num_args)
    {
        case 0:
        ...
        case 5:
            bdk_fatal("%s(%lu,%lu,%lu,%lu,%lu) is invalid on this chip\n", name, arg1, arg2, arg3, arg4, arg5);
        default:
            bdk_fatal("%s(%lu,%lu,%lu,%lu,%lu,%lu) is invalid on this chip\n", name, arg1, arg2, arg3, arg4, arg5, arg6);
    }
}
