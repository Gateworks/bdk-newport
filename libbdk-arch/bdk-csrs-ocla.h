...
union bdk_ocla_cap_ctl_s
{
    ...
    /* struct bdk_ocla_cap_ctl_s_s cn8; */
    struct bdk_ocla_cap_ctl_s_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_38_63        : 26;
        uint64_t ctl                   : 1;  /**< [ 37: 37] Indicates a control word. Always set for control structures. */
...
{
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=4))
        return 0x87e0b0000620ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b0000620ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b0000620ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b0000620ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_ACTIVE_PC", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_BIST_RESULT(unsigned long a)
{
    ...
    __bdk_csr_fatal("OCLAX_BIST_RESULT", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_oclax_cdhx_ctl
{
    ...
    /* struct bdk_oclax_cdhx_ctl_s cn8; */
...
static inline uint64_t BDK_OCLAX_CDHX_CTL(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=4) && (b<=1)))
        return 0x87e0b0000600ll + 0x1000000ll * ((a) & 0x7) + 8ll * ((b) & 0x1);
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b<=1)))
        return 0x87e0b0000600ll + 0x1000000ll * ((a) & 0x7) + 8ll * ((b) & 0x1);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=1)))
        return 0x87e0b0000600ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b<=1)))
        return 0x87e0b0000600ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1);
    __bdk_csr_fatal("OCLAX_CDHX_CTL", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_CDHX_INJECT_STATE(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b<=1)))
        return 0x87e0b0000610ll + 0x1000000ll * ((a) & 0x7) + 8ll * ((b) & 0x1);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=1)))
        return 0x87e0b0000610ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b<=1)))
        return 0x87e0b0000610ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1);
    __bdk_csr_fatal("OCLAX_CDHX_INJECT_STATE", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_CONST(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b0000000ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b0000000ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b0000000ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_CONST", 1, a, 0, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN81XX) && ((a<=1) && (b<=8191)))
        return 0x87e0a8400000ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1fff);
    if (bdk_is_model(OCTEONTX_CN83XX) && ((a<=2) && (b<=8191)))
        return 0x87e0a8400000ll + 0x1000000ll * ((a) & 0x3) + 8ll * ((b) & 0x1fff);
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=4) && (b<=16383)))
        return 0x87e0b0400000ll + 0x1000000ll * ((a) & 0x7) + 8ll * ((b) & 0x3fff);
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b<=16383)))
        return 0x87e0b0400000ll + 0x1000000ll * ((a) & 0x7) + 8ll * ((b) & 0x3fff);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=16383)))
        return 0x87e0b0400000ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3fff);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b<=16383)))
        return 0x87e0b0400000ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x3fff);
    __bdk_csr_fatal("OCLAX_DATX", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_DAT_POP(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b0000800ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b0000800ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b0000800ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_DAT_POP", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_ECO(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b00000d0ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b00000d0ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b00000d0ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_ECO", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_FIFO_DEPTH(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b0000200ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b0000200ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b0000200ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_FIFO_DEPTH", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_FIFO_LIMIT(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b0000240ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b0000240ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b0000240ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_FIFO_LIMIT", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_FIFO_TAIL(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b0000260ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b0000260ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b0000260ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_FIFO_TAIL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_FIFO_TRIG(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b00002a0ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b00002a0ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b00002a0ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_FIFO_TRIG", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_FIFO_WRAP(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b0000280ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b0000280ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b0000280ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_FIFO_WRAP", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_oclax_fsmx_andx_ix
{
    ...
    /* struct bdk_oclax_fsmx_andx_ix_s cn; */
};
...
{
    if (bdk_is_model(OCTEONTX_CN81XX) && ((a<=1) && (b<=1) && (c<=15) && (d<=1)))
        return 0x87e0a8300000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x1) + 0x10ll * ((c) & 0xf) + 8ll * ((d) & 0x1);
    if (bdk_is_model(OCTEONTX_CN83XX) && ((a<=2) && (b<=1) && (c<=15) && (d<=1)))
        return 0x87e0a8300000ll + 0x1000000ll * ((a) & 0x3) + 0x1000ll * ((b) & 0x1) + 0x10ll * ((c) & 0xf) + 8ll * ((d) & 0x1);
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=4) && (b<=1) && (c<=15) && (d<=1)))
        return 0x87e0b0300000ll + 0x1000000ll * ((a) & 0x7) + 0x1000ll * ((b) & 0x1) + 0x10ll * ((c) & 0xf) + 8ll * ((d) & 0x1);
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b<=1) && (c<=15) && (d<=1)))
        return 0x87e0b0300000ll + 0x1000000ll * ((a) & 0x7) + 0x1000ll * ((b) & 0x1) + 0x10ll * ((c) & 0xf) + 8ll * ((d) & 0x1);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=1) && (c<=15) && (d<=1)))
        return 0x87e0b0300000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x1) + 0x10ll * ((c) & 0xf) + 8ll * ((d) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b<=1) && (c<=15) && (d<=1)))
        return 0x87e0b0300000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x1) + 0x10ll * ((c) & 0xf) + 8ll * ((d) & 0x1);
    __bdk_csr_fatal("OCLAX_FSMX_ANDX_IX", 4, a, b, c, d, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN81XX) && ((a<=1) && (b<=1) && (c<=15)))
        return 0x87e0a8310000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x1) + 8ll * ((c) & 0xf);
    if (bdk_is_model(OCTEONTX_CN83XX) && ((a<=2) && (b<=1) && (c<=15)))
        return 0x87e0a8310000ll + 0x1000000ll * ((a) & 0x3) + 0x1000ll * ((b) & 0x1) + 8ll * ((c) & 0xf);
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=4) && (b<=1) && (c<=15)))
        return 0x87e0b0310000ll + 0x1000000ll * ((a) & 0x7) + 0x1000ll * ((b) & 0x1) + 8ll * ((c) & 0xf);
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b<=1) && (c<=15)))
        return 0x87e0b0310000ll + 0x1000000ll * ((a) & 0x7) + 0x1000ll * ((b) & 0x1) + 8ll * ((c) & 0xf);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=1) && (c<=15)))
        return 0x87e0b0310000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x1) + 8ll * ((c) & 0xf);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b<=1) && (c<=15)))
        return 0x87e0b0310000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x1) + 8ll * ((c) & 0xf);
    __bdk_csr_fatal("OCLAX_FSMX_ORX", 3, a, b, c, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_FSMX_STATEX(unsigned long a, unsigned long b, unsigned long c)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b<=1) && (c<=15)))
        return 0x87e0b0320000ll + 0x1000000ll * ((a) & 0x7) + 0x1000ll * ((b) & 0x1) + 8ll * ((c) & 0xf);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=1) && (c<=15)))
        return 0x87e0b0320000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x1) + 8ll * ((c) & 0xf);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b<=1) && (c<=15)))
        return 0x87e0b0320000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x1) + 8ll * ((c) & 0xf);
    __bdk_csr_fatal("OCLAX_FSMX_STATEX", 3, a, b, c, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_GEN_CTL(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b0000060ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b0000060ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b0000060ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_GEN_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN81XX) && ((a<=1) && (b<=3)))
        return 0x87e0a8230000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x3);
    if (bdk_is_model(OCTEONTX_CN83XX) && ((a<=2) && (b<=3)))
        return 0x87e0a8230000ll + 0x1000000ll * ((a) & 0x3) + 0x1000ll * ((b) & 0x3);
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=4) && (b<=3)))
        return 0x87e0b0230000ll + 0x1000000ll * ((a) & 0x7) + 0x1000ll * ((b) & 0x3);
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b<=3)))
        return 0x87e0b0230000ll + 0x1000000ll * ((a) & 0x7) + 0x1000ll * ((b) & 0x3);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=3)))
        return 0x87e0b0230000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x3);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b<=3)))
        return 0x87e0b0230000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x3);
    __bdk_csr_fatal("OCLAX_MATX_COUNT", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_MATX_CTL(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b<=3)))
        return 0x87e0b0200000ll + 0x1000000ll * ((a) & 0x7) + 0x1000ll * ((b) & 0x3);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=3)))
        return 0x87e0b0200000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x3);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b<=3)))
        return 0x87e0b0200000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x3);
    __bdk_csr_fatal("OCLAX_MATX_CTL", 2, a, b, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN81XX) && ((a<=1) && (b<=3) && (c<=1)))
        return 0x87e0a8220000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x3) + 8ll * ((c) & 0x1);
    if (bdk_is_model(OCTEONTX_CN83XX) && ((a<=2) && (b<=3) && (c<=1)))
        return 0x87e0a8220000ll + 0x1000000ll * ((a) & 0x3) + 0x1000ll * ((b) & 0x3) + 8ll * ((c) & 0x1);
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=4) && (b<=3) && (c<=1)))
        return 0x87e0b0220000ll + 0x1000000ll * ((a) & 0x7) + 0x1000ll * ((b) & 0x3) + 8ll * ((c) & 0x1);
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b<=3) && (c<=1)))
        return 0x87e0b0220000ll + 0x1000000ll * ((a) & 0x7) + 0x1000ll * ((b) & 0x3) + 8ll * ((c) & 0x1);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=3) && (c<=1)))
        return 0x87e0b0220000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x3) + 8ll * ((c) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b<=3) && (c<=1)))
        return 0x87e0b0220000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x3) + 8ll * ((c) & 0x1);
    __bdk_csr_fatal("OCLAX_MATX_MASKX", 3, a, b, c, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_MATX_THRESH(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b<=3)))
        return 0x87e0b0240000ll + 0x1000000ll * ((a) & 0x7) + 0x1000ll * ((b) & 0x3);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=3)))
        return 0x87e0b0240000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x3);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b<=3)))
        return 0x87e0b0240000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x3);
    __bdk_csr_fatal("OCLAX_MATX_THRESH", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_MATX_VALUEX(unsigned long a, unsigned long b, unsigned long c)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b<=3) && (c<=1)))
        return 0x87e0b0210000ll + 0x1000000ll * ((a) & 0x7) + 0x1000ll * ((b) & 0x3) + 8ll * ((c) & 0x1);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=3) && (c<=1)))
        return 0x87e0b0210000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x3) + 8ll * ((c) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b<=3) && (c<=1)))
        return 0x87e0b0210000ll + 0x1000000ll * ((a) & 0x1) + 0x1000ll * ((b) & 0x3) + 8ll * ((c) & 0x1);
    __bdk_csr_fatal("OCLAX_MATX_VALUEX", 3, a, b, c, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_MPARID(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b00000e0ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b00000e0ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b00000e0ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_MPARID", 1, a, 0, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN81XX) && ((a<=1) && (b==0)))
        return 0x87e0a8ff0000ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_CN83XX) && ((a<=2) && (b==0)))
        return 0x87e0a8ff0000ll + 0x1000000ll * ((a) & 0x3) + 8ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=4) && (b==0)))
        return 0x87e0b0ff0000ll + 0x1000000ll * ((a) & 0x7) + 8ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b==0)))
        return 0x87e0b0ff0000ll + 0x1000000ll * ((a) & 0x7) + 8ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b==0)))
        return 0x87e0b0ff0000ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b==0)))
        return 0x87e0b0ff0000ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x0);
    __bdk_csr_fatal("OCLAX_MSIX_PBAX", 2, a, b, 0, 0, 0, 0);
}
...
union bdk_oclax_msix_vecx_addr
{
    ...
    struct bdk_oclax_msix_vecx_addr_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
...
static inline uint64_t BDK_OCLAX_MSIX_VECX_ADDR(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b==0)))
        return 0x87e0b0f00000ll + 0x1000000ll * ((a) & 0x7) + 0x10ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b==0)))
        return 0x87e0b0f00000ll + 0x1000000ll * ((a) & 0x1) + 0x10ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b==0)))
        return 0x87e0b0f00000ll + 0x1000000ll * ((a) & 0x1) + 0x10ll * ((b) & 0x0);
    __bdk_csr_fatal("OCLAX_MSIX_VECX_ADDR", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_MSIX_VECX_CTL(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b==0)))
        return 0x87e0b0f00008ll + 0x1000000ll * ((a) & 0x7) + 0x10ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b==0)))
        return 0x87e0b0f00008ll + 0x1000000ll * ((a) & 0x1) + 0x10ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b==0)))
        return 0x87e0b0f00008ll + 0x1000000ll * ((a) & 0x1) + 0x10ll * ((b) & 0x0);
    __bdk_csr_fatal("OCLAX_MSIX_VECX_CTL", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_RAWX(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b<=1)))
        return 0x87e0b0000100ll + 0x1000000ll * ((a) & 0x7) + 8ll * ((b) & 0x1);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=1)))
        return 0x87e0b0000100ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b<=1)))
        return 0x87e0b0000100ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1);
    __bdk_csr_fatal("OCLAX_RAWX", 2, a, b, 0, 0, 0, 0);
}
...
union bdk_oclax_sft_rst
{
    ...
    /* struct bdk_oclax_sft_rst_s cn8; */
    struct bdk_oclax_sft_rst_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
        uint64_t reset                 : 1;  /**< [  0:  0](R/W1) Reset. When written with one, reset OCLA excluding the RSL interface. Software
...
static inline uint64_t BDK_OCLAX_SFT_RST(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b0000020ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b0000020ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b0000020ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_SFT_RST", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_oclax_stack_base
{
    ...
    struct bdk_oclax_stack_base_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_49_63        : 15;
    ...
    /* struct bdk_oclax_stack_base_cn8 cn81xx; */
...
static inline uint64_t BDK_OCLAX_STACK_BASE(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b0000400ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b0000400ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b0000400ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_STACK_BASE", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_STACK_CUR(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b0000480ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b0000480ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b0000480ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_STACK_CUR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_STACK_STORE_CNT(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b0000460ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b0000460ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b0000460ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_STACK_STORE_CNT", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_STACK_TOP(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b0000420ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b0000420ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b0000420ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_STACK_TOP", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_STACK_WRAP(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b0000440ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b0000440ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b0000440ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_STACK_WRAP", 1, a, 0, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN81XX) && ((a<=1) && (b<=71)))
        return 0x87e0a8100000ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7f);
    if (bdk_is_model(OCTEONTX_CN83XX) && ((a<=2) && (b<=71)))
        return 0x87e0a8100000ll + 0x1000000ll * ((a) & 0x3) + 8ll * ((b) & 0x7f);
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=4) && (b<=71)))
        return 0x87e0b0100000ll + 0x1000000ll * ((a) & 0x7) + 8ll * ((b) & 0x7f);
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=6) && (b<=71)))
        return 0x87e0b0100000ll + 0x1000000ll * ((a) & 0x7) + 8ll * ((b) & 0x7f);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=71)))
        return 0x87e0b0100000ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7f);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b<=71)))
        return 0x87e0b0100000ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x7f);
    __bdk_csr_fatal("OCLAX_STAGEX", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_STATE_ENA_W1C(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b00000b8ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b00000b8ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b00000b8ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_STATE_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_STATE_ENA_W1S(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b00000b0ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b00000b0ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b00000b0ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_STATE_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_STATE_INT(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b0000080ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b0000080ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b0000080ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_STATE_INT", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_STATE_SET(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b00000a0ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b00000a0ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b00000a0ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_STATE_SET", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_OCLAX_TIME(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=6))
        return 0x87e0b00000c0ll + 0x1000000ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=1))
        return 0x87e0b00000c0ll + 0x1000000ll * ((a) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e0b00000c0ll + 0x1000000ll * ((a) & 0x1);
    __bdk_csr_fatal("OCLAX_TIME", 1, a, 0, 0, 0, 0, 0);
}
