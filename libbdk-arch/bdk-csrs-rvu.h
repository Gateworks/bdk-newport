 ...
 */
#define BDK_RVU_BAR_E_RVU_PFX_BAR0(a) (0x840000000000ll + 0x1000000000ll * (a))
#define BDK_RVU_BAR_E_RVU_PFX_BAR0_SIZE 0x10000000ull
#define BDK_RVU_BAR_E_RVU_PFX_FUNCX_BAR2(a,b) (0x840200000000ll + 0x1000000000ll * (a) + 0x2000000ll * (b))
#define BDK_RVU_BAR_E_RVU_PFX_FUNCX_BAR2_SIZE 0x100000ull
#define BDK_RVU_BAR_E_RVU_PFX_FUNCX_BAR4(a,b) (0x840400000000ll + 0x1000000000ll * (a) + 0x2000000ll * (b))
#define BDK_RVU_BAR_E_RVU_PFX_FUNCX_BAR4_SIZE 0x10000ull
...
#define BDK_RVU_BLOCK_ADDR_E_REEX(a) (0x14 + (a))
...
#define BDK_RVU_BLOCK_TYPE_E_REE (0xe)
 ...
 * This is an enum used in csr3 virtual equations.
 */
#define BDK_RVU_BUS_LF_SLOT_E_RVU_BUS_LFX_SLOTX(a,b) (0 + 0x2000000 * (a) + 0x1000 * (b))
 ...
 * This is an enum used in csr3 virtual equations.
 */
#define BDK_RVU_BUSDID_E_RVU_BUSDID (0x840000000000ll)
 ...
 * Enumerates the MSI-X interrupt vectors.
 */
#define BDK_RVU_PF_INT_VEC_E_AFPF_MBOX (6)
#define BDK_RVU_PF_INT_VEC_E_VFFLRX(a) (0 + (a))
#define BDK_RVU_PF_INT_VEC_E_VFMEX(a) (2 + (a))
#define BDK_RVU_PF_INT_VEC_E_VFPF_MBOXX(a) (4 + (a))
...
{
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=15) && (b<=1)))
        return 0x840000002000ll + 0x10ll * ((a) & 0xf) + 8ll * ((b) & 0x1);
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=23) && (b<=1)))
        return 0x840000002000ll + 0x10ll * ((a) & 0x1f) + 8ll * ((b) & 0x1);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=15) && (b<=1)))
        return 0x840000002000ll + 0x10ll * ((a) & 0xf) + 8ll * ((b) & 0x1);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=15) && (b<=1)))
        return 0x840000002000ll + 0x10ll * ((a) & 0xf) + 8ll * ((b) & 0x1);
    __bdk_csr_fatal("RVU_AF_AFPFX_MBOXX", 2, a, b, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_AFPFX_MBOXX(a,b) 0x0 /* RVU_BAR0 */
 ...
 */
union bdk_rvu_af_bar2_aliasx
{
    uint64_t u;
    struct bdk_rvu_af_bar2_aliasx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_rvu_af_bar2_aliasx_s cn; */
};
typedef union bdk_rvu_af_bar2_aliasx bdk_rvu_af_bar2_aliasx_t;

static inline uint64_t BDK_RVU_AF_BAR2_ALIASX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_RVU_AF_BAR2_ALIASX(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && (a<=131071))
        return 0x840009100000ll + 8ll * ((a) & 0x1ffff);
    __bdk_csr_fatal("RVU_AF_BAR2_ALIASX", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_RVU_AF_BAR2_ALIASX(a) bdk_rvu_af_bar2_aliasx_t
#define bustype_BDK_RVU_AF_BAR2_ALIASX(a) BDK_CSR_TYPE_RVU_PF_BAR0
#define basename_BDK_RVU_AF_BAR2_ALIASX(a) "RVU_AF_BAR2_ALIASX"
#define device_bar_BDK_RVU_AF_BAR2_ALIASX(a) 0x0 /* RVU_BAR0 */
#define busnum_BDK_RVU_AF_BAR2_ALIASX(a) (a)
#define arguments_BDK_RVU_AF_BAR2_ALIASX(a) (a),-1,-1,-1
 ...
 * Not implemented. Placeholder for bug33464.
 */
union bdk_rvu_af_bar2_sel
{
    uint64_t u;
    struct bdk_rvu_af_bar2_sel_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_rvu_af_bar2_sel_s cn; */
};
typedef union bdk_rvu_af_bar2_sel bdk_rvu_af_bar2_sel_t;

#define BDK_RVU_AF_BAR2_SEL BDK_RVU_AF_BAR2_SEL_FUNC()
static inline uint64_t BDK_RVU_AF_BAR2_SEL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_RVU_AF_BAR2_SEL_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x840009000000ll;
    __bdk_csr_fatal("RVU_AF_BAR2_SEL", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_BDK_RVU_AF_BAR2_SEL bdk_rvu_af_bar2_sel_t
#define bustype_BDK_RVU_AF_BAR2_SEL BDK_CSR_TYPE_RVU_PF_BAR0
#define basename_BDK_RVU_AF_BAR2_SEL "RVU_AF_BAR2_SEL"
#define device_bar_BDK_RVU_AF_BAR2_SEL 0x0 /* RVU_BAR0 */
#define busnum_BDK_RVU_AF_BAR2_SEL 0
#define arguments_BDK_RVU_AF_BAR2_SEL -1,-1,-1,-1
...
static inline uint64_t BDK_RVU_AF_BLK_RST_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_BLK_RST", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_BLK_RST 0x0 /* RVU_BAR0 */
 ...
 */
union bdk_rvu_af_bp_test
{
    uint64_t u;
    struct bdk_rvu_af_bp_test_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_rvu_af_bp_test_s cn; */
};
typedef union bdk_rvu_af_bp_test bdk_rvu_af_bp_test_t;

#define BDK_RVU_AF_BP_TEST BDK_RVU_AF_BP_TEST_FUNC()
static inline uint64_t BDK_RVU_AF_BP_TEST_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_RVU_AF_BP_TEST_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x840000004000ll;
    __bdk_csr_fatal("RVU_AF_BP_TEST", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_BDK_RVU_AF_BP_TEST bdk_rvu_af_bp_test_t
#define bustype_BDK_RVU_AF_BP_TEST BDK_CSR_TYPE_RVU_PF_BAR0
#define basename_BDK_RVU_AF_BP_TEST "RVU_AF_BP_TEST"
#define device_bar_BDK_RVU_AF_BP_TEST 0x0 /* RVU_BAR0 */
#define busnum_BDK_RVU_AF_BP_TEST 0
#define arguments_BDK_RVU_AF_BP_TEST -1,-1,-1,-1
...
static inline uint64_t BDK_RVU_AF_ECO_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_ECO", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_ECO 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_gen_int
{
    ...
    /* struct bdk_rvu_af_gen_int_s cn9; */
    struct bdk_rvu_af_gen_int_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_rvu_af_gen_int_s cn98xx; */
    /* struct bdk_rvu_af_gen_int_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_gen_int_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_GEN_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_GEN_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_GEN_INT 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_gen_int_ena_w1c
{
    ...
    /* struct bdk_rvu_af_gen_int_ena_w1c_s cn9; */
    struct bdk_rvu_af_gen_int_ena_w1c_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
        uint64_t msix_fault            : 1;  /**< [  1:  1](R/W1C/H) Reads or clears enable for RVU_AF_GEN_INT[MSIX_FAULT]. */
    ...
    /* struct bdk_rvu_af_gen_int_ena_w1c_s cn98xx; */
    /* struct bdk_rvu_af_gen_int_ena_w1c_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_gen_int_ena_w1c_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_GEN_INT_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_GEN_INT_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_GEN_INT_ENA_W1C 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_gen_int_ena_w1s
{
    ...
    /* struct bdk_rvu_af_gen_int_ena_w1s_s cn9; */
    struct bdk_rvu_af_gen_int_ena_w1s_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
        uint64_t msix_fault            : 1;  /**< [  1:  1](R/W1S/H) Reads or sets enable for RVU_AF_GEN_INT[MSIX_FAULT]. */
    ...
    /* struct bdk_rvu_af_gen_int_ena_w1s_s cn98xx; */
    /* struct bdk_rvu_af_gen_int_ena_w1s_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_gen_int_ena_w1s_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_GEN_INT_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_GEN_INT_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_GEN_INT_ENA_W1S 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_gen_int_w1s
{
    ...
    /* struct bdk_rvu_af_gen_int_w1s_s cn9; */
    struct bdk_rvu_af_gen_int_w1s_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
        uint64_t msix_fault            : 1;  /**< [  1:  1](R/W1S/H) Reads or sets RVU_AF_GEN_INT[MSIX_FAULT]. */
    ...
    /* struct bdk_rvu_af_gen_int_w1s_s cn98xx; */
    /* struct bdk_rvu_af_gen_int_w1s_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_gen_int_w1s_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_GEN_INT_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_GEN_INT_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_GEN_INT_W1S 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_AF_HWVF_RST_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_HWVF_RST", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_HWVF_RST 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_AF_MSIXTR_BASE_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_MSIXTR_BASE", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_MSIXTR_BASE 0x0 /* RVU_BAR0 */
 ...
 */
union bdk_rvu_af_pfx_vf_bar4_addr
{
    uint64_t u;
    struct bdk_rvu_af_pfx_vf_bar4_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_rvu_af_pfx_vf_bar4_addr_s cn9; */
    /* struct bdk_rvu_af_pfx_vf_bar4_addr_s cn96xx; */
    /* struct bdk_rvu_af_pfx_vf_bar4_addr_s cn98xx; */
    struct bdk_rvu_af_pfx_vf_bar4_addr_loki
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t addr                  : 48; /**< [ 63: 16](SR/W) When RVU_PRIV_PF()_CFG[PF_VF_IO_BAR4] is set, programmable base physical
                                                                 address of the PF/VF mailbox memory, consisting of RVU_PRIV_PF()_CFG[NVF]
...
typedef union bdk_rvu_af_pfx_vf_bar4_addr bdk_rvu_af_pfx_vf_bar4_addr_t;

static inline uint64_t BDK_RVU_AF_PFX_VF_BAR4_ADDR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_RVU_AF_PFX_VF_BAR4_ADDR(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN96XX_PASS3_X) && (a<=15))
        return 0x840000001000ll + 0x10ll * ((a) & 0xf);
    if (bdk_is_model(OCTEONTX_CN98XX) && (a<=23))
        return 0x840000001000ll + 0x10ll * ((a) & 0x1f);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x840000001000ll + 0x10ll * ((a) & 0xf);
    __bdk_csr_fatal("RVU_AF_PFX_VF_BAR4_ADDR", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_RVU_AF_PFX_VF_BAR4_ADDR(a) bdk_rvu_af_pfx_vf_bar4_addr_t
#define bustype_BDK_RVU_AF_PFX_VF_BAR4_ADDR(a) BDK_CSR_TYPE_RVU_PF_BAR0
#define basename_BDK_RVU_AF_PFX_VF_BAR4_ADDR(a) "RVU_AF_PFX_VF_BAR4_ADDR"
#define device_bar_BDK_RVU_AF_PFX_VF_BAR4_ADDR(a) 0x0 /* RVU_BAR0 */
#define busnum_BDK_RVU_AF_PFX_VF_BAR4_ADDR(a) (a)
#define arguments_BDK_RVU_AF_PFX_VF_BAR4_ADDR(a) (a),-1,-1,-1
...
static inline uint64_t BDK_RVU_AF_PF_BAR4_ADDR_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PF_BAR4_ADDR", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PF_BAR4_ADDR 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pf_rst
{
    ...
    /* struct bdk_rvu_af_pf_rst_s cn9; */
    struct bdk_rvu_af_pf_rst_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_13_63        : 51;
        uint64_t exec                  : 1;  /**< [ 12: 12](R/W1S/H) Execute PF software-initiated reset. When software writes a one to set this bit, hardware
    ...
    /* struct bdk_rvu_af_pf_rst_s cn98xx; */
    /* struct bdk_rvu_af_pf_rst_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pf_rst_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PF_RST_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PF_RST", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PF_RST 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pfaf_mbox_int
{
    ...
    /* struct bdk_rvu_af_pfaf_mbox_int_s cn9; */
    struct bdk_rvu_af_pfaf_mbox_int_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_rvu_af_pfaf_mbox_int_s cn98xx; */
    /* struct bdk_rvu_af_pfaf_mbox_int_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pfaf_mbox_int_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PFAF_MBOX_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PFAF_MBOX_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PFAF_MBOX_INT 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pfaf_mbox_int_ena_w1c
{
    ...
    /* struct bdk_rvu_af_pfaf_mbox_int_ena_w1c_s cn9; */
    struct bdk_rvu_af_pfaf_mbox_int_ena_w1c_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct bdk_rvu_af_pfaf_mbox_int_ena_w1c_s cn98xx; */
    /* struct bdk_rvu_af_pfaf_mbox_int_ena_w1c_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pfaf_mbox_int_ena_w1c_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PFAF_MBOX_INT_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PFAF_MBOX_INT_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PFAF_MBOX_INT_ENA_W1C 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pfaf_mbox_int_ena_w1s
{
    ...
    /* struct bdk_rvu_af_pfaf_mbox_int_ena_w1s_s cn9; */
    struct bdk_rvu_af_pfaf_mbox_int_ena_w1s_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct bdk_rvu_af_pfaf_mbox_int_ena_w1s_s cn98xx; */
    /* struct bdk_rvu_af_pfaf_mbox_int_ena_w1s_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pfaf_mbox_int_ena_w1s_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PFAF_MBOX_INT_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PFAF_MBOX_INT_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PFAF_MBOX_INT_ENA_W1S 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pfaf_mbox_int_w1s
{
    ...
    /* struct bdk_rvu_af_pfaf_mbox_int_w1s_s cn9; */
    struct bdk_rvu_af_pfaf_mbox_int_w1s_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct bdk_rvu_af_pfaf_mbox_int_w1s_s cn98xx; */
    /* struct bdk_rvu_af_pfaf_mbox_int_w1s_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pfaf_mbox_int_w1s_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PFAF_MBOX_INT_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PFAF_MBOX_INT_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PFAF_MBOX_INT_W1S 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pfflr_int
{
    ...
    /* struct bdk_rvu_af_pfflr_int_s cn9; */
    struct bdk_rvu_af_pfflr_int_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct bdk_rvu_af_pfflr_int_s cn98xx; */
    /* struct bdk_rvu_af_pfflr_int_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pfflr_int_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PFFLR_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PFFLR_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PFFLR_INT 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pfflr_int_ena_w1c
{
    ...
    /* struct bdk_rvu_af_pfflr_int_ena_w1c_s cn9; */
    struct bdk_rvu_af_pfflr_int_ena_w1c_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct bdk_rvu_af_pfflr_int_ena_w1c_s cn98xx; */
    /* struct bdk_rvu_af_pfflr_int_ena_w1c_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pfflr_int_ena_w1c_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PFFLR_INT_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PFFLR_INT_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PFFLR_INT_ENA_W1C 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pfflr_int_ena_w1s
{
    ...
    /* struct bdk_rvu_af_pfflr_int_ena_w1s_s cn9; */
    struct bdk_rvu_af_pfflr_int_ena_w1s_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct bdk_rvu_af_pfflr_int_ena_w1s_s cn98xx; */
    /* struct bdk_rvu_af_pfflr_int_ena_w1s_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pfflr_int_ena_w1s_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PFFLR_INT_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PFFLR_INT_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PFFLR_INT_ENA_W1S 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pfflr_int_w1s
{
    ...
    /* struct bdk_rvu_af_pfflr_int_w1s_s cn9; */
    struct bdk_rvu_af_pfflr_int_w1s_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct bdk_rvu_af_pfflr_int_w1s_s cn98xx; */
    /* struct bdk_rvu_af_pfflr_int_w1s_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pfflr_int_w1s_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PFFLR_INT_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PFFLR_INT_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PFFLR_INT_W1S 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pfme_int
{
    ...
    /* struct bdk_rvu_af_pfme_int_s cn9; */
    struct bdk_rvu_af_pfme_int_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct bdk_rvu_af_pfme_int_s cn98xx; */
    /* struct bdk_rvu_af_pfme_int_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pfme_int_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PFME_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PFME_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PFME_INT 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pfme_int_ena_w1c
{
    ...
    /* struct bdk_rvu_af_pfme_int_ena_w1c_s cn9; */
    struct bdk_rvu_af_pfme_int_ena_w1c_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct bdk_rvu_af_pfme_int_ena_w1c_s cn98xx; */
    /* struct bdk_rvu_af_pfme_int_ena_w1c_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pfme_int_ena_w1c_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PFME_INT_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PFME_INT_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PFME_INT_ENA_W1C 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pfme_int_ena_w1s
{
    ...
    /* struct bdk_rvu_af_pfme_int_ena_w1s_s cn9; */
    struct bdk_rvu_af_pfme_int_ena_w1s_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct bdk_rvu_af_pfme_int_ena_w1s_s cn98xx; */
    /* struct bdk_rvu_af_pfme_int_ena_w1s_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pfme_int_ena_w1s_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PFME_INT_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PFME_INT_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PFME_INT_ENA_W1S 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pfme_int_w1s
{
    ...
    /* struct bdk_rvu_af_pfme_int_w1s_s cn9; */
    struct bdk_rvu_af_pfme_int_w1s_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct bdk_rvu_af_pfme_int_w1s_s cn98xx; */
    /* struct bdk_rvu_af_pfme_int_w1s_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pfme_int_w1s_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PFME_INT_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PFME_INT_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PFME_INT_W1S 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pfme_status
{
    ...
    /* struct bdk_rvu_af_pfme_status_s cn9; */
    struct bdk_rvu_af_pfme_status_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct bdk_rvu_af_pfme_status_s cn98xx; */
    /* struct bdk_rvu_af_pfme_status_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pfme_status_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PFME_STATUS_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PFME_STATUS", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PFME_STATUS 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pftrpend
{
    ...
    /* struct bdk_rvu_af_pftrpend_s cn9; */
    struct bdk_rvu_af_pftrpend_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct bdk_rvu_af_pftrpend_s cn98xx; */
    /* struct bdk_rvu_af_pftrpend_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pftrpend_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PFTRPEND_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PFTRPEND", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PFTRPEND 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_pftrpend_w1s
{
    ...
    /* struct bdk_rvu_af_pftrpend_w1s_s cn9; */
    struct bdk_rvu_af_pftrpend_w1s_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct bdk_rvu_af_pftrpend_w1s_s cn98xx; */
    /* struct bdk_rvu_af_pftrpend_w1s_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_pftrpend_w1s_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_PFTRPEND_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_PFTRPEND_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_PFTRPEND_W1S 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_ras
{
    ...
    /* struct bdk_rvu_af_ras_s cn9; */
    struct bdk_rvu_af_ras_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_rvu_af_ras_s cn98xx; */
    /* struct bdk_rvu_af_ras_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_ras_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_RAS_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_RAS", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_RAS 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_ras_ena_w1c
{
    ...
    /* struct bdk_rvu_af_ras_ena_w1c_s cn9; */
    struct bdk_rvu_af_ras_ena_w1c_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
        uint64_t msix_poison           : 1;  /**< [  0:  0](R/W1C/H) Reads or clears enable for RVU_AF_RAS[MSIX_POISON]. */
    ...
    /* struct bdk_rvu_af_ras_ena_w1c_s cn98xx; */
    /* struct bdk_rvu_af_ras_ena_w1c_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_ras_ena_w1c_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_RAS_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_RAS_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_RAS_ENA_W1C 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_ras_ena_w1s
{
    ...
    /* struct bdk_rvu_af_ras_ena_w1s_s cn9; */
    struct bdk_rvu_af_ras_ena_w1s_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
        uint64_t msix_poison           : 1;  /**< [  0:  0](R/W1S/H) Reads or sets enable for RVU_AF_RAS[MSIX_POISON]. */
    ...
    /* struct bdk_rvu_af_ras_ena_w1s_s cn98xx; */
    /* struct bdk_rvu_af_ras_ena_w1s_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_ras_ena_w1s_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_RAS_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_RAS_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_RAS_ENA_W1S 0x0 /* RVU_BAR0 */
...
union bdk_rvu_af_ras_w1s
{
    ...
    /* struct bdk_rvu_af_ras_w1s_s cn9; */
    struct bdk_rvu_af_ras_w1s_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
        uint64_t msix_poison           : 1;  /**< [  0:  0](R/W1S/H) Reads or sets RVU_AF_RAS[MSIX_POISON]. */
    ...
    /* struct bdk_rvu_af_ras_w1s_s cn98xx; */
    /* struct bdk_rvu_af_ras_w1s_cn96xx cnf95xx; */
    /* struct bdk_rvu_af_ras_w1s_cn96xx loki; */
};
...
static inline uint64_t BDK_RVU_AF_RAS_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_AF_RAS_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_AF_RAS_W1S 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PF_BLOCK_ADDRX_DISC(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_BLOCK_ADDRX_DISC", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_BLOCK_ADDRX_DISC(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_PF_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_INT 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_INT_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_PF_INT_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_INT_ENA_W1C 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_INT_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_PF_INT_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_INT_ENA_W1S 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_INT_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_PF_INT_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_INT_W1S 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_MSIX_PBAX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_MSIX_PBAX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_MSIX_PBAX(a) 0x2 /* RVU_BAR2 */
...
union bdk_rvu_pf_msix_vecx_addr
{
    ...
    /* struct bdk_rvu_pf_msix_vecx_addr_s cn9; */
    /* struct bdk_rvu_pf_msix_vecx_addr_s cn96xx; */
    struct bdk_rvu_pf_msix_vecx_addr_cn98xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) PF IOVA to use for MSI-X delivery of this vector. */
    ...
    struct bdk_rvu_pf_msix_vecx_addr_cnf95xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) PF IOVA to use for MSI-X delivery of this vector. */
    ...
    /* struct bdk_rvu_pf_msix_vecx_addr_cn98xx loki; */
};
...
static inline uint64_t BDK_RVU_PF_MSIX_VECX_ADDR(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_MSIX_VECX_ADDR", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_MSIX_VECX_ADDR(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_MSIX_VECX_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_MSIX_VECX_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_MSIX_VECX_CTL(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_PFAF_MBOXX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_PFAF_MBOXX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_PFAF_MBOXX(a) 0x2 /* RVU_BAR2 */
...
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && ((a<=127) && (b<=1)))
        return 0x840200000000ll + 0x1000ll * ((a) & 0x7f) + 8ll * ((b) & 0x1);
    __bdk_csr_fatal("RVU_PF_VFX_PFVF_MBOXX", 2, a, b, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFX_PFVF_MBOXX(a,b) 0x2 /* RVU_BAR2 */
...
union bdk_rvu_pf_vf_bar4_addr
{
    ...
    /* struct bdk_rvu_pf_vf_bar4_addr_s cn9; */
    /* struct bdk_rvu_pf_vf_bar4_addr_s cn96xxp1; */
    struct bdk_rvu_pf_vf_bar4_addr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_rvu_pf_vf_bar4_addr_cn96xxp3 cn98xx; */
    /* struct bdk_rvu_pf_vf_bar4_addr_s cnf95xx; */
    /* struct bdk_rvu_pf_vf_bar4_addr_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_RVU_PF_VF_BAR4_ADDR_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_PF_VF_BAR4_ADDR", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VF_BAR4_ADDR 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_VFFLR_INTX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_VFFLR_INTX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFFLR_INTX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_VFFLR_INT_ENA_W1CX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_VFFLR_INT_ENA_W1CX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFFLR_INT_ENA_W1CX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_VFFLR_INT_ENA_W1SX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_VFFLR_INT_ENA_W1SX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFFLR_INT_ENA_W1SX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_VFFLR_INT_W1SX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_VFFLR_INT_W1SX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFFLR_INT_W1SX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_VFME_INTX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_VFME_INTX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFME_INTX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_VFME_INT_ENA_W1CX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_VFME_INT_ENA_W1CX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFME_INT_ENA_W1CX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_VFME_INT_ENA_W1SX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_VFME_INT_ENA_W1SX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFME_INT_ENA_W1SX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_VFME_INT_W1SX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_VFME_INT_W1SX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFME_INT_W1SX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_VFME_STATUSX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_VFME_STATUSX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFME_STATUSX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_VFPF_MBOX_INTX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_VFPF_MBOX_INTX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFPF_MBOX_INTX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_VFPF_MBOX_INT_ENA_W1CX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_VFPF_MBOX_INT_ENA_W1CX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFPF_MBOX_INT_ENA_W1CX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_VFPF_MBOX_INT_ENA_W1SX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_VFPF_MBOX_INT_ENA_W1SX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFPF_MBOX_INT_ENA_W1SX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_VFPF_MBOX_INT_W1SX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_VFPF_MBOX_INT_W1SX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFPF_MBOX_INT_W1SX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_VFTRPENDX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_VFTRPENDX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFTRPENDX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PF_VFTRPEND_W1SX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PF_VFTRPEND_W1SX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PF_VFTRPEND_W1SX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_PRIV_ACTIVE_PC_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_PRIV_ACTIVE_PC", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_ACTIVE_PC 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PRIV_BLOCK_TYPEX_REV(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PRIV_BLOCK_TYPEX_REV", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_BLOCK_TYPEX_REV(a) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PRIV_CLK_CFG_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_PRIV_CLK_CFG", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_CLK_CFG 0x0 /* RVU_BAR0 */
...
union bdk_rvu_priv_const
{
    ...
    /* struct bdk_rvu_priv_const_s cn9; */
    /* struct bdk_rvu_priv_const_s cn96xx; */
    struct bdk_rvu_priv_const_cn98xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
        uint64_t max_vfs_per_pf        : 8;  /**< [ 47: 40](RO) Maximum number of VFs per RVU PF. */
    ...
    /* struct bdk_rvu_priv_const_cn98xx cnf95xx; */
    /* struct bdk_rvu_priv_const_s loki; */
};
...
static inline uint64_t BDK_RVU_PRIV_CONST_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_PRIV_CONST", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_CONST 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PRIV_GEN_CFG_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_PRIV_GEN_CFG", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_GEN_CFG 0x0 /* RVU_BAR0 */
...
{
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=255) && (b==0)))
        return 0x840008001350ll + 0x10000ll * ((a) & 0xff) + 8ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=255) && (b<=1)))
        return 0x840008001350ll + 0x10000ll * ((a) & 0xff) + 8ll * ((b) & 0x1);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=255) && (b==0)))
        return 0x840008001350ll + 0x10000ll * ((a) & 0xff) + 8ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=255) && (b==0)))
        return 0x840008001350ll + 0x10000ll * ((a) & 0xff) + 8ll * ((b) & 0x0);
    __bdk_csr_fatal("RVU_PRIV_HWVFX_CPTX_CFG", 2, a, b, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_HWVFX_CPTX_CFG(a,b) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PRIV_HWVFX_INT_CFG(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PRIV_HWVFX_INT_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_HWVFX_INT_CFG(a) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PRIV_HWVFX_NIXX_CFG(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=255) && (b==0)))
        return 0x840008001300ll + 0x10000ll * ((a) & 0xff) + 8ll * ((b) & 0x0);
    __bdk_csr_fatal("RVU_PRIV_HWVFX_NIXX_CFG", 2, a, b, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_HWVFX_NIXX_CFG(a,b) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PRIV_HWVFX_NPA_CFG(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PRIV_HWVFX_NPA_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_HWVFX_NPA_CFG(a) 0x0 /* RVU_BAR0 */
 ...
 */
union bdk_rvu_priv_hwvfx_reex_cfg
{
    uint64_t u;
    struct bdk_rvu_priv_hwvfx_reex_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_9_63         : 55;
        uint64_t num_lfs               : 9;  /**< [  8:  0](R/W) Number of LFs from the block that are provisioned to the PF/VF. When non-zero,
    ...
    /* struct bdk_rvu_priv_hwvfx_reex_cfg_s cn; */
};
typedef union bdk_rvu_priv_hwvfx_reex_cfg bdk_rvu_priv_hwvfx_reex_cfg_t;

static inline uint64_t BDK_RVU_PRIV_HWVFX_REEX_CFG(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_RVU_PRIV_HWVFX_REEX_CFG(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=255) && (b<=1)))
        return 0x840008001360ll + 0x10000ll * ((a) & 0xff) + 8ll * ((b) & 0x1);
    __bdk_csr_fatal("RVU_PRIV_HWVFX_REEX_CFG", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_RVU_PRIV_HWVFX_REEX_CFG(a,b) bdk_rvu_priv_hwvfx_reex_cfg_t
#define bustype_BDK_RVU_PRIV_HWVFX_REEX_CFG(a,b) BDK_CSR_TYPE_RVU_PF_BAR0
#define basename_BDK_RVU_PRIV_HWVFX_REEX_CFG(a,b) "RVU_PRIV_HWVFX_REEX_CFG"
#define device_bar_BDK_RVU_PRIV_HWVFX_REEX_CFG(a,b) 0x0 /* RVU_BAR0 */
#define busnum_BDK_RVU_PRIV_HWVFX_REEX_CFG(a,b) (a)
#define arguments_BDK_RVU_PRIV_HWVFX_REEX_CFG(a,b) (a),(b),-1,-1
...
static inline uint64_t BDK_RVU_PRIV_HWVFX_SSO_CFG(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PRIV_HWVFX_SSO_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_HWVFX_SSO_CFG(a) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PRIV_HWVFX_SSOW_CFG(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PRIV_HWVFX_SSOW_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_HWVFX_SSOW_CFG(a) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PRIV_HWVFX_TIM_CFG(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_PRIV_HWVFX_TIM_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_HWVFX_TIM_CFG(a) 0x0 /* RVU_BAR0 */
...
union bdk_rvu_priv_pfx_cfg
{
    ...
    /* struct bdk_rvu_priv_pfx_cfg_s cn9; */
    struct bdk_rvu_priv_pfx_cfg_cn96xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_rvu_priv_pfx_cfg_s cn96xxp3; */
    /* struct bdk_rvu_priv_pfx_cfg_s cn98xx; */
    /* struct bdk_rvu_priv_pfx_cfg_cn96xxp1 cnf95xx; */
    struct bdk_rvu_priv_pfx_cfg_loki
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
        uint64_t pf_vf_io_bar4         : 1;  /**< [ 23: 23](R/W) Selects how the PF/VF mailbox memory in LLC/DRAM is configured accessed by
...
static inline uint64_t BDK_RVU_PRIV_PFX_CFG(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CNF95XX) && (a<=15))
        return 0x840008000100ll + 0x10000ll * ((a) & 0xf);
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x840008000100ll + 0x10000ll * ((a) & 0xf);
    __bdk_csr_fatal("RVU_PRIV_PFX_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_PFX_CFG(a) 0x0 /* RVU_BAR0 */
...
{
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=15) && (b==0)))
        return 0x840008000350ll + 0x10000ll * ((a) & 0xf) + 8ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=23) && (b<=1)))
        return 0x840008000350ll + 0x10000ll * ((a) & 0x1f) + 8ll * ((b) & 0x1);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=15) && (b==0)))
        return 0x840008000350ll + 0x10000ll * ((a) & 0xf) + 8ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=15) && (b==0)))
        return 0x840008000350ll + 0x10000ll * ((a) & 0xf) + 8ll * ((b) & 0x0);
    __bdk_csr_fatal("RVU_PRIV_PFX_CPTX_CFG", 2, a, b, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_PFX_CPTX_CFG(a,b) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PRIV_PFX_ID_CFG(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x840008000120ll + 0x10000ll * ((a) & 0xf);
    __bdk_csr_fatal("RVU_PRIV_PFX_ID_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_PFX_ID_CFG(a) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PRIV_PFX_INT_CFG(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x840008000200ll + 0x10000ll * ((a) & 0xf);
    __bdk_csr_fatal("RVU_PRIV_PFX_INT_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_PFX_INT_CFG(a) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PRIV_PFX_MSIX_CFG(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x840008000110ll + 0x10000ll * ((a) & 0xf);
    __bdk_csr_fatal("RVU_PRIV_PFX_MSIX_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_PFX_MSIX_CFG(a) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PRIV_PFX_NIXX_CFG(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=15) && (b==0)))
        return 0x840008000300ll + 0x10000ll * ((a) & 0xf) + 8ll * ((b) & 0x0);
    __bdk_csr_fatal("RVU_PRIV_PFX_NIXX_CFG", 2, a, b, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_PFX_NIXX_CFG(a,b) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PRIV_PFX_NPA_CFG(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x840008000310ll + 0x10000ll * ((a) & 0xf);
    __bdk_csr_fatal("RVU_PRIV_PFX_NPA_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_PFX_NPA_CFG(a) 0x0 /* RVU_BAR0 */
 ...
 */
union bdk_rvu_priv_pfx_reex_cfg
{
    uint64_t u;
    struct bdk_rvu_priv_pfx_reex_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_9_63         : 55;
        uint64_t num_lfs               : 9;  /**< [  8:  0](R/W) Number of LFs from the block that are provisioned to the PF/VF. When non-zero,
    ...
    /* struct bdk_rvu_priv_pfx_reex_cfg_s cn; */
};
typedef union bdk_rvu_priv_pfx_reex_cfg bdk_rvu_priv_pfx_reex_cfg_t;

static inline uint64_t BDK_RVU_PRIV_PFX_REEX_CFG(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_RVU_PRIV_PFX_REEX_CFG(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=23) && (b<=1)))
        return 0x840008000360ll + 0x10000ll * ((a) & 0x1f) + 8ll * ((b) & 0x1);
    __bdk_csr_fatal("RVU_PRIV_PFX_REEX_CFG", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_RVU_PRIV_PFX_REEX_CFG(a,b) bdk_rvu_priv_pfx_reex_cfg_t
#define bustype_BDK_RVU_PRIV_PFX_REEX_CFG(a,b) BDK_CSR_TYPE_RVU_PF_BAR0
#define basename_BDK_RVU_PRIV_PFX_REEX_CFG(a,b) "RVU_PRIV_PFX_REEX_CFG"
#define device_bar_BDK_RVU_PRIV_PFX_REEX_CFG(a,b) 0x0 /* RVU_BAR0 */
#define busnum_BDK_RVU_PRIV_PFX_REEX_CFG(a,b) (a)
#define arguments_BDK_RVU_PRIV_PFX_REEX_CFG(a,b) (a),(b),-1,-1
...
static inline uint64_t BDK_RVU_PRIV_PFX_SSO_CFG(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x840008000320ll + 0x10000ll * ((a) & 0xf);
    __bdk_csr_fatal("RVU_PRIV_PFX_SSO_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_PFX_SSO_CFG(a) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PRIV_PFX_SSOW_CFG(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x840008000330ll + 0x10000ll * ((a) & 0xf);
    __bdk_csr_fatal("RVU_PRIV_PFX_SSOW_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_PFX_SSOW_CFG(a) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_PRIV_PFX_TIM_CFG(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x840008000340ll + 0x10000ll * ((a) & 0xf);
    __bdk_csr_fatal("RVU_PRIV_PFX_TIM_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_PRIV_PFX_TIM_CFG(a) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_RVU_VF_BLOCK_ADDRX_DISC(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && (a<=31))
        return 0x840200000200ll + 8ll * ((a) & 0x1f);
    __bdk_csr_fatal("RVU_VF_BLOCK_ADDRX_DISC", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_VF_BLOCK_ADDRX_DISC(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_VF_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_VF_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_VF_INT 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_VF_INT_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_VF_INT_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_VF_INT_ENA_W1C 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_VF_INT_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_VF_INT_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_VF_INT_ENA_W1S 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_VF_INT_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("RVU_VF_INT_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_VF_INT_W1S 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_VF_MSIX_PBAX(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && (a==0))
        return 0x8402000f0000ll + 8ll * ((a) & 0x0);
    __bdk_csr_fatal("RVU_VF_MSIX_PBAX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_VF_MSIX_PBAX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_VF_MSIX_VECX_ADDR(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && (a==0))
        return 0x840200080000ll + 0x10ll * ((a) & 0x0);
    __bdk_csr_fatal("RVU_VF_MSIX_VECX_ADDR", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_VF_MSIX_VECX_ADDR(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_VF_MSIX_VECX_CTL(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && (a==0))
        return 0x840200080008ll + 0x10ll * ((a) & 0x0);
    __bdk_csr_fatal("RVU_VF_MSIX_VECX_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_VF_MSIX_VECX_CTL(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_RVU_VF_VFPF_MBOXX(unsigned long a)
{
    ...
    __bdk_csr_fatal("RVU_VF_VFPF_MBOXX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_RVU_VF_VFPF_MBOXX(a) 0x2 /* RVU_BAR2 */
