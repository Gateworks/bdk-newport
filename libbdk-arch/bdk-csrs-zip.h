 ...
 */
#define BDK_ZIP_BAR_E_ZIPX_PF_BAR0(a) (0x838000000000ll + 0x1000000000ll * (a))
#define BDK_ZIP_BAR_E_ZIPX_PF_BAR0_SIZE 0x800000ull
#define BDK_ZIP_BAR_E_ZIPX_PF_BAR4(a) (0x838010000000ll + 0x1000000000ll * (a))
#define BDK_ZIP_BAR_E_ZIPX_PF_BAR4_SIZE 0x100000ull
#define BDK_ZIP_BAR_E_ZIPX_VFX_BAR0(a,b) (0x838020000000ll + 0x1000000000ll * (a) + 0x100000ll * (b))
#define BDK_ZIP_BAR_E_ZIPX_VFX_BAR0_SIZE 0x100000ull
#define BDK_ZIP_BAR_E_ZIPX_VFX_BAR4(a,b) (0x838030000000ll + 0x1000000000ll * (a) + 0x100000ll * (b))
#define BDK_ZIP_BAR_E_ZIPX_VFX_BAR4_SIZE 0x100000ull
#define BDK_ZIP_BAR_E_ZIP_PF_BAR0 (0x838000000000ll)
#define BDK_ZIP_BAR_E_ZIP_PF_BAR0_SIZE 0x800000ull
#define BDK_ZIP_BAR_E_ZIP_PF_BAR4 (0x838010000000ll)
#define BDK_ZIP_BAR_E_ZIP_PF_BAR4_SIZE 0x100000ull
 ...
 */
#define BDK_ZIP_CC_E_DEFLATE (0)
#define BDK_ZIP_CC_E_DEFLATE_DYNHUFF (1)
#define BDK_ZIP_CC_E_DEFLATE_FIXEDHUFF (2)
#define BDK_ZIP_CC_E_LZS (3)
...
#define BDK_ZIP_COMP_E_PTR_ERR (0xf)
...
#define BDK_ZIP_PF_INT_VEC_E_RAS (1)
...
union bdk_zip_inst_s
{
    ...
    /* struct bdk_zip_inst_s_cn9 cn96xx; */
    struct bdk_zip_inst_s_cn98xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t doneint               : 1;  /**< [ 63: 63] Done interrupt. When [DONEINT] is set and the instruction completes,
...
union bdk_zip_zptr_s
{
    ...
    /* struct bdk_zip_zptr_s_cn9 cn96xx; */
    struct bdk_zip_zptr_s_cn98xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t addr                  : 64; /**< [ 63:  0] When a ZIP_ZPTR_S is in an instruction word, [ADDR] is either:
                                                                 * (a) A direct IOVA byte pointer into LLC/DRAM attached memory, or
...
union bdk_zip_zres_s
{
    ...
    /* struct bdk_zip_zres_s_cn9 cn96xx; */
    struct bdk_zip_zres_s_cn98xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t crc32                 : 32; /**< [ 63: 32] The CRC32 result corresponding to the bytes processed in the uncompressed stream,
                                                                 seeded with ZIP_INST_S[ADLERCRC32].
 ...
 */
union bdk_zipx_cmd_ctl
{
    uint64_t u;
    struct bdk_zipx_cmd_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_cmd_ctl_s cn; */
};
typedef union bdk_zipx_cmd_ctl bdk_zipx_cmd_ctl_t;

static inline uint64_t BDK_ZIPX_CMD_CTL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_CMD_CTL(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000000ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_CMD_CTL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_CMD_CTL(a) bdk_zipx_cmd_ctl_t
#define bustype_BDK_ZIPX_CMD_CTL(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_CMD_CTL(a) "ZIPX_CMD_CTL"
#define device_bar_BDK_ZIPX_CMD_CTL(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_CMD_CTL(a) (a)
#define arguments_BDK_ZIPX_CMD_CTL(a) (a),-1,-1,-1
 ...
 * chip.
 */
union bdk_zipx_constants
{
    uint64_t u;
    struct bdk_zipx_constants_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_constants_s cn; */
};
typedef union bdk_zipx_constants bdk_zipx_constants_t;

static inline uint64_t BDK_ZIPX_CONSTANTS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_CONSTANTS(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x8380000000a0ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_CONSTANTS", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_CONSTANTS(a) bdk_zipx_constants_t
#define bustype_BDK_ZIPX_CONSTANTS(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_CONSTANTS(a) "ZIPX_CONSTANTS"
#define device_bar_BDK_ZIPX_CONSTANTS(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_CONSTANTS(a) (a)
#define arguments_BDK_ZIPX_CONSTANTS(a) (a),-1,-1,-1
 ...
 * in this chip.
 */
union bdk_zipx_constants2
{
    uint64_t u;
    struct bdk_zipx_constants2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_constants2_s cn; */
};
typedef union bdk_zipx_constants2 bdk_zipx_constants2_t;

static inline uint64_t BDK_ZIPX_CONSTANTS2(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_CONSTANTS2(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x8380000000a8ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_CONSTANTS2", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_CONSTANTS2(a) bdk_zipx_constants2_t
#define bustype_BDK_ZIPX_CONSTANTS2(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_CONSTANTS2(a) "ZIPX_CONSTANTS2"
#define device_bar_BDK_ZIPX_CONSTANTS2(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_CONSTANTS2(a) (a)
#define arguments_BDK_ZIPX_CONSTANTS2(a) (a),-1,-1,-1
 ...
 */
union bdk_zipx_corex_bp_test
{
    uint64_t u;
    struct bdk_zipx_corex_bp_test_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_corex_bp_test_s cn; */
};
typedef union bdk_zipx_corex_bp_test bdk_zipx_corex_bp_test_t;

static inline uint64_t BDK_ZIPX_COREX_BP_TEST(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_COREX_BP_TEST(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=11)))
        return 0x838000003400ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0xf);
    __bdk_csr_fatal("ZIPX_COREX_BP_TEST", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_COREX_BP_TEST(a,b) bdk_zipx_corex_bp_test_t
#define bustype_BDK_ZIPX_COREX_BP_TEST(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_COREX_BP_TEST(a,b) "ZIPX_COREX_BP_TEST"
#define device_bar_BDK_ZIPX_COREX_BP_TEST(a,b) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_COREX_BP_TEST(a,b) (a)
#define arguments_BDK_ZIPX_COREX_BP_TEST(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_corex_to_sta
{
    uint64_t u;
    struct bdk_zipx_corex_to_sta_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_corex_to_sta_s cn; */
};
typedef union bdk_zipx_corex_to_sta bdk_zipx_corex_to_sta_t;

static inline uint64_t BDK_ZIPX_COREX_TO_STA(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_COREX_TO_STA(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=11)))
        return 0x838000000780ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0xf);
    __bdk_csr_fatal("ZIPX_COREX_TO_STA", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_COREX_TO_STA(a,b) bdk_zipx_corex_to_sta_t
#define bustype_BDK_ZIPX_COREX_TO_STA(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_COREX_TO_STA(a,b) "ZIPX_COREX_TO_STA"
#define device_bar_BDK_ZIPX_COREX_TO_STA(a,b) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_COREX_TO_STA(a,b) (a)
#define arguments_BDK_ZIPX_COREX_TO_STA(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_core_reset
{
    uint64_t u;
    struct bdk_zipx_core_reset_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_core_reset_s cn; */
};
typedef union bdk_zipx_core_reset bdk_zipx_core_reset_t;

static inline uint64_t BDK_ZIPX_CORE_RESET(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_CORE_RESET(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000300ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_CORE_RESET", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_CORE_RESET(a) bdk_zipx_core_reset_t
#define bustype_BDK_ZIPX_CORE_RESET(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_CORE_RESET(a) "ZIPX_CORE_RESET"
#define device_bar_BDK_ZIPX_CORE_RESET(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_CORE_RESET(a) (a)
#define arguments_BDK_ZIPX_CORE_RESET(a) (a),-1,-1,-1
 ...
 */
union bdk_zipx_core_to_cfg
{
    uint64_t u;
    struct bdk_zipx_core_to_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_core_to_cfg_s cn; */
};
typedef union bdk_zipx_core_to_cfg bdk_zipx_core_to_cfg_t;

static inline uint64_t BDK_ZIPX_CORE_TO_CFG(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_CORE_TO_CFG(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000700ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_CORE_TO_CFG", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_CORE_TO_CFG(a) bdk_zipx_core_to_cfg_t
#define bustype_BDK_ZIPX_CORE_TO_CFG(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_CORE_TO_CFG(a) "ZIPX_CORE_TO_CFG"
#define device_bar_BDK_ZIPX_CORE_TO_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_CORE_TO_CFG(a) (a)
#define arguments_BDK_ZIPX_CORE_TO_CFG(a) (a),-1,-1,-1
 ...
 */
union bdk_zipx_ctl_cfg
{
    uint64_t u;
    struct bdk_zipx_ctl_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_ctl_cfg_s cn; */
};
typedef union bdk_zipx_ctl_cfg bdk_zipx_ctl_cfg_t;

static inline uint64_t BDK_ZIPX_CTL_CFG(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_CTL_CFG(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000560ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_CTL_CFG", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_CTL_CFG(a) bdk_zipx_ctl_cfg_t
#define bustype_BDK_ZIPX_CTL_CFG(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_CTL_CFG(a) "ZIPX_CTL_CFG"
#define device_bar_BDK_ZIPX_CTL_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_CTL_CFG(a) (a)
#define arguments_BDK_ZIPX_CTL_CFG(a) (a),-1,-1,-1
 ...
 */
union bdk_zipx_dbg_corex_inst
{
    uint64_t u;
    struct bdk_zipx_dbg_corex_inst_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_dbg_corex_inst_s cn; */
};
typedef union bdk_zipx_dbg_corex_inst bdk_zipx_dbg_corex_inst_t;

static inline uint64_t BDK_ZIPX_DBG_COREX_INST(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_DBG_COREX_INST(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=11)))
        return 0x838000003000ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0xf);
    __bdk_csr_fatal("ZIPX_DBG_COREX_INST", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_DBG_COREX_INST(a,b) bdk_zipx_dbg_corex_inst_t
#define bustype_BDK_ZIPX_DBG_COREX_INST(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_DBG_COREX_INST(a,b) "ZIPX_DBG_COREX_INST"
#define device_bar_BDK_ZIPX_DBG_COREX_INST(a,b) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_DBG_COREX_INST(a,b) (a)
#define arguments_BDK_ZIPX_DBG_COREX_INST(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_dbg_corex_sta
{
    uint64_t u;
    struct bdk_zipx_dbg_corex_sta_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t busy                  : 1;  /**< [ 63: 63](RO/H) Core state. 0 = core is idle; 1 = core is busy. */
    ...
    /* struct bdk_zipx_dbg_corex_sta_s cn; */
};
typedef union bdk_zipx_dbg_corex_sta bdk_zipx_dbg_corex_sta_t;

static inline uint64_t BDK_ZIPX_DBG_COREX_STA(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_DBG_COREX_STA(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=11)))
        return 0x838000003200ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0xf);
    __bdk_csr_fatal("ZIPX_DBG_COREX_STA", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_DBG_COREX_STA(a,b) bdk_zipx_dbg_corex_sta_t
#define bustype_BDK_ZIPX_DBG_COREX_STA(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_DBG_COREX_STA(a,b) "ZIPX_DBG_COREX_STA"
#define device_bar_BDK_ZIPX_DBG_COREX_STA(a,b) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_DBG_COREX_STA(a,b) (a)
#define arguments_BDK_ZIPX_DBG_COREX_STA(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_dbg_quex_sta
{
    uint64_t u;
    struct bdk_zipx_dbg_quex_sta_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_dbg_quex_sta_s cn; */
};
typedef union bdk_zipx_dbg_quex_sta bdk_zipx_dbg_quex_sta_t;

static inline uint64_t BDK_ZIPX_DBG_QUEX_STA(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_DBG_QUEX_STA(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838000001800ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_DBG_QUEX_STA", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_DBG_QUEX_STA(a,b) bdk_zipx_dbg_quex_sta_t
#define bustype_BDK_ZIPX_DBG_QUEX_STA(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_DBG_QUEX_STA(a,b) "ZIPX_DBG_QUEX_STA"
#define device_bar_BDK_ZIPX_DBG_QUEX_STA(a,b) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_DBG_QUEX_STA(a,b) (a)
#define arguments_BDK_ZIPX_DBG_QUEX_STA(a,b) (a),(b),-1,-1
...
union bdk_zipx_eco
{
    ...
    /* struct bdk_zipx_eco_s cn; */
};
typedef union bdk_zipx_eco bdk_zipx_eco_t;

static inline uint64_t BDK_ZIPX_ECO(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_ECO(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x8380000005f0ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_ECO", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_ECO(a) bdk_zipx_eco_t
#define bustype_BDK_ZIPX_ECO(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_ECO(a) "ZIPX_ECO"
#define device_bar_BDK_ZIPX_ECO(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_ECO(a) (a)
#define arguments_BDK_ZIPX_ECO(a) (a),-1,-1,-1
 ...
 */
union bdk_zipx_pf_active_pc
{
    uint64_t u;
    struct bdk_zipx_pf_active_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_pf_active_pc_s cn; */
};
typedef union bdk_zipx_pf_active_pc bdk_zipx_pf_active_pc_t;

static inline uint64_t BDK_ZIPX_PF_ACTIVE_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_ACTIVE_PC(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000450ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_PF_ACTIVE_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_ACTIVE_PC(a) bdk_zipx_pf_active_pc_t
#define bustype_BDK_ZIPX_PF_ACTIVE_PC(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_ACTIVE_PC(a) "ZIPX_PF_ACTIVE_PC"
#define device_bar_BDK_ZIPX_PF_ACTIVE_PC(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_PF_ACTIVE_PC(a) (a)
#define arguments_BDK_ZIPX_PF_ACTIVE_PC(a) (a),-1,-1,-1
 ...
 */
union bdk_zipx_pf_inst_latency_pc
{
    uint64_t u;
    struct bdk_zipx_pf_inst_latency_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_pf_inst_latency_pc_s cn; */
};
typedef union bdk_zipx_pf_inst_latency_pc bdk_zipx_pf_inst_latency_pc_t;

static inline uint64_t BDK_ZIPX_PF_INST_LATENCY_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_INST_LATENCY_PC(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000420ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_PF_INST_LATENCY_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_INST_LATENCY_PC(a) bdk_zipx_pf_inst_latency_pc_t
#define bustype_BDK_ZIPX_PF_INST_LATENCY_PC(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_INST_LATENCY_PC(a) "ZIPX_PF_INST_LATENCY_PC"
#define device_bar_BDK_ZIPX_PF_INST_LATENCY_PC(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_PF_INST_LATENCY_PC(a) (a)
#define arguments_BDK_ZIPX_PF_INST_LATENCY_PC(a) (a),-1,-1,-1
 ...
 */
union bdk_zipx_pf_inst_req_pc
{
    uint64_t u;
    struct bdk_zipx_pf_inst_req_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_pf_inst_req_pc_s cn; */
};
typedef union bdk_zipx_pf_inst_req_pc bdk_zipx_pf_inst_req_pc_t;

static inline uint64_t BDK_ZIPX_PF_INST_REQ_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_INST_REQ_PC(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000410ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_PF_INST_REQ_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_INST_REQ_PC(a) bdk_zipx_pf_inst_req_pc_t
#define bustype_BDK_ZIPX_PF_INST_REQ_PC(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_INST_REQ_PC(a) "ZIPX_PF_INST_REQ_PC"
#define device_bar_BDK_ZIPX_PF_INST_REQ_PC(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_PF_INST_REQ_PC(a) (a)
#define arguments_BDK_ZIPX_PF_INST_REQ_PC(a) (a),-1,-1,-1
 ...
 */
union bdk_zipx_pf_mbox_ena_w1cx
{
    uint64_t u;
    struct bdk_zipx_pf_mbox_ena_w1cx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_pf_mbox_ena_w1cx_s cn; */
};
typedef union bdk_zipx_pf_mbox_ena_w1cx bdk_zipx_pf_mbox_ena_w1cx_t;

static inline uint64_t BDK_ZIPX_PF_MBOX_ENA_W1CX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_MBOX_ENA_W1CX(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b==0)))
        return 0x838000000940ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __bdk_csr_fatal("ZIPX_PF_MBOX_ENA_W1CX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_MBOX_ENA_W1CX(a,b) bdk_zipx_pf_mbox_ena_w1cx_t
#define bustype_BDK_ZIPX_PF_MBOX_ENA_W1CX(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_MBOX_ENA_W1CX(a,b) "ZIPX_PF_MBOX_ENA_W1CX"
#define device_bar_BDK_ZIPX_PF_MBOX_ENA_W1CX(a,b) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_PF_MBOX_ENA_W1CX(a,b) (a)
#define arguments_BDK_ZIPX_PF_MBOX_ENA_W1CX(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_pf_mbox_ena_w1sx
{
    uint64_t u;
    struct bdk_zipx_pf_mbox_ena_w1sx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_pf_mbox_ena_w1sx_s cn; */
};
typedef union bdk_zipx_pf_mbox_ena_w1sx bdk_zipx_pf_mbox_ena_w1sx_t;

static inline uint64_t BDK_ZIPX_PF_MBOX_ENA_W1SX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_MBOX_ENA_W1SX(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b==0)))
        return 0x838000000960ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __bdk_csr_fatal("ZIPX_PF_MBOX_ENA_W1SX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_MBOX_ENA_W1SX(a,b) bdk_zipx_pf_mbox_ena_w1sx_t
#define bustype_BDK_ZIPX_PF_MBOX_ENA_W1SX(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_MBOX_ENA_W1SX(a,b) "ZIPX_PF_MBOX_ENA_W1SX"
#define device_bar_BDK_ZIPX_PF_MBOX_ENA_W1SX(a,b) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_PF_MBOX_ENA_W1SX(a,b) (a)
#define arguments_BDK_ZIPX_PF_MBOX_ENA_W1SX(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_pf_mbox_intx
{
    uint64_t u;
    struct bdk_zipx_pf_mbox_intx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_pf_mbox_intx_s cn; */
};
typedef union bdk_zipx_pf_mbox_intx bdk_zipx_pf_mbox_intx_t;

static inline uint64_t BDK_ZIPX_PF_MBOX_INTX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_MBOX_INTX(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b==0)))
        return 0x838000000900ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __bdk_csr_fatal("ZIPX_PF_MBOX_INTX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_MBOX_INTX(a,b) bdk_zipx_pf_mbox_intx_t
#define bustype_BDK_ZIPX_PF_MBOX_INTX(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_MBOX_INTX(a,b) "ZIPX_PF_MBOX_INTX"
#define device_bar_BDK_ZIPX_PF_MBOX_INTX(a,b) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_PF_MBOX_INTX(a,b) (a)
#define arguments_BDK_ZIPX_PF_MBOX_INTX(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_pf_mbox_int_w1sx
{
    uint64_t u;
    struct bdk_zipx_pf_mbox_int_w1sx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_pf_mbox_int_w1sx_s cn; */
};
typedef union bdk_zipx_pf_mbox_int_w1sx bdk_zipx_pf_mbox_int_w1sx_t;

static inline uint64_t BDK_ZIPX_PF_MBOX_INT_W1SX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_MBOX_INT_W1SX(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b==0)))
        return 0x838000000920ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __bdk_csr_fatal("ZIPX_PF_MBOX_INT_W1SX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_MBOX_INT_W1SX(a,b) bdk_zipx_pf_mbox_int_w1sx_t
#define bustype_BDK_ZIPX_PF_MBOX_INT_W1SX(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_MBOX_INT_W1SX(a,b) "ZIPX_PF_MBOX_INT_W1SX"
#define device_bar_BDK_ZIPX_PF_MBOX_INT_W1SX(a,b) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_PF_MBOX_INT_W1SX(a,b) (a)
#define arguments_BDK_ZIPX_PF_MBOX_INT_W1SX(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_pf_msix_pbax
{
    uint64_t u;
    struct bdk_zipx_pf_msix_pbax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_pf_msix_pbax_s cn; */
};
typedef union bdk_zipx_pf_msix_pbax bdk_zipx_pf_msix_pbax_t;

static inline uint64_t BDK_ZIPX_PF_MSIX_PBAX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_MSIX_PBAX(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b==0)))
        return 0x8380100f0000ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __bdk_csr_fatal("ZIPX_PF_MSIX_PBAX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_MSIX_PBAX(a,b) bdk_zipx_pf_msix_pbax_t
#define bustype_BDK_ZIPX_PF_MSIX_PBAX(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_MSIX_PBAX(a,b) "ZIPX_PF_MSIX_PBAX"
#define device_bar_BDK_ZIPX_PF_MSIX_PBAX(a,b) 0x4 /* PF_BAR4 */
#define busnum_BDK_ZIPX_PF_MSIX_PBAX(a,b) (a)
#define arguments_BDK_ZIPX_PF_MSIX_PBAX(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_pf_msix_vecx_addr
{
    uint64_t u;
    struct bdk_zipx_pf_msix_vecx_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_pf_msix_vecx_addr_s cn; */
};
typedef union bdk_zipx_pf_msix_vecx_addr bdk_zipx_pf_msix_vecx_addr_t;

static inline uint64_t BDK_ZIPX_PF_MSIX_VECX_ADDR(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_MSIX_VECX_ADDR(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=1)))
        return 0x838010000000ll + 0x1000000000ll * ((a) & 0x0) + 0x10ll * ((b) & 0x1);
    __bdk_csr_fatal("ZIPX_PF_MSIX_VECX_ADDR", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_MSIX_VECX_ADDR(a,b) bdk_zipx_pf_msix_vecx_addr_t
#define bustype_BDK_ZIPX_PF_MSIX_VECX_ADDR(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_MSIX_VECX_ADDR(a,b) "ZIPX_PF_MSIX_VECX_ADDR"
#define device_bar_BDK_ZIPX_PF_MSIX_VECX_ADDR(a,b) 0x4 /* PF_BAR4 */
#define busnum_BDK_ZIPX_PF_MSIX_VECX_ADDR(a,b) (a)
#define arguments_BDK_ZIPX_PF_MSIX_VECX_ADDR(a,b) (a),(b),-1,-1
 ...
 * This register is the MSI-X vector table, indexed by the ZIP_PF_INT_VEC_E enumeration.
 */
union bdk_zipx_pf_msix_vecx_ctl
{
    uint64_t u;
    struct bdk_zipx_pf_msix_vecx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_pf_msix_vecx_ctl_s cn; */
};
typedef union bdk_zipx_pf_msix_vecx_ctl bdk_zipx_pf_msix_vecx_ctl_t;

static inline uint64_t BDK_ZIPX_PF_MSIX_VECX_CTL(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_MSIX_VECX_CTL(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=1)))
        return 0x838010000008ll + 0x1000000000ll * ((a) & 0x0) + 0x10ll * ((b) & 0x1);
    __bdk_csr_fatal("ZIPX_PF_MSIX_VECX_CTL", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_MSIX_VECX_CTL(a,b) bdk_zipx_pf_msix_vecx_ctl_t
#define bustype_BDK_ZIPX_PF_MSIX_VECX_CTL(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_MSIX_VECX_CTL(a,b) "ZIPX_PF_MSIX_VECX_CTL"
#define device_bar_BDK_ZIPX_PF_MSIX_VECX_CTL(a,b) 0x4 /* PF_BAR4 */
#define busnum_BDK_ZIPX_PF_MSIX_VECX_CTL(a,b) (a)
#define arguments_BDK_ZIPX_PF_MSIX_VECX_CTL(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_pf_quex_gmctl
{
    uint64_t u;
    struct bdk_zipx_pf_quex_gmctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_pf_quex_gmctl_s cn; */
};
typedef union bdk_zipx_pf_quex_gmctl bdk_zipx_pf_quex_gmctl_t;

static inline uint64_t BDK_ZIPX_PF_QUEX_GMCTL(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_QUEX_GMCTL(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838000000800ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_PF_QUEX_GMCTL", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_QUEX_GMCTL(a,b) bdk_zipx_pf_quex_gmctl_t
#define bustype_BDK_ZIPX_PF_QUEX_GMCTL(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_QUEX_GMCTL(a,b) "ZIPX_PF_QUEX_GMCTL"
#define device_bar_BDK_ZIPX_PF_QUEX_GMCTL(a,b) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_PF_QUEX_GMCTL(a,b) (a)
#define arguments_BDK_ZIPX_PF_QUEX_GMCTL(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_pf_ras
{
    uint64_t u;
    struct bdk_zipx_pf_ras_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_pf_ras_s cn; */
};
typedef union bdk_zipx_pf_ras bdk_zipx_pf_ras_t;

static inline uint64_t BDK_ZIPX_PF_RAS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_RAS(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000980ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_PF_RAS", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_RAS(a) bdk_zipx_pf_ras_t
#define bustype_BDK_ZIPX_PF_RAS(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_RAS(a) "ZIPX_PF_RAS"
#define device_bar_BDK_ZIPX_PF_RAS(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_PF_RAS(a) (a)
#define arguments_BDK_ZIPX_PF_RAS(a) (a),-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union bdk_zipx_pf_ras_ena_w1c
{
    uint64_t u;
    struct bdk_zipx_pf_ras_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
    ...
    /* struct bdk_zipx_pf_ras_ena_w1c_s cn; */
};
typedef union bdk_zipx_pf_ras_ena_w1c bdk_zipx_pf_ras_ena_w1c_t;

static inline uint64_t BDK_ZIPX_PF_RAS_ENA_W1C(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_RAS_ENA_W1C(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000990ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_PF_RAS_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_RAS_ENA_W1C(a) bdk_zipx_pf_ras_ena_w1c_t
#define bustype_BDK_ZIPX_PF_RAS_ENA_W1C(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_RAS_ENA_W1C(a) "ZIPX_PF_RAS_ENA_W1C"
#define device_bar_BDK_ZIPX_PF_RAS_ENA_W1C(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_PF_RAS_ENA_W1C(a) (a)
#define arguments_BDK_ZIPX_PF_RAS_ENA_W1C(a) (a),-1,-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union bdk_zipx_pf_ras_ena_w1s
{
    uint64_t u;
    struct bdk_zipx_pf_ras_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
    ...
    /* struct bdk_zipx_pf_ras_ena_w1s_s cn; */
};
typedef union bdk_zipx_pf_ras_ena_w1s bdk_zipx_pf_ras_ena_w1s_t;

static inline uint64_t BDK_ZIPX_PF_RAS_ENA_W1S(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_RAS_ENA_W1S(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000998ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_PF_RAS_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_RAS_ENA_W1S(a) bdk_zipx_pf_ras_ena_w1s_t
#define bustype_BDK_ZIPX_PF_RAS_ENA_W1S(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_RAS_ENA_W1S(a) "ZIPX_PF_RAS_ENA_W1S"
#define device_bar_BDK_ZIPX_PF_RAS_ENA_W1S(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_PF_RAS_ENA_W1S(a) (a)
#define arguments_BDK_ZIPX_PF_RAS_ENA_W1S(a) (a),-1,-1,-1
 ...
 * This register sets interrupt bits.
 */
union bdk_zipx_pf_ras_w1s
{
    uint64_t u;
    struct bdk_zipx_pf_ras_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
    ...
    /* struct bdk_zipx_pf_ras_w1s_s cn; */
};
typedef union bdk_zipx_pf_ras_w1s bdk_zipx_pf_ras_w1s_t;

static inline uint64_t BDK_ZIPX_PF_RAS_W1S(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_RAS_W1S(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000988ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_PF_RAS_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_RAS_W1S(a) bdk_zipx_pf_ras_w1s_t
#define bustype_BDK_ZIPX_PF_RAS_W1S(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_RAS_W1S(a) "ZIPX_PF_RAS_W1S"
#define device_bar_BDK_ZIPX_PF_RAS_W1S(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_PF_RAS_W1S(a) (a)
#define arguments_BDK_ZIPX_PF_RAS_W1S(a) (a),-1,-1,-1
 ...
 */
union bdk_zipx_pf_rd_latency_pc
{
    uint64_t u;
    struct bdk_zipx_pf_rd_latency_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_pf_rd_latency_pc_s cn; */
};
typedef union bdk_zipx_pf_rd_latency_pc bdk_zipx_pf_rd_latency_pc_t;

static inline uint64_t BDK_ZIPX_PF_RD_LATENCY_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_RD_LATENCY_PC(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000440ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_PF_RD_LATENCY_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_RD_LATENCY_PC(a) bdk_zipx_pf_rd_latency_pc_t
#define bustype_BDK_ZIPX_PF_RD_LATENCY_PC(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_RD_LATENCY_PC(a) "ZIPX_PF_RD_LATENCY_PC"
#define device_bar_BDK_ZIPX_PF_RD_LATENCY_PC(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_PF_RD_LATENCY_PC(a) (a)
#define arguments_BDK_ZIPX_PF_RD_LATENCY_PC(a) (a),-1,-1,-1
 ...
 */
union bdk_zipx_pf_rd_req_pc
{
    uint64_t u;
    struct bdk_zipx_pf_rd_req_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_pf_rd_req_pc_s cn; */
};
typedef union bdk_zipx_pf_rd_req_pc bdk_zipx_pf_rd_req_pc_t;

static inline uint64_t BDK_ZIPX_PF_RD_REQ_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_RD_REQ_PC(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000430ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_PF_RD_REQ_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_RD_REQ_PC(a) bdk_zipx_pf_rd_req_pc_t
#define bustype_BDK_ZIPX_PF_RD_REQ_PC(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_RD_REQ_PC(a) "ZIPX_PF_RD_REQ_PC"
#define device_bar_BDK_ZIPX_PF_RD_REQ_PC(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_PF_RD_REQ_PC(a) (a)
#define arguments_BDK_ZIPX_PF_RD_REQ_PC(a) (a),-1,-1,-1
 ...
 */
union bdk_zipx_pf_vfx_mboxx
{
    uint64_t u;
    struct bdk_zipx_pf_vfx_mboxx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_pf_vfx_mboxx_s cn; */
};
typedef union bdk_zipx_pf_vfx_mboxx bdk_zipx_pf_vfx_mboxx_t;

static inline uint64_t BDK_ZIPX_PF_VFX_MBOXX(unsigned long a, unsigned long b, unsigned long c) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_PF_VFX_MBOXX(unsigned long a, unsigned long b, unsigned long c)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7) && (c<=1)))
        return 0x838000002000ll + 0x1000000000ll * ((a) & 0x0) + 0x10ll * ((b) & 0x7) + 8ll * ((c) & 0x1);
    __bdk_csr_fatal("ZIPX_PF_VFX_MBOXX", 3, a, b, c, 0, 0, 0);
}

#define typedef_BDK_ZIPX_PF_VFX_MBOXX(a,b,c) bdk_zipx_pf_vfx_mboxx_t
#define bustype_BDK_ZIPX_PF_VFX_MBOXX(a,b,c) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_PF_VFX_MBOXX(a,b,c) "ZIPX_PF_VFX_MBOXX"
#define device_bar_BDK_ZIPX_PF_VFX_MBOXX(a,b,c) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_PF_VFX_MBOXX(a,b,c) (a)
#define arguments_BDK_ZIPX_PF_VFX_MBOXX(a,b,c) (a),(b),(c),-1
 ...
 * These registers reflect status of the ZIP instruction queues and are for debug use only.
 */
union bdk_zipx_quex_gcfg
{
    uint64_t u;
    struct bdk_zipx_quex_gcfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_quex_gcfg_s cn; */
};
typedef union bdk_zipx_quex_gcfg bdk_zipx_quex_gcfg_t;

static inline uint64_t BDK_ZIPX_QUEX_GCFG(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_QUEX_GCFG(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838000001a00ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_QUEX_GCFG", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_QUEX_GCFG(a,b) bdk_zipx_quex_gcfg_t
#define bustype_BDK_ZIPX_QUEX_GCFG(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_QUEX_GCFG(a,b) "ZIPX_QUEX_GCFG"
#define device_bar_BDK_ZIPX_QUEX_GCFG(a,b) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_QUEX_GCFG(a,b) (a)
#define arguments_BDK_ZIPX_QUEX_GCFG(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_quex_map
{
    uint64_t u;
    struct bdk_zipx_quex_map_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_quex_map_s cn; */
};
typedef union bdk_zipx_quex_map bdk_zipx_quex_map_t;

static inline uint64_t BDK_ZIPX_QUEX_MAP(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_QUEX_MAP(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838000001400ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_QUEX_MAP", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_QUEX_MAP(a,b) bdk_zipx_quex_map_t
#define bustype_BDK_ZIPX_QUEX_MAP(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_QUEX_MAP(a,b) "ZIPX_QUEX_MAP"
#define device_bar_BDK_ZIPX_QUEX_MAP(a,b) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_QUEX_MAP(a,b) (a)
#define arguments_BDK_ZIPX_QUEX_MAP(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_quex_sbuf_ctl
{
    uint64_t u;
    struct bdk_zipx_quex_sbuf_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_quex_sbuf_ctl_s cn; */
};
typedef union bdk_zipx_quex_sbuf_ctl bdk_zipx_quex_sbuf_ctl_t;

static inline uint64_t BDK_ZIPX_QUEX_SBUF_CTL(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_QUEX_SBUF_CTL(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838000001200ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_QUEX_SBUF_CTL", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_QUEX_SBUF_CTL(a,b) bdk_zipx_quex_sbuf_ctl_t
#define bustype_BDK_ZIPX_QUEX_SBUF_CTL(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_QUEX_SBUF_CTL(a,b) "ZIPX_QUEX_SBUF_CTL"
#define device_bar_BDK_ZIPX_QUEX_SBUF_CTL(a,b) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_QUEX_SBUF_CTL(a,b) (a)
#define arguments_BDK_ZIPX_QUEX_SBUF_CTL(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_que_pri
{
    uint64_t u;
    struct bdk_zipx_que_pri_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_que_pri_s cn; */
};
typedef union bdk_zipx_que_pri bdk_zipx_que_pri_t;

static inline uint64_t BDK_ZIPX_QUE_PRI(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_QUE_PRI(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000508ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_QUE_PRI", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_QUE_PRI(a) bdk_zipx_que_pri_t
#define bustype_BDK_ZIPX_QUE_PRI(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_QUE_PRI(a) "ZIPX_QUE_PRI"
#define device_bar_BDK_ZIPX_QUE_PRI(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_QUE_PRI(a) (a)
#define arguments_BDK_ZIPX_QUE_PRI(a) (a),-1,-1,-1
 ...
 */
union bdk_zipx_que_reset
{
    uint64_t u;
    struct bdk_zipx_que_reset_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
    ...
    /* struct bdk_zipx_que_reset_s cn; */
};
typedef union bdk_zipx_que_reset bdk_zipx_que_reset_t;

static inline uint64_t BDK_ZIPX_QUE_RESET(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_QUE_RESET(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000400ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_QUE_RESET", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_QUE_RESET(a) bdk_zipx_que_reset_t
#define bustype_BDK_ZIPX_QUE_RESET(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_QUE_RESET(a) "ZIPX_QUE_RESET"
#define device_bar_BDK_ZIPX_QUE_RESET(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_QUE_RESET(a) (a)
#define arguments_BDK_ZIPX_QUE_RESET(a) (a),-1,-1,-1
 ...
 */
union bdk_zipx_throttle
{
    uint64_t u;
    struct bdk_zipx_throttle_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_throttle_s cn; */
};
typedef union bdk_zipx_throttle bdk_zipx_throttle_t;

static inline uint64_t BDK_ZIPX_THROTTLE(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_THROTTLE(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && (a==0))
        return 0x838000000010ll + 0x1000000000ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIPX_THROTTLE", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_THROTTLE(a) bdk_zipx_throttle_t
#define bustype_BDK_ZIPX_THROTTLE(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_THROTTLE(a) "ZIPX_THROTTLE"
#define device_bar_BDK_ZIPX_THROTTLE(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIPX_THROTTLE(a) (a)
#define arguments_BDK_ZIPX_THROTTLE(a) (a),-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union bdk_zipx_vfx_misc_ena_w1c
{
    uint64_t u;
    struct bdk_zipx_vfx_misc_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
    ...
    /* struct bdk_zipx_vfx_misc_ena_w1c_s cn; */
};
typedef union bdk_zipx_vfx_misc_ena_w1c bdk_zipx_vfx_misc_ena_w1c_t;

static inline uint64_t BDK_ZIPX_VFX_MISC_ENA_W1C(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VFX_MISC_ENA_W1C(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838020000330ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_VFX_MISC_ENA_W1C", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VFX_MISC_ENA_W1C(a,b) bdk_zipx_vfx_misc_ena_w1c_t
#define bustype_BDK_ZIPX_VFX_MISC_ENA_W1C(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VFX_MISC_ENA_W1C(a,b) "ZIPX_VFX_MISC_ENA_W1C"
#define device_bar_BDK_ZIPX_VFX_MISC_ENA_W1C(a,b) 0x0 /* VF_BAR0 */
#define busnum_BDK_ZIPX_VFX_MISC_ENA_W1C(a,b) (a)
#define arguments_BDK_ZIPX_VFX_MISC_ENA_W1C(a,b) (a),(b),-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union bdk_zipx_vfx_misc_ena_w1s
{
    uint64_t u;
    struct bdk_zipx_vfx_misc_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
    ...
    /* struct bdk_zipx_vfx_misc_ena_w1s_s cn; */
};
typedef union bdk_zipx_vfx_misc_ena_w1s bdk_zipx_vfx_misc_ena_w1s_t;

static inline uint64_t BDK_ZIPX_VFX_MISC_ENA_W1S(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VFX_MISC_ENA_W1S(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838020000320ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_VFX_MISC_ENA_W1S", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VFX_MISC_ENA_W1S(a,b) bdk_zipx_vfx_misc_ena_w1s_t
#define bustype_BDK_ZIPX_VFX_MISC_ENA_W1S(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VFX_MISC_ENA_W1S(a,b) "ZIPX_VFX_MISC_ENA_W1S"
#define device_bar_BDK_ZIPX_VFX_MISC_ENA_W1S(a,b) 0x0 /* VF_BAR0 */
#define busnum_BDK_ZIPX_VFX_MISC_ENA_W1S(a,b) (a)
#define arguments_BDK_ZIPX_VFX_MISC_ENA_W1S(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_vfx_misc_int
{
    uint64_t u;
    struct bdk_zipx_vfx_misc_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
    ...
    /* struct bdk_zipx_vfx_misc_int_s cn; */
};
typedef union bdk_zipx_vfx_misc_int bdk_zipx_vfx_misc_int_t;

static inline uint64_t BDK_ZIPX_VFX_MISC_INT(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VFX_MISC_INT(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838020000300ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_VFX_MISC_INT", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VFX_MISC_INT(a,b) bdk_zipx_vfx_misc_int_t
#define bustype_BDK_ZIPX_VFX_MISC_INT(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VFX_MISC_INT(a,b) "ZIPX_VFX_MISC_INT"
#define device_bar_BDK_ZIPX_VFX_MISC_INT(a,b) 0x0 /* VF_BAR0 */
#define busnum_BDK_ZIPX_VFX_MISC_INT(a,b) (a)
#define arguments_BDK_ZIPX_VFX_MISC_INT(a,b) (a),(b),-1,-1
 ...
 * This register sets interrupt bits.
 */
union bdk_zipx_vfx_misc_int_w1s
{
    uint64_t u;
    struct bdk_zipx_vfx_misc_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
    ...
    /* struct bdk_zipx_vfx_misc_int_w1s_s cn; */
};
typedef union bdk_zipx_vfx_misc_int_w1s bdk_zipx_vfx_misc_int_w1s_t;

static inline uint64_t BDK_ZIPX_VFX_MISC_INT_W1S(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VFX_MISC_INT_W1S(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838020000310ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_VFX_MISC_INT_W1S", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VFX_MISC_INT_W1S(a,b) bdk_zipx_vfx_misc_int_w1s_t
#define bustype_BDK_ZIPX_VFX_MISC_INT_W1S(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VFX_MISC_INT_W1S(a,b) "ZIPX_VFX_MISC_INT_W1S"
#define device_bar_BDK_ZIPX_VFX_MISC_INT_W1S(a,b) 0x0 /* VF_BAR0 */
#define busnum_BDK_ZIPX_VFX_MISC_INT_W1S(a,b) (a)
#define arguments_BDK_ZIPX_VFX_MISC_INT_W1S(a,b) (a),(b),-1,-1
 ...
 * enumeration.
 */
union bdk_zipx_vfx_msix_pbax
{
    uint64_t u;
    struct bdk_zipx_vfx_msix_pbax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t pend                  : 64; /**< [ 63:  0](RO/H) Pending message for the associated ZIP()_PF_MSIX_VEC()_CTL, enumerated by ZIP_PF_INT_VEC_E.
                                                                 Bits that have no associated ZIP_PF_INT_VEC_E are 0. */
    ...
    /* struct bdk_zipx_vfx_msix_pbax_s cn; */
};
typedef union bdk_zipx_vfx_msix_pbax bdk_zipx_vfx_msix_pbax_t;

static inline uint64_t BDK_ZIPX_VFX_MSIX_PBAX(unsigned long a, unsigned long b, unsigned long c) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VFX_MSIX_PBAX(unsigned long a, unsigned long b, unsigned long c)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7) && (c==0)))
        return 0x8380300f0000ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7) + 8ll * ((c) & 0x0);
    __bdk_csr_fatal("ZIPX_VFX_MSIX_PBAX", 3, a, b, c, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VFX_MSIX_PBAX(a,b,c) bdk_zipx_vfx_msix_pbax_t
#define bustype_BDK_ZIPX_VFX_MSIX_PBAX(a,b,c) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VFX_MSIX_PBAX(a,b,c) "ZIPX_VFX_MSIX_PBAX"
#define device_bar_BDK_ZIPX_VFX_MSIX_PBAX(a,b,c) 0x4 /* VF_BAR4 */
#define busnum_BDK_ZIPX_VFX_MSIX_PBAX(a,b,c) (a)
#define arguments_BDK_ZIPX_VFX_MSIX_PBAX(a,b,c) (a),(b),(c),-1
 ...
 */
union bdk_zipx_vfx_msix_vecx_addr
{
    uint64_t u;
    struct bdk_zipx_vfx_msix_vecx_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
    ...
    /* struct bdk_zipx_vfx_msix_vecx_addr_s cn; */
};
typedef union bdk_zipx_vfx_msix_vecx_addr bdk_zipx_vfx_msix_vecx_addr_t;

static inline uint64_t BDK_ZIPX_VFX_MSIX_VECX_ADDR(unsigned long a, unsigned long b, unsigned long c) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VFX_MSIX_VECX_ADDR(unsigned long a, unsigned long b, unsigned long c)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7) && (c<=1)))
        return 0x838030000000ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7) + 0x10ll * ((c) & 0x1);
    __bdk_csr_fatal("ZIPX_VFX_MSIX_VECX_ADDR", 3, a, b, c, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VFX_MSIX_VECX_ADDR(a,b,c) bdk_zipx_vfx_msix_vecx_addr_t
#define bustype_BDK_ZIPX_VFX_MSIX_VECX_ADDR(a,b,c) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VFX_MSIX_VECX_ADDR(a,b,c) "ZIPX_VFX_MSIX_VECX_ADDR"
#define device_bar_BDK_ZIPX_VFX_MSIX_VECX_ADDR(a,b,c) 0x4 /* VF_BAR4 */
#define busnum_BDK_ZIPX_VFX_MSIX_VECX_ADDR(a,b,c) (a)
#define arguments_BDK_ZIPX_VFX_MSIX_VECX_ADDR(a,b,c) (a),(b),(c),-1
 ...
 * This register is the MSI-X vector table, indexed by the ZIP_VF_INT_VEC_E enumeration.
 */
union bdk_zipx_vfx_msix_vecx_ctl
{
    uint64_t u;
    struct bdk_zipx_vfx_msix_vecx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_33_63        : 31;
        uint64_t mask                  : 1;  /**< [ 32: 32](R/W) When set, no MSI-X interrupts are sent to this vector. */
    ...
    /* struct bdk_zipx_vfx_msix_vecx_ctl_s cn; */
};
typedef union bdk_zipx_vfx_msix_vecx_ctl bdk_zipx_vfx_msix_vecx_ctl_t;

static inline uint64_t BDK_ZIPX_VFX_MSIX_VECX_CTL(unsigned long a, unsigned long b, unsigned long c) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VFX_MSIX_VECX_CTL(unsigned long a, unsigned long b, unsigned long c)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7) && (c<=1)))
        return 0x838030000008ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7) + 0x10ll * ((c) & 0x1);
    __bdk_csr_fatal("ZIPX_VFX_MSIX_VECX_CTL", 3, a, b, c, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VFX_MSIX_VECX_CTL(a,b,c) bdk_zipx_vfx_msix_vecx_ctl_t
#define bustype_BDK_ZIPX_VFX_MSIX_VECX_CTL(a,b,c) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VFX_MSIX_VECX_CTL(a,b,c) "ZIPX_VFX_MSIX_VECX_CTL"
#define device_bar_BDK_ZIPX_VFX_MSIX_VECX_CTL(a,b,c) 0x4 /* VF_BAR4 */
#define busnum_BDK_ZIPX_VFX_MSIX_VECX_CTL(a,b,c) (a)
#define arguments_BDK_ZIPX_VFX_MSIX_VECX_CTL(a,b,c) (a),(b),(c),-1
 ...
 */
union bdk_zipx_vfx_pf_mboxx
{
    uint64_t u;
    struct bdk_zipx_vfx_pf_mboxx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_vfx_pf_mboxx_s cn; */
};
typedef union bdk_zipx_vfx_pf_mboxx bdk_zipx_vfx_pf_mboxx_t;

static inline uint64_t BDK_ZIPX_VFX_PF_MBOXX(unsigned long a, unsigned long b, unsigned long c) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VFX_PF_MBOXX(unsigned long a, unsigned long b, unsigned long c)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7) && (c<=1)))
        return 0x838020000400ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7) + 8ll * ((c) & 0x1);
    __bdk_csr_fatal("ZIPX_VFX_PF_MBOXX", 3, a, b, c, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VFX_PF_MBOXX(a,b,c) bdk_zipx_vfx_pf_mboxx_t
#define bustype_BDK_ZIPX_VFX_PF_MBOXX(a,b,c) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VFX_PF_MBOXX(a,b,c) "ZIPX_VFX_PF_MBOXX"
#define device_bar_BDK_ZIPX_VFX_PF_MBOXX(a,b,c) 0x0 /* VF_BAR0 */
#define busnum_BDK_ZIPX_VFX_PF_MBOXX(a,b,c) (a)
#define arguments_BDK_ZIPX_VFX_PF_MBOXX(a,b,c) (a),(b),(c),-1
 ...
 */
union bdk_zipx_vqx_done
{
    uint64_t u;
    struct bdk_zipx_vqx_done_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_vqx_done_s cn; */
};
typedef union bdk_zipx_vqx_done bdk_zipx_vqx_done_t;

static inline uint64_t BDK_ZIPX_VQX_DONE(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VQX_DONE(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838020000100ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_VQX_DONE", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VQX_DONE(a,b) bdk_zipx_vqx_done_t
#define bustype_BDK_ZIPX_VQX_DONE(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VQX_DONE(a,b) "ZIPX_VQX_DONE"
#define device_bar_BDK_ZIPX_VQX_DONE(a,b) 0x0 /* VF_BAR0 */
#define busnum_BDK_ZIPX_VQX_DONE(a,b) (a)
#define arguments_BDK_ZIPX_VQX_DONE(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_vqx_done_ack
{
    uint64_t u;
    struct bdk_zipx_vqx_done_ack_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
    ...
    /* struct bdk_zipx_vqx_done_ack_s cn; */
};
typedef union bdk_zipx_vqx_done_ack bdk_zipx_vqx_done_ack_t;

static inline uint64_t BDK_ZIPX_VQX_DONE_ACK(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VQX_DONE_ACK(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838020000110ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_VQX_DONE_ACK", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VQX_DONE_ACK(a,b) bdk_zipx_vqx_done_ack_t
#define bustype_BDK_ZIPX_VQX_DONE_ACK(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VQX_DONE_ACK(a,b) "ZIPX_VQX_DONE_ACK"
#define device_bar_BDK_ZIPX_VQX_DONE_ACK(a,b) 0x0 /* VF_BAR0 */
#define busnum_BDK_ZIPX_VQX_DONE_ACK(a,b) (a)
#define arguments_BDK_ZIPX_VQX_DONE_ACK(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_vqx_done_ena_w1c
{
    uint64_t u;
    struct bdk_zipx_vqx_done_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_vqx_done_ena_w1c_s cn; */
};
typedef union bdk_zipx_vqx_done_ena_w1c bdk_zipx_vqx_done_ena_w1c_t;

static inline uint64_t BDK_ZIPX_VQX_DONE_ENA_W1C(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VQX_DONE_ENA_W1C(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838020000130ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_VQX_DONE_ENA_W1C", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VQX_DONE_ENA_W1C(a,b) bdk_zipx_vqx_done_ena_w1c_t
#define bustype_BDK_ZIPX_VQX_DONE_ENA_W1C(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VQX_DONE_ENA_W1C(a,b) "ZIPX_VQX_DONE_ENA_W1C"
#define device_bar_BDK_ZIPX_VQX_DONE_ENA_W1C(a,b) 0x0 /* VF_BAR0 */
#define busnum_BDK_ZIPX_VQX_DONE_ENA_W1C(a,b) (a)
#define arguments_BDK_ZIPX_VQX_DONE_ENA_W1C(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_vqx_done_ena_w1s
{
    uint64_t u;
    struct bdk_zipx_vqx_done_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct bdk_zipx_vqx_done_ena_w1s_s cn; */
};
typedef union bdk_zipx_vqx_done_ena_w1s bdk_zipx_vqx_done_ena_w1s_t;

static inline uint64_t BDK_ZIPX_VQX_DONE_ENA_W1S(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VQX_DONE_ENA_W1S(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838020000120ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_VQX_DONE_ENA_W1S", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VQX_DONE_ENA_W1S(a,b) bdk_zipx_vqx_done_ena_w1s_t
#define bustype_BDK_ZIPX_VQX_DONE_ENA_W1S(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VQX_DONE_ENA_W1S(a,b) "ZIPX_VQX_DONE_ENA_W1S"
#define device_bar_BDK_ZIPX_VQX_DONE_ENA_W1S(a,b) 0x0 /* VF_BAR0 */
#define busnum_BDK_ZIPX_VQX_DONE_ENA_W1S(a,b) (a)
#define arguments_BDK_ZIPX_VQX_DONE_ENA_W1S(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_vqx_done_wait
{
    uint64_t u;
    struct bdk_zipx_vqx_done_wait_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_zipx_vqx_done_wait_s cn; */
};
typedef union bdk_zipx_vqx_done_wait bdk_zipx_vqx_done_wait_t;

static inline uint64_t BDK_ZIPX_VQX_DONE_WAIT(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VQX_DONE_WAIT(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838020000140ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_VQX_DONE_WAIT", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VQX_DONE_WAIT(a,b) bdk_zipx_vqx_done_wait_t
#define bustype_BDK_ZIPX_VQX_DONE_WAIT(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VQX_DONE_WAIT(a,b) "ZIPX_VQX_DONE_WAIT"
#define device_bar_BDK_ZIPX_VQX_DONE_WAIT(a,b) 0x0 /* VF_BAR0 */
#define busnum_BDK_ZIPX_VQX_DONE_WAIT(a,b) (a)
#define arguments_BDK_ZIPX_VQX_DONE_WAIT(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_vqx_doorbell
{
    uint64_t u;
    struct bdk_zipx_vqx_doorbell_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
    ...
    /* struct bdk_zipx_vqx_doorbell_s cn; */
};
typedef union bdk_zipx_vqx_doorbell bdk_zipx_vqx_doorbell_t;

static inline uint64_t BDK_ZIPX_VQX_DOORBELL(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VQX_DOORBELL(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838020001000ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_VQX_DOORBELL", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VQX_DOORBELL(a,b) bdk_zipx_vqx_doorbell_t
#define bustype_BDK_ZIPX_VQX_DOORBELL(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VQX_DOORBELL(a,b) "ZIPX_VQX_DOORBELL"
#define device_bar_BDK_ZIPX_VQX_DOORBELL(a,b) 0x0 /* VF_BAR0 */
#define busnum_BDK_ZIPX_VQX_DOORBELL(a,b) (a)
#define arguments_BDK_ZIPX_VQX_DOORBELL(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_vqx_ena
{
    uint64_t u;
    struct bdk_zipx_vqx_ena_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct bdk_zipx_vqx_ena_s cn; */
};
typedef union bdk_zipx_vqx_ena bdk_zipx_vqx_ena_t;

static inline uint64_t BDK_ZIPX_VQX_ENA(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VQX_ENA(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838020000010ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_VQX_ENA", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VQX_ENA(a,b) bdk_zipx_vqx_ena_t
#define bustype_BDK_ZIPX_VQX_ENA(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VQX_ENA(a,b) "ZIPX_VQX_ENA"
#define device_bar_BDK_ZIPX_VQX_ENA(a,b) 0x0 /* VF_BAR0 */
#define busnum_BDK_ZIPX_VQX_ENA(a,b) (a)
#define arguments_BDK_ZIPX_VQX_ENA(a,b) (a),(b),-1,-1
 ...
 */
union bdk_zipx_vqx_sbuf_addr
{
    uint64_t u;
    struct bdk_zipx_vqx_sbuf_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
    ...
    /* struct bdk_zipx_vqx_sbuf_addr_s cn; */
};
typedef union bdk_zipx_vqx_sbuf_addr bdk_zipx_vqx_sbuf_addr_t;

static inline uint64_t BDK_ZIPX_VQX_SBUF_ADDR(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIPX_VQX_SBUF_ADDR(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a==0) && (b<=7)))
        return 0x838020000020ll + 0x1000000000ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x7);
    __bdk_csr_fatal("ZIPX_VQX_SBUF_ADDR", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_ZIPX_VQX_SBUF_ADDR(a,b) bdk_zipx_vqx_sbuf_addr_t
#define bustype_BDK_ZIPX_VQX_SBUF_ADDR(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIPX_VQX_SBUF_ADDR(a,b) "ZIPX_VQX_SBUF_ADDR"
#define device_bar_BDK_ZIPX_VQX_SBUF_ADDR(a,b) 0x0 /* VF_BAR0 */
#define busnum_BDK_ZIPX_VQX_SBUF_ADDR(a,b) (a)
#define arguments_BDK_ZIPX_VQX_SBUF_ADDR(a,b) (a),(b),-1,-1
...
static inline uint64_t BDK_ZIP_CMD_CTL_FUNC(void)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x838000000000ll;
    __bdk_csr_fatal("ZIP_CMD_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_zip_constants
{
    ...
    /* struct bdk_zip_constants_s cn8; */
...
static inline uint64_t BDK_ZIP_CONSTANTS_FUNC(void)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x8380000000a0ll;
    __bdk_csr_fatal("ZIP_CONSTANTS", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_CONSTANTS2_FUNC(void)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x8380000000a8ll;
    __bdk_csr_fatal("ZIP_CONSTANTS2", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_COREX_BIST_STATUS(unsigned long a)
{
    ...
    __bdk_csr_fatal("ZIP_COREX_BIST_STATUS", 1, a, 0, 0, 0, 0, 0);
}
 ...
 * INTERNAL: ZIP Backpressure Test Registers
 */
union bdk_zip_corex_bp_test
{
    uint64_t u;
    struct bdk_zip_corex_bp_test_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_52_63        : 12;
        uint64_t enable                : 4;  /**< [ 51: 48](R/W) Enable test mode. For diagnostic use only.
    ...
    /* struct bdk_zip_corex_bp_test_s cn; */
};
typedef union bdk_zip_corex_bp_test bdk_zip_corex_bp_test_t;

static inline uint64_t BDK_ZIP_COREX_BP_TEST(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIP_COREX_BP_TEST(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=11))
        return 0x838000003400ll + 8ll * ((a) & 0xf);
    __bdk_csr_fatal("ZIP_COREX_BP_TEST", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIP_COREX_BP_TEST(a) bdk_zip_corex_bp_test_t
#define bustype_BDK_ZIP_COREX_BP_TEST(a) BDK_CSR_TYPE_NCB
#define basename_BDK_ZIP_COREX_BP_TEST(a) "ZIP_COREX_BP_TEST"
#define device_bar_BDK_ZIP_COREX_BP_TEST(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIP_COREX_BP_TEST(a) (a)
#define arguments_BDK_ZIP_COREX_BP_TEST(a) (a),-1,-1,-1
...
static inline uint64_t BDK_ZIP_COREX_TO_STA(unsigned long a)
{
    ...
    __bdk_csr_fatal("ZIP_COREX_TO_STA", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_CORE_RESET_FUNC(void)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x838000000300ll;
    __bdk_csr_fatal("ZIP_CORE_RESET", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_CORE_TO_CFG_FUNC(void)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x838000000700ll;
    __bdk_csr_fatal("ZIP_CORE_TO_CFG", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_CTL_BIST_STATUS_FUNC(void)
{
    ...
    __bdk_csr_fatal("ZIP_CTL_BIST_STATUS", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_CTL_CFG_FUNC(void)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x838000000560ll;
    __bdk_csr_fatal("ZIP_CTL_CFG", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_zip_dbg_corex_inst
{
    ...
    /* struct bdk_zip_dbg_corex_inst_s cn8; */
...
static inline uint64_t BDK_ZIP_DBG_COREX_INST(unsigned long a)
{
    ...
    __bdk_csr_fatal("ZIP_DBG_COREX_INST", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_DBG_COREX_STA(unsigned long a)
{
    ...
    __bdk_csr_fatal("ZIP_DBG_COREX_STA", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_zip_dbg_quex_sta
{
    ...
    /* struct bdk_zip_dbg_quex_sta_s cn; */
};
...
{
    if (bdk_is_model(OCTEONTX_CN83XX) && (a<=7))
        return 0x838000001800ll + 8ll * ((a) & 0x7);
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838000001800ll + 8ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_DBG_QUEX_STA", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_ECC_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("ZIP_ECC_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_ECCE_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("ZIP_ECCE_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_ECCE_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("ZIP_ECCE_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_ECCE_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("ZIP_ECCE_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_ECCE_INT_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("ZIP_ECCE_INT_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_ECO_FUNC(void)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x8380000005f0ll;
    __bdk_csr_fatal("ZIP_ECO", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_FIFE_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("ZIP_FIFE_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_FIFE_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("ZIP_FIFE_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_FIFE_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("ZIP_FIFE_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_FIFE_INT_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("ZIP_FIFE_INT_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_PF_ACTIVE_PC_FUNC(void)
{
    ...
    __bdk_csr_fatal("ZIP_PF_ACTIVE_PC", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_PF_INST_LATENCY_PC_FUNC(void)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x838000000420ll;
    __bdk_csr_fatal("ZIP_PF_INST_LATENCY_PC", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_PF_INST_REQ_PC_FUNC(void)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x838000000410ll;
    __bdk_csr_fatal("ZIP_PF_INST_REQ_PC", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_PF_MBOX_ENA_W1CX(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a==0))
        return 0x838000000940ll + 8ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIP_PF_MBOX_ENA_W1CX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_PF_MBOX_ENA_W1SX(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a==0))
        return 0x838000000960ll + 8ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIP_PF_MBOX_ENA_W1SX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_PF_MBOX_INTX(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a==0))
        return 0x838000000900ll + 8ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIP_PF_MBOX_INTX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_PF_MBOX_INT_W1SX(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a==0))
        return 0x838000000920ll + 8ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIP_PF_MBOX_INT_W1SX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_PF_MSIX_PBAX(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a==0))
        return 0x8380100f0000ll + 8ll * ((a) & 0x0);
    __bdk_csr_fatal("ZIP_PF_MSIX_PBAX", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_zip_pf_msix_vecx_addr
{
    ...
    /* struct bdk_zip_pf_msix_vecx_addr_s cn96xxp1; */
    struct bdk_zip_pf_msix_vecx_addr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
...
static inline uint64_t BDK_ZIP_PF_MSIX_VECX_ADDR(unsigned long a)
{
    ...
    __bdk_csr_fatal("ZIP_PF_MSIX_VECX_ADDR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_PF_MSIX_VECX_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("ZIP_PF_MSIX_VECX_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_PF_QUEX_GMCTL(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838000000800ll + 0x100000ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_PF_QUEX_GMCTL", 1, a, 0, 0, 0, 0, 0);
}
 ...
 * This register contains PF RAS error flags for ZPI.
 */
union bdk_zip_pf_ras
{
    uint64_t u;
    struct bdk_zip_pf_ras_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
        uint64_t ld_cmd_psn            : 1;  /**< [  1:  1](R/W1C/H) Poison received on a NCB instruction response. */
    ...
    /* struct bdk_zip_pf_ras_s cn; */
};
typedef union bdk_zip_pf_ras bdk_zip_pf_ras_t;

#define BDK_ZIP_PF_RAS BDK_ZIP_PF_RAS_FUNC()
static inline uint64_t BDK_ZIP_PF_RAS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIP_PF_RAS_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x838000000980ll;
    __bdk_csr_fatal("ZIP_PF_RAS", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIP_PF_RAS bdk_zip_pf_ras_t
#define bustype_BDK_ZIP_PF_RAS BDK_CSR_TYPE_NCB
#define basename_BDK_ZIP_PF_RAS "ZIP_PF_RAS"
#define device_bar_BDK_ZIP_PF_RAS 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIP_PF_RAS 0
#define arguments_BDK_ZIP_PF_RAS -1,-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union bdk_zip_pf_ras_ena_w1c
{
    uint64_t u;
    struct bdk_zip_pf_ras_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
    ...
    /* struct bdk_zip_pf_ras_ena_w1c_s cn; */
};
typedef union bdk_zip_pf_ras_ena_w1c bdk_zip_pf_ras_ena_w1c_t;

#define BDK_ZIP_PF_RAS_ENA_W1C BDK_ZIP_PF_RAS_ENA_W1C_FUNC()
static inline uint64_t BDK_ZIP_PF_RAS_ENA_W1C_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIP_PF_RAS_ENA_W1C_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x838000000990ll;
    __bdk_csr_fatal("ZIP_PF_RAS_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIP_PF_RAS_ENA_W1C bdk_zip_pf_ras_ena_w1c_t
#define bustype_BDK_ZIP_PF_RAS_ENA_W1C BDK_CSR_TYPE_NCB
#define basename_BDK_ZIP_PF_RAS_ENA_W1C "ZIP_PF_RAS_ENA_W1C"
#define device_bar_BDK_ZIP_PF_RAS_ENA_W1C 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIP_PF_RAS_ENA_W1C 0
#define arguments_BDK_ZIP_PF_RAS_ENA_W1C -1,-1,-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union bdk_zip_pf_ras_ena_w1s
{
    uint64_t u;
    struct bdk_zip_pf_ras_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
    ...
    /* struct bdk_zip_pf_ras_ena_w1s_s cn; */
};
typedef union bdk_zip_pf_ras_ena_w1s bdk_zip_pf_ras_ena_w1s_t;

#define BDK_ZIP_PF_RAS_ENA_W1S BDK_ZIP_PF_RAS_ENA_W1S_FUNC()
static inline uint64_t BDK_ZIP_PF_RAS_ENA_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIP_PF_RAS_ENA_W1S_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x838000000998ll;
    __bdk_csr_fatal("ZIP_PF_RAS_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIP_PF_RAS_ENA_W1S bdk_zip_pf_ras_ena_w1s_t
#define bustype_BDK_ZIP_PF_RAS_ENA_W1S BDK_CSR_TYPE_NCB
#define basename_BDK_ZIP_PF_RAS_ENA_W1S "ZIP_PF_RAS_ENA_W1S"
#define device_bar_BDK_ZIP_PF_RAS_ENA_W1S 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIP_PF_RAS_ENA_W1S 0
#define arguments_BDK_ZIP_PF_RAS_ENA_W1S -1,-1,-1,-1
 ...
 * This register sets interrupt bits.
 */
union bdk_zip_pf_ras_w1s
{
    uint64_t u;
    struct bdk_zip_pf_ras_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
    ...
    /* struct bdk_zip_pf_ras_w1s_s cn; */
};
typedef union bdk_zip_pf_ras_w1s bdk_zip_pf_ras_w1s_t;

#define BDK_ZIP_PF_RAS_W1S BDK_ZIP_PF_RAS_W1S_FUNC()
static inline uint64_t BDK_ZIP_PF_RAS_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_ZIP_PF_RAS_W1S_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x838000000988ll;
    __bdk_csr_fatal("ZIP_PF_RAS_W1S", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_BDK_ZIP_PF_RAS_W1S bdk_zip_pf_ras_w1s_t
#define bustype_BDK_ZIP_PF_RAS_W1S BDK_CSR_TYPE_NCB
#define basename_BDK_ZIP_PF_RAS_W1S "ZIP_PF_RAS_W1S"
#define device_bar_BDK_ZIP_PF_RAS_W1S 0x0 /* PF_BAR0 */
#define busnum_BDK_ZIP_PF_RAS_W1S 0
#define arguments_BDK_ZIP_PF_RAS_W1S -1,-1,-1,-1
...
static inline uint64_t BDK_ZIP_PF_RD_LATENCY_PC_FUNC(void)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x838000000440ll;
    __bdk_csr_fatal("ZIP_PF_RD_LATENCY_PC", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_PF_RD_REQ_PC_FUNC(void)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x838000000430ll;
    __bdk_csr_fatal("ZIP_PF_RD_REQ_PC", 0, 0, 0, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN83XX) && ((a<=7) && (b<=1)))
        return 0x838000002000ll + 0x10ll * ((a) & 0x7) + 8ll * ((b) & 0x1);
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=7) && (b<=1)))
        return 0x838000002000ll + 0x10ll * ((a) & 0x7) + 8ll * ((b) & 0x1);
    __bdk_csr_fatal("ZIP_PF_VFX_MBOXX", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_QUEX_GCFG(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838000001a00ll + 8ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_QUEX_GCFG", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_QUEX_MAP(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838000001400ll + 8ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_QUEX_MAP", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_zip_quex_sbuf_ctl
{
    ...
    /* struct bdk_zip_quex_sbuf_ctl_s cn8; */
...
static inline uint64_t BDK_ZIP_QUEX_SBUF_CTL(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838000001200ll + 8ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_QUEX_SBUF_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_QUE_PRI_FUNC(void)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x838000000508ll;
    __bdk_csr_fatal("ZIP_QUE_PRI", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_QUE_RESET_FUNC(void)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x838000000400ll;
    __bdk_csr_fatal("ZIP_QUE_RESET", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_THROTTLE_FUNC(void)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX))
        return 0x838000000010ll;
    __bdk_csr_fatal("ZIP_THROTTLE", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_VFX_MISC_ENA_W1C(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838020000330ll + 0x100000ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_VFX_MISC_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_VFX_MISC_ENA_W1S(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838020000320ll + 0x100000ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_VFX_MISC_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_VFX_MISC_INT(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838020000300ll + 0x100000ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_VFX_MISC_INT", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_VFX_MISC_INT_W1S(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838020000310ll + 0x100000ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_VFX_MISC_INT_W1S", 1, a, 0, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN83XX) && ((a<=7) && (b==0)))
        return 0x8380300f0000ll + 0x100000ll * ((a) & 0x7) + 8ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=7) && (b==0)))
        return 0x8380300f0000ll + 0x100000ll * ((a) & 0x7) + 8ll * ((b) & 0x0);
    __bdk_csr_fatal("ZIP_VFX_MSIX_PBAX", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_VFX_MSIX_VECX_ADDR(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=7) && (b<=1)))
        return 0x838030000000ll + 0x100000ll * ((a) & 0x7) + 0x10ll * ((b) & 0x1);
    __bdk_csr_fatal("ZIP_VFX_MSIX_VECX_ADDR", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_VFX_MSIX_VECX_CTL(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=7) && (b<=1)))
        return 0x838030000008ll + 0x100000ll * ((a) & 0x7) + 0x10ll * ((b) & 0x1);
    __bdk_csr_fatal("ZIP_VFX_MSIX_VECX_CTL", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_VFX_PF_MBOXX(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=7) && (b<=1)))
        return 0x838020000400ll + 0x100000ll * ((a) & 0x7) + 8ll * ((b) & 0x1);
    __bdk_csr_fatal("ZIP_VFX_PF_MBOXX", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_VQX_DONE(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838020000100ll + 0x100000ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_VQX_DONE", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_VQX_DONE_ACK(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838020000110ll + 0x100000ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_VQX_DONE_ACK", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_VQX_DONE_ENA_W1C(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838020000130ll + 0x100000ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_VQX_DONE_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_VQX_DONE_ENA_W1S(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838020000120ll + 0x100000ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_VQX_DONE_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_VQX_DONE_WAIT(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838020000140ll + 0x100000ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_VQX_DONE_WAIT", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_VQX_DOORBELL(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838020001000ll + 0x100000ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_VQX_DOORBELL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_VQX_ENA(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838020000010ll + 0x100000ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_VQX_ENA", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_ZIP_VQX_SBUF_ADDR(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_CN96XX) && (a<=7))
        return 0x838020000020ll + 0x100000ll * ((a) & 0x7);
    __bdk_csr_fatal("ZIP_VQX_SBUF_ADDR", 1, a, 0, 0, 0, 0, 0);
}
