...
static inline uint64_t BDK_MIO_TWSX_ACCESS_WDOG(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_ACCESS_WDOG", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_TWSX_CLKEN(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_CLKEN", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_mio_twsx_const
{
    ...
    struct bdk_mio_twsx_const_s
    {
        ...
        uint64_t ver                   : 8;  /**< [  7:  0](RO) TWSI version. */
#else /* Word 0 - Little Endian */
        uint64_t ver                   : 8;  /**< [  7:  0](RO) TWSI version. */
        uint64_t reserved_8_63         : 56;
#endif /* Word 0 - End */
...
static inline uint64_t BDK_MIO_TWSX_CONST(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_CONST", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_TWSX_INT(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_INT", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_TWSX_INT_ENA_W1C(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_INT_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_TWSX_INT_ENA_W1S(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_INT_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_TWSX_INT_W1S(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_INT_W1S", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_TWSX_IO_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_IO_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_TWSX_MODE(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_MODE", 1, a, 0, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN8XXX) && ((a<=1) && (b==0)))
        return 0x87e0d0ff0000ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_CN9XXX) && ((a<=5) && (b==0)))
        return 0x87e0d0ff0000ll + 0x1000000ll * ((a) & 0x7) + 8ll * ((b) & 0x0);
    __bdk_csr_fatal("MIO_TWSX_MSIX_PBAX", 2, a, b, 0, 0, 0, 0);
}
...
union bdk_mio_twsx_msix_vecx_addr
{
    ...
    /* struct bdk_mio_twsx_msix_vecx_addr_s cn96xxp1; */
    struct bdk_mio_twsx_msix_vecx_addr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
    ...
    /* struct bdk_mio_twsx_msix_vecx_addr_cn96xxp3 cn98xx; */
    /* struct bdk_mio_twsx_msix_vecx_addr_cn96xxp3 cnf95xx; */
    /* struct bdk_mio_twsx_msix_vecx_addr_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_MIO_TWSX_MSIX_VECX_ADDR(unsigned long a, unsigned long b)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_MSIX_VECX_ADDR", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_TWSX_MSIX_VECX_CTL(unsigned long a, unsigned long b)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_MSIX_VECX_CTL", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_TWSX_SW_TWSI(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_SW_TWSI", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_TWSX_SW_TWSI_EXT(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_SW_TWSI_EXT", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_TWSX_TSTAMP_RX(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_TSTAMP_RX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_TWSX_TSTAMP_TX(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_TSTAMP_TX", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_mio_twsx_twsi_block_ctl
{
    ...
    /* struct bdk_mio_twsx_twsi_block_ctl_s cn9; */
    /* struct bdk_mio_twsx_twsi_block_ctl_s cn96xxp1; */
    struct bdk_mio_twsx_twsi_block_ctl_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_33_63        : 31;
    ...
    /* struct bdk_mio_twsx_twsi_block_ctl_cn96xxp3 cn98xx; */
    /* struct bdk_mio_twsx_twsi_block_ctl_s cnf95xxp1; */
    /* struct bdk_mio_twsx_twsi_block_ctl_cn96xxp3 cnf95xxp2; */
    /* struct bdk_mio_twsx_twsi_block_ctl_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_MIO_TWSX_TWSI_BLOCK_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_TWSI_BLOCK_CTL", 1, a, 0, 0, 0, 0, 0);
}
 ...
 * For TWSI writes, software does a series of writes to fill up the FIFO before
 ...
 *
 * The FIFO pointer needs to be reset by writing 1 to MIO_TWS()_TWSI_BLOCK_STS[RESET_PTR]
...
static inline uint64_t BDK_MIO_TWSX_TWSI_BLOCK_FIFO(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_TWSI_BLOCK_FIFO", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_TWSX_TWSI_BLOCK_STS(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_TWSI_BLOCK_STS", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MIO_TWSX_TWSI_SW(unsigned long a)
{
    ...
    __bdk_csr_fatal("MIO_TWSX_TWSI_SW", 1, a, 0, 0, 0, 0, 0);
}
