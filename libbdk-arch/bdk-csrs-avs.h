...
static inline uint64_t BDK_AVS_CFG_FUNC(void)
{
    ...
    __bdk_csr_fatal("AVS_CFG", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_AVS_CLKEN_FUNC(void)
{
    ...
    __bdk_csr_fatal("AVS_CLKEN", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_AVS_CONST_FUNC(void)
{
    ...
    __bdk_csr_fatal("AVS_CONST", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_AVS_ECO_FUNC(void)
{
    ...
    __bdk_csr_fatal("AVS_ECO", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_AVS_INT_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("AVS_INT_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_AVS_INT_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("AVS_INT_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_AVS_IO_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("AVS_IO_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_AVS_MDATA_FUNC(void)
{
    ...
    __bdk_csr_fatal("AVS_MDATA", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_AVS_MSIX_PBAX(unsigned long a)
{
    ...
    __bdk_csr_fatal("AVS_MSIX_PBAX", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_avs_msix_vecx_addr
{
    ...
    /* struct bdk_avs_msix_vecx_addr_s cn9; */
    /* struct bdk_avs_msix_vecx_addr_s cn96xxp1; */
    struct bdk_avs_msix_vecx_addr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
    ...
    /* struct bdk_avs_msix_vecx_addr_cn96xxp3 cn98xx; */
    /* struct bdk_avs_msix_vecx_addr_cn96xxp3 cnf95xx; */
    /* struct bdk_avs_msix_vecx_addr_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_AVS_MSIX_VECX_ADDR(unsigned long a)
{
    ...
    __bdk_csr_fatal("AVS_MSIX_VECX_ADDR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_AVS_MSIX_VECX_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("AVS_MSIX_VECX_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_AVS_SDATA_FUNC(void)
{
    ...
    __bdk_csr_fatal("AVS_SDATA", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_AVS_SSTATUS_FUNC(void)
{
    ...
    __bdk_csr_fatal("AVS_SSTATUS", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_AVS_STS_FUNC(void)
{
    ...
    __bdk_csr_fatal("AVS_STS", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_AVS_STS_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("AVS_STS_W1S", 0, 0, 0, 0, 0, 0, 0);
}
