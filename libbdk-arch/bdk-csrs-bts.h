 ...
 */
#define BDK_BTS_INT_VEC_E_BTS_PDBANK_DONE_INTR (0)
...
static inline uint64_t BDK_BTS_CG_1PPS_CFG_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_CG_1PPS_CFG", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_CG_CFG_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_CG_CFG", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_CG_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_CG_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_CSCLK_ACTIVE_PC_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_CSCLK_ACTIVE_PC", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_DAC_CLK_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_DAC_CLK_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_ECO_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_ECO", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_EXT_REFX_DIV_CFG0(unsigned long a)
{
    ...
    __bdk_csr_fatal("BTS_EXT_REFX_DIV_CFG0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_EXT_REFX_DIV_CFG1(unsigned long a)
{
    ...
    __bdk_csr_fatal("BTS_EXT_REFX_DIV_CFG1", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_GLOBAL_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_GLOBAL_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_GLOBAL_STATUS_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_GLOBAL_STATUS", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_INT_SUM_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_INT_SUM_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_INT_SUM_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_INT_SUM_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_INT_SUM_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_INT_SUM_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_INT_SUM_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_INT_SUM_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_MSIX_PBAX(unsigned long a)
{
    ...
    __bdk_csr_fatal("BTS_MSIX_PBAX", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_bts_msix_vecx_addr
{
    ...
    /* struct bdk_bts_msix_vecx_addr_s cn9; */
    /* struct bdk_bts_msix_vecx_addr_s cn96xxp1; */
    struct bdk_bts_msix_vecx_addr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
    ...
    /* struct bdk_bts_msix_vecx_addr_cn96xxp3 cn98xx; */
    /* struct bdk_bts_msix_vecx_addr_cn96xxp3 cnf95xx; */
    /* struct bdk_bts_msix_vecx_addr_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_BTS_MSIX_VECX_ADDR(unsigned long a)
{
    ...
    __bdk_csr_fatal("BTS_MSIX_VECX_ADDR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_MSIX_VECX_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("BTS_MSIX_VECX_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_PD1PPS_DIV_CFG0_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_PD1PPS_DIV_CFG0", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_PD1PPS_DIV_CFG1_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_PD1PPS_DIV_CFG1", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_PD_HISTORY_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_PD_HISTORY", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_PD_SLICEX_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("BTS_PD_SLICEX_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_PD_SLICEX_STATUS(unsigned long a)
{
    ...
    __bdk_csr_fatal("BTS_PD_SLICEX_STATUS", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_PDBFN_DIV_CFG0_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_PDBFN_DIV_CFG0", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_PDBFN_DIV_CFG1_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_PDBFN_DIV_CFG1", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_bts_pll_ctl
{
    ...
    /* struct bdk_bts_pll_ctl_s cn9; */
    struct bdk_bts_pll_ctl_cn96xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_37_63        : 27;
        uint64_t alt_ref_clk_sel       : 2;  /**< [ 36: 35](RAZ) Reserved. */
    ...
    struct bdk_bts_pll_ctl_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_37_63        : 27;
        uint64_t alt_ref_clk_sel       : 2;  /**< [ 36: 35](RAZ) Reserved. */
    ...
    /* struct bdk_bts_pll_ctl_cn96xxp3 cn98xx; */
    /* struct bdk_bts_pll_ctl_cn96xxp1 cnf95xxp1; */
    /* struct bdk_bts_pll_ctl_cn96xxp3 cnf95xxp2; */
    /* struct bdk_bts_pll_ctl_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_BTS_PLL_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_PLL_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_PLL_PC_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_PLL_PC", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_PTP_1PPS_CFG_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_PTP_1PPS_CFG", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BTS_PWM_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_PWM_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_bts_tp_mux_sel
{
    ...
    /* struct bdk_bts_tp_mux_sel_s cn9; */
    /* struct bdk_bts_tp_mux_sel_s cn96xxp1; */
    struct bdk_bts_tp_mux_sel_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
        uint64_t tp4_sel               : 4;  /**< [ 15: 12](R/W) Select the source for the BTS_TP4 output signal:
    ...
    /* struct bdk_bts_tp_mux_sel_cn96xxp3 cn98xx; */
    /* struct bdk_bts_tp_mux_sel_cn96xxp3 cnf95xx; */
    /* struct bdk_bts_tp_mux_sel_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_BTS_TP_MUX_SEL_FUNC(void)
{
    ...
    __bdk_csr_fatal("BTS_TP_MUX_SEL", 0, 0, 0, 0, 0, 0, 0);
}
