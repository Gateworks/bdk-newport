...
static inline uint64_t BDK_PCCBR_XXX_ACS_CAP_CTL_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x144;
    __bdk_csr_fatal("PCCBR_XXX_ACS_CAP_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PCCBR_XXX_ACS_CAP_HDR_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x140;
    __bdk_csr_fatal("PCCBR_XXX_ACS_CAP_HDR", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_pccbr_xxx_bus
{
    ...
    /* struct bdk_pccbr_xxx_bus_s cn8; */
    struct bdk_pccbr_xxx_bus_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t slt                   : 8;  /**< [ 31: 24](RO) Secondary latency timer. Not applicable to PCI Express, hardwired to 0x0. */
        uint32_t subbnum               : 8;  /**< [ 23: 16](R/W) Subordinate bus number. Resets to PCCBR_XXX_VSEC_CTL[STATIC_SUBBNUM].
...
union bdk_pccbr_xxx_e_cap_hdr
{
    ...
    /* struct bdk_pccbr_xxx_e_cap_hdr_s cn; */
};
...
union bdk_pccbr_xxx_id
{
    ...
    /* struct bdk_pccbr_xxx_id_s cn8; */
    /* struct bdk_pccbr_xxx_id_s cn9; */
    /* struct bdk_pccbr_xxx_id_s cn96xxp1; */
    struct bdk_pccbr_xxx_id_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t devid                 : 16; /**< [ 31: 16](RO) Device ID. \<15:8\> is PCC_PROD_E::GEN. \<7:0\> is PCC_DEV_IDL_E::PCCBR. */
    ...
    /* struct bdk_pccbr_xxx_id_cn96xxp3 cn98xx; */
    /* struct bdk_pccbr_xxx_id_cn96xxp3 cnf95xx; */
    /* struct bdk_pccbr_xxx_id_cn96xxp3 loki; */
};
