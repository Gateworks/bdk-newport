...
static inline uint64_t BDK_PMUX_PMAUTHSTATUS(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020fb8ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMAUTHSTATUS", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCCFILTR_EL0(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a00802047cll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCCFILTR_EL0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCCNTR_EL0_HI(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a0080200fcll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCCNTR_EL0_HI", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCCNTR_EL0_LO(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a0080200f8ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCCNTR_EL0_LO", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCEID0(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020e20ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCEID0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCEID1(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020e24ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCEID1", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCEID2(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020e28ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCEID2", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCEID3(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020e2cll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCEID3", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCFGR(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020e00ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCFGR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCID1SR(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020208ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCID1SR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCID1SR_ALIAS(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020228ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCID1SR_ALIAS", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCID2SR(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a00802022cll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCID2SR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCIDR0(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020ff0ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCIDR0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCIDR1(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020ff4ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCIDR1", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCIDR2(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020ff8ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCIDR2", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCIDR3(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020ffcll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCIDR3", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCNTENCLR_EL0(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020c20ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCNTENCLR_EL0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMCNTENSET_EL0(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020c00ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCNTENSET_EL0", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_pmux_pmcr_el0
{
    ...
    struct bdk_pmux_pmcr_el0_cn96xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_11_31        : 21;
        uint32_t reserved_7_10         : 4;
    ...
    /* struct bdk_pmux_pmcr_el0_cn8 cn96xxp3; */
    /* struct bdk_pmux_pmcr_el0_cn8 cn98xx; */
    /* struct bdk_pmux_pmcr_el0_cn8 cnf95xx; */
    /* struct bdk_pmux_pmcr_el0_cn8 loki; */
};
...
static inline uint64_t BDK_PMUX_PMCR_EL0(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020e04ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMCR_EL0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMDEVAFF0(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020fa8ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMDEVAFF0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMDEVAFF1(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020facll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMDEVAFF1", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_pmux_pmdevarch
{
    ...
    /* struct bdk_pmux_pmdevarch_s cn8; */
    struct bdk_pmux_pmdevarch_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t architect             : 11; /**< [ 31: 21](RO) Defines the architecture of the component. For performance
                                                                     monitors, this is ARM limited.
    ...
    /* struct bdk_pmux_pmdevarch_cn9 cn96xxp1; */
    /* struct bdk_pmux_pmdevarch_s cn96xxp3; */
    /* struct bdk_pmux_pmdevarch_s cn98xx; */
    /* struct bdk_pmux_pmdevarch_s cnf95xx; */
    /* struct bdk_pmux_pmdevarch_s loki; */
};
...
static inline uint64_t BDK_PMUX_PMDEVARCH(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020fbcll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMDEVARCH", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMDEVID(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020fc8ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMDEVID", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMDEVTYPE(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020fccll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMDEVTYPE", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMEVCNTRX_EL0(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=5) && (b<=5)))
        return 0x87a008020000ll + 0x80000ll * ((a) & 0x7) + 8ll * ((b) & 0x7);
    __bdk_csr_fatal("PMUX_PMEVCNTRX_EL0", 2, a, b, 0, 0, 0, 0);
}
...
union bdk_pmux_pmevtyperx_el0
{
    ...
    /* struct bdk_pmux_pmevtyperx_el0_s cn8; */
    ...
    /* struct bdk_pmux_pmevtyperx_el0_cn9 cn96xxp1; */
    struct bdk_pmux_pmevtyperx_el0_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t p                     : 1;  /**< [ 31: 31](R/W) EL1 modes filtering bit. Controls counting in EL1. If EL3 is
                                                                     implemented, then counting in nonsecure EL1 is further
    ...
    /* struct bdk_pmux_pmevtyperx_el0_cn96xxp3 cn98xx; */
    /* struct bdk_pmux_pmevtyperx_el0_cn96xxp3 cnf95xx; */
    /* struct bdk_pmux_pmevtyperx_el0_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_PMUX_PMEVTYPERX_EL0(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=5) && (b<=5)))
        return 0x87a008020400ll + 0x80000ll * ((a) & 0x7) + 4ll * ((b) & 0x7);
    __bdk_csr_fatal("PMUX_PMEVTYPERX_EL0", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMINTENCLR_EL1(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020c60ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMINTENCLR_EL1", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMINTENSET_EL1(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020c40ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMINTENSET_EL1", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMITCTRL(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020f00ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMITCTRL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMLAR(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020fb0ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMLAR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMLSR(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020fb4ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMLSR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMOVSCLR_EL0(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020c80ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMOVSCLR_EL0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMOVSSET_EL0(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020cc0ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMOVSSET_EL0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMPCSR_HI(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020204ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMPCSR_HI", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMPCSR_HI_ALIAS(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020224ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMPCSR_HI_ALIAS", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMPCSR_LO(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020200ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMPCSR_LO", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMPCSR_LO_ALIAS(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020220ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMPCSR_LO_ALIAS", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMPIDR0(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020fe0ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMPIDR0", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_pmux_pmpidr1
{
    ...
    /* struct bdk_pmux_pmpidr1_s cn8; */
    /* struct bdk_pmux_pmpidr1_s cn9; */
    /* struct bdk_pmux_pmpidr1_s cn96xxp1; */
    struct bdk_pmux_pmpidr1_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct bdk_pmux_pmpidr1_cn96xxp3 cn98xx; */
    /* struct bdk_pmux_pmpidr1_cn96xxp3 cnf95xx; */
    /* struct bdk_pmux_pmpidr1_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_PMUX_PMPIDR1(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020fe4ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMPIDR1", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_pmux_pmpidr2
{
    ...
    /* struct bdk_pmux_pmpidr2_s cn8; */
    struct bdk_pmux_pmpidr2_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by ARM. */
    ...
    /* struct bdk_pmux_pmpidr2_cn9 cn96xxp1; */
    struct bdk_pmux_pmpidr2_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by Arm. */
    ...
    /* struct bdk_pmux_pmpidr2_s cn98xx; */
    /* struct bdk_pmux_pmpidr2_s cnf95xxp1; */
    /* struct bdk_pmux_pmpidr2_cn96xxp3 cnf95xxp2; */
    /* struct bdk_pmux_pmpidr2_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_PMUX_PMPIDR2(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020fe8ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMPIDR2", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMPIDR3(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020fecll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMPIDR3", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_pmux_pmpidr4
{
    ...
    /* struct bdk_pmux_pmpidr4_s cn8; */
    /* struct bdk_pmux_pmpidr4_s cn9; */
    /* struct bdk_pmux_pmpidr4_s cn96xxp1; */
    struct bdk_pmux_pmpidr4_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t size                  : 4;  /**< [  7:  4](RO) Size of the component. Log2 of the number of
    ...
    /* struct bdk_pmux_pmpidr4_s cn98xx; */
    /* struct bdk_pmux_pmpidr4_s cnf95xxp1; */
    /* struct bdk_pmux_pmpidr4_cn96xxp3 cnf95xxp2; */
    /* struct bdk_pmux_pmpidr4_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_PMUX_PMPIDR4(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020fd0ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMPIDR4", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMPIDR5(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020fd4ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMPIDR5", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMPIDR6(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020fd8ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMPIDR6", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMPIDR7(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020fdcll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMPIDR7", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMSWINC_EL0(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008020ca0ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMSWINC_EL0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PMUX_PMVIDSR(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a00802020cll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("PMUX_PMVIDSR", 1, a, 0, 0, 0, 0, 0);
}
