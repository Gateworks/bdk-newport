...
union bdk_mpix_cfg
{
    ...
    /* struct bdk_mpix_cfg_s cn9; */
    struct bdk_mpix_cfg_cn96xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_mpix_cfg_cn96xxp3 cn98xx; */
    struct bdk_mpix_cfg_cnf95xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_51_63        : 13;
    ...
    /* struct bdk_mpix_cfg_cn96xxp3 cnf95xxp2; */
    /* struct bdk_mpix_cfg_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_MPIX_CFG(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPIX_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_mpix_cfg2
{
    ...
    /* struct bdk_mpix_cfg2_s cn9; */
    /* struct bdk_mpix_cfg2_s cn96xxp1; */
    struct bdk_mpix_cfg2_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
        uint64_t delay_spiclk          : 2;  /**< [  7:  6](R/W) Delay the SPICLK between 0 and 3 half-cycles. Default is zero delay. */
    ...
    /* struct bdk_mpix_cfg2_cn96xxp3 cn98xx; */
    /* struct bdk_mpix_cfg2_cn96xxp3 cnf95xx; */
    /* struct bdk_mpix_cfg2_cn96xxp3 loki; */
};
typedef union bdk_mpix_cfg2 bdk_mpix_cfg2_t;

static inline uint64_t BDK_MPIX_CFG2(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_MPIX_CFG2(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && (a<=1))
        return 0x804000002000ll + 0x1000000000ll * ((a) & 0x1);
    __bdk_csr_fatal("MPIX_CFG2", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_MPIX_CFG2(a) bdk_mpix_cfg2_t
#define bustype_BDK_MPIX_CFG2(a) BDK_CSR_TYPE_NCB
#define basename_BDK_MPIX_CFG2(a) "MPIX_CFG2"
#define device_bar_BDK_MPIX_CFG2(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_MPIX_CFG2(a) (a)
#define arguments_BDK_MPIX_CFG2(a) (a),-1,-1,-1
...
static inline uint64_t BDK_MPIX_CLKEN(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPIX_CLKEN", 1, a, 0, 0, 0, 0, 0);
}
 ...
 */
union bdk_mpix_const
{
    uint64_t u;
    struct bdk_mpix_const_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_mpix_const_s cn9; */
    /* struct bdk_mpix_const_s cn96xx; */
    /* struct bdk_mpix_const_s cn98xx; */
    struct bdk_mpix_const_cnf95xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_13_63        : 51;
    ...
    /* struct bdk_mpix_const_s cnf95xxp2; */
    /* struct bdk_mpix_const_s loki; */
};
typedef union bdk_mpix_const bdk_mpix_const_t;

static inline uint64_t BDK_MPIX_CONST(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_MPIX_CONST(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x804000000000ll + 0x1000000000ll * ((a) & 0x1);
    __bdk_csr_fatal("MPIX_CONST", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_MPIX_CONST(a) bdk_mpix_const_t
#define bustype_BDK_MPIX_CONST(a) BDK_CSR_TYPE_NCB
#define basename_BDK_MPIX_CONST(a) "MPIX_CONST"
#define device_bar_BDK_MPIX_CONST(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_MPIX_CONST(a) (a)
#define arguments_BDK_MPIX_CONST(a) (a),-1,-1,-1
...
static inline uint64_t BDK_MPIX_CSCLK_ACTIVE_PC(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPIX_CSCLK_ACTIVE_PC", 1, a, 0, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && ((a<=1) && (b<=8)))
        return 0x804000001080ll + 0x1000000000ll * ((a) & 0x1) + 8ll * ((b) & 0xf);
    __bdk_csr_fatal("MPIX_DATX", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPIX_ESPI_RINT_ENA_W1C(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPIX_ESPI_RINT_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPIX_ESPI_RINT_ENA_W1S(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPIX_ESPI_RINT_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPIX_ESPI_RINT_W1C(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPIX_ESPI_RINT_W1C", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPIX_ESPI_RINT_W1S(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPIX_ESPI_RINT_W1S", 1, a, 0, 0, 0, 0, 0);
}
 ...
 */
union bdk_mpix_force_cs
{
    uint64_t u;
    struct bdk_mpix_force_cs_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_mpix_force_cs_s cn; */
};
typedef union bdk_mpix_force_cs bdk_mpix_force_cs_t;

static inline uint64_t BDK_MPIX_FORCE_CS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_MPIX_FORCE_CS(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN96XX_PASS3_X) && (a<=1))
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x804000002088ll + 0x1000000000ll * ((a) & 0x1);
    __bdk_csr_fatal("MPIX_FORCE_CS", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_MPIX_FORCE_CS(a) bdk_mpix_force_cs_t
#define bustype_BDK_MPIX_FORCE_CS(a) BDK_CSR_TYPE_NCB
#define basename_BDK_MPIX_FORCE_CS(a) "MPIX_FORCE_CS"
#define device_bar_BDK_MPIX_FORCE_CS(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_MPIX_FORCE_CS(a) (a)
#define arguments_BDK_MPIX_FORCE_CS(a) (a),-1,-1,-1
...
static inline uint64_t BDK_MPIX_INT_ENA_W1C(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPIX_INT_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPIX_INT_ENA_W1S(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPIX_INT_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPIX_IO_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPIX_IO_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPIX_MSIX_PBAX(unsigned long a, unsigned long b)
{
    ...
    __bdk_csr_fatal("MPIX_MSIX_PBAX", 2, a, b, 0, 0, 0, 0);
}
...
union bdk_mpix_msix_vecx_addr
{
    ...
    /* struct bdk_mpix_msix_vecx_addr_s cn9; */
    /* struct bdk_mpix_msix_vecx_addr_s cn96xxp1; */
    struct bdk_mpix_msix_vecx_addr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
    ...
    /* struct bdk_mpix_msix_vecx_addr_cn96xxp3 cn98xx; */
    /* struct bdk_mpix_msix_vecx_addr_cn96xxp3 cnf95xx; */
    /* struct bdk_mpix_msix_vecx_addr_cn96xxp3 loki; */
};
...
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && ((a<=1) && (b<=64)))
        return 0x804000f00000ll + 0x1000000000ll * ((a) & 0x1) + 0x10ll * ((b) & 0x7f);
    __bdk_csr_fatal("MPIX_MSIX_VECX_ADDR", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPIX_MSIX_VECX_CTL(unsigned long a, unsigned long b)
{
    ...
    __bdk_csr_fatal("MPIX_MSIX_VECX_CTL", 2, a, b, 0, 0, 0, 0);
}
 ...
 */
union bdk_mpix_rcvdx
{
    uint64_t u;
    struct bdk_mpix_rcvdx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_mpix_rcvdx_s cn; */
};
typedef union bdk_mpix_rcvdx bdk_mpix_rcvdx_t;

static inline uint64_t BDK_MPIX_RCVDX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_MPIX_RCVDX(unsigned long a, unsigned long b)
{
    if (bdk_is_model(OCTEONTX_CN96XX_PASS3_X) && ((a<=1) && (b<=143)))
        return 0x804000002800ll + 0x1000000000ll * ((a) & 0x1) + 8ll * ((b) & 0xff);
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=1) && (b<=143)))
        return 0x804000002800ll + 0x1000000000ll * ((a) & 0x1) + 8ll * ((b) & 0xff);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=1) && (b<=143)))
        return 0x804000002800ll + 0x1000000000ll * ((a) & 0x1) + 8ll * ((b) & 0xff);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=1) && (b<=143)))
        return 0x804000002800ll + 0x1000000000ll * ((a) & 0x1) + 8ll * ((b) & 0xff);
    __bdk_csr_fatal("MPIX_RCVDX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_BDK_MPIX_RCVDX(a,b) bdk_mpix_rcvdx_t
#define bustype_BDK_MPIX_RCVDX(a,b) BDK_CSR_TYPE_NCB
#define basename_BDK_MPIX_RCVDX(a,b) "MPIX_RCVDX"
#define device_bar_BDK_MPIX_RCVDX(a,b) 0x0 /* PF_BAR0 */
#define busnum_BDK_MPIX_RCVDX(a,b) (a)
#define arguments_BDK_MPIX_RCVDX(a,b) (a),(b),-1,-1
...
union bdk_mpix_sts
{
    ...
    /* struct bdk_mpix_sts_s cn9; */
    struct bdk_mpix_sts_cn96xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
        uint64_t crc                   : 8;  /**< [ 39: 32](R/W1C/H) MPI CRC value received. */
    ...
    /* struct bdk_mpix_sts_s cn96xxp3; */
    /* struct bdk_mpix_sts_s cn98xx; */
    /* struct bdk_mpix_sts_s cnf95xx; */
    /* struct bdk_mpix_sts_s loki; */
};
...
static inline uint64_t BDK_MPIX_STS(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPIX_STS", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPIX_STS_W1S(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPIX_STS_W1S", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_mpix_tx
{
    ...
    /* struct bdk_mpix_tx_s cn9; */
    struct bdk_mpix_tx_cn96xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_22_63        : 42;
        uint64_t csid                  : 2;  /**< [ 21: 20](WO) Which CS to assert for this transaction. */
    ...
    /* struct bdk_mpix_tx_s cn96xxp3; */
    /* struct bdk_mpix_tx_s cn98xx; */
    struct bdk_mpix_tx_cnf95xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_22_63        : 42;
        uint64_t csid                  : 2;  /**< [ 21: 20](WO) Which CS to assert for this transaction. */
    ...
    /* struct bdk_mpix_tx_s cnf95xxp2; */
    /* struct bdk_mpix_tx_s loki; */
};
...
static inline uint64_t BDK_MPIX_TX(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPIX_TX", 1, a, 0, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && ((a<=1) && (b<=143)))
        return 0x804000001800ll + 0x1000000000ll * ((a) & 0x1) + 8ll * ((b) & 0xff);
    __bdk_csr_fatal("MPIX_WIDE_BUFX", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPIX_WIDE_DAT(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPIX_WIDE_DAT", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_mpix_xmit
{
    ...
    /* struct bdk_mpix_xmit_s cn9; */
    struct bdk_mpix_xmit_cn96xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_63           : 1;
        uint64_t csid                  : 2;  /**< [ 62: 61](WO) Which CS to assert for this transaction */
    ...
    /* struct bdk_mpix_xmit_cn96xxp3 cn98xx; */
    struct bdk_mpix_xmit_cnf95xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_63           : 1;
        uint64_t csid                  : 2;  /**< [ 62: 61](WO) Which CS to assert for this transaction */
    ...
    /* struct bdk_mpix_xmit_cn96xxp3 cnf95xxp2; */
    /* struct bdk_mpix_xmit_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_MPIX_XMIT(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPIX_XMIT", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPI_CFG_FUNC(void)
{
    ...
    __bdk_csr_fatal("MPI_CFG", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPI_DATX(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPI_DATX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPI_INT_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("MPI_INT_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPI_INT_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("MPI_INT_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPI_MSIX_PBAX(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPI_MSIX_PBAX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPI_MSIX_VECX_ADDR(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPI_MSIX_VECX_ADDR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPI_MSIX_VECX_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("MPI_MSIX_VECX_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPI_STS_FUNC(void)
{
    ...
    __bdk_csr_fatal("MPI_STS", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPI_STS_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("MPI_STS_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPI_TX_FUNC(void)
{
    ...
    __bdk_csr_fatal("MPI_TX", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_MPI_WIDE_DAT_FUNC(void)
{
    ...
    __bdk_csr_fatal("MPI_WIDE_DAT", 0, 0, 0, 0, 0, 0, 0);
}
