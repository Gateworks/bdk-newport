...
static inline uint64_t BDK_CTIX_ASICCTL(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010144ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_ASICCTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CLAIMCLR_EL1(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fa4ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CLAIMCLR_EL1", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CLAIMSET_EL1(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fa0ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CLAIMSET_EL1", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIAPPCLEAR(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010018ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIAPPCLEAR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIAPPPULSE(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a00801001cll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIAPPPULSE", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_ctix_ctiappset
{
    ...
    /* struct bdk_ctix_ctiappset_s cn; */
};
...
static inline uint64_t BDK_CTIX_CTIAPPSET(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010014ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIAPPSET", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIAUTHSTATUS(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fb8ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIAUTHSTATUS", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTICHINSTATUS(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010138ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTICHINSTATUS", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTICHOUTSTATUS(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a00801013cll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTICHOUTSTATUS", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTICIDR0(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010ff0ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTICIDR0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTICIDR1(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010ff4ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTICIDR1", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTICIDR2(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010ff8ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTICIDR2", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTICIDR3(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010ffcll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTICIDR3", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTICONTROL(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010000ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTICONTROL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIDEVAFF0(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fa8ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIDEVAFF0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIDEVAFF1(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010facll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIDEVAFF1", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_ctix_ctidevarch
{
    ...
    /* struct bdk_ctix_ctidevarch_s cn8; */
    struct bdk_ctix_ctidevarch_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t architect             : 11; /**< [ 31: 21](RO) Defines the architecture of the component. This is ARM Limited.
    ...
    /* struct bdk_ctix_ctidevarch_cn9 cn96xxp1; */
    /* struct bdk_ctix_ctidevarch_s cn96xxp3; */
    /* struct bdk_ctix_ctidevarch_s cn98xx; */
    /* struct bdk_ctix_ctidevarch_s cnf95xx; */
    /* struct bdk_ctix_ctidevarch_s loki; */
};
...
static inline uint64_t BDK_CTIX_CTIDEVARCH(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fbcll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIDEVARCH", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIDEVID(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fc8ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIDEVID", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIDEVID1(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fc4ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIDEVID1", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIDEVID2(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fc0ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIDEVID2", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIDEVTYPE(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fccll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIDEVTYPE", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIGATE(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010140ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIGATE", 1, a, 0, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN81XX) && ((a<=3) && (b<=2)))
        return 0x87a008010020ll + 0x80000ll * ((a) & 0x3) + 4ll * ((b) & 0x3);
    if (bdk_is_model(OCTEONTX_CN83XX) && ((a<=23) && (b<=2)))
        return 0x87a008010020ll + 0x80000ll * ((a) & 0x1f) + 4ll * ((b) & 0x3);
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=23) && (b<=9)))
        return 0x87a008010020ll + 0x80000ll * ((a) & 0x1f) + 4ll * ((b) & 0xf);
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=35) && (b<=9)))
        return 0x87a008010020ll + 0x80000ll * ((a) & 0x3f) + 4ll * ((b) & 0xf);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=5) && (b<=9)))
        return 0x87a008010020ll + 0x80000ll * ((a) & 0x7) + 4ll * ((b) & 0xf);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=5) && (b<=9)))
        return 0x87a008010020ll + 0x80000ll * ((a) & 0x7) + 4ll * ((b) & 0xf);
    __bdk_csr_fatal("CTIX_CTIINENX", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIINTACK(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010010ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIINTACK", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIITCTRL(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010f00ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIITCTRL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTILAR(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fb0ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTILAR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTILSR(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fb4ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTILSR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIOUTENX(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=5) && (b<=9)))
        return 0x87a0080100a0ll + 0x80000ll * ((a) & 0x7) + 4ll * ((b) & 0xf);
    __bdk_csr_fatal("CTIX_CTIOUTENX", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIPIDR0(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fe0ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIPIDR0", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_ctix_ctipidr1
{
    ...
    /* struct bdk_ctix_ctipidr1_s cn8; */
    /* struct bdk_ctix_ctipidr1_s cn9; */
    /* struct bdk_ctix_ctipidr1_s cn96xxp1; */
    struct bdk_ctix_ctipidr1_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct bdk_ctix_ctipidr1_cn96xxp3 cn98xx; */
    /* struct bdk_ctix_ctipidr1_cn96xxp3 cnf95xx; */
    /* struct bdk_ctix_ctipidr1_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_CTIX_CTIPIDR1(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fe4ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIPIDR1", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_ctix_ctipidr2
{
    ...
    /* struct bdk_ctix_ctipidr2_s cn8; */
    struct bdk_ctix_ctipidr2_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by ARM. */
    ...
    /* struct bdk_ctix_ctipidr2_cn9 cn96xxp1; */
    struct bdk_ctix_ctipidr2_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by Arm. */
    ...
    /* struct bdk_ctix_ctipidr2_s cn98xx; */
    /* struct bdk_ctix_ctipidr2_s cnf95xxp1; */
    /* struct bdk_ctix_ctipidr2_cn96xxp3 cnf95xxp2; */
    /* struct bdk_ctix_ctipidr2_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_CTIX_CTIPIDR2(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fe8ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIPIDR2", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIPIDR3(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fecll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIPIDR3", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_ctix_ctipidr4
{
    ...
    /* struct bdk_ctix_ctipidr4_s cn8; */
    /* struct bdk_ctix_ctipidr4_s cn9; */
    /* struct bdk_ctix_ctipidr4_s cn96xxp1; */
    struct bdk_ctix_ctipidr4_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t size                  : 4;  /**< [  7:  4](RO) Size of the component. Log\<sub\>2\</sub\> of the number of 4KB pages from the
    ...
    /* struct bdk_ctix_ctipidr4_s cn98xx; */
    /* struct bdk_ctix_ctipidr4_s cnf95xxp1; */
    /* struct bdk_ctix_ctipidr4_cn96xxp3 cnf95xxp2; */
    /* struct bdk_ctix_ctipidr4_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_CTIX_CTIPIDR4(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fd0ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIPIDR4", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIPIDR5(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fd4ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIPIDR5", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIPIDR6(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fd8ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIPIDR6", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTIPIDR7(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010fdcll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTIPIDR7", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTITRIGINSTATUS(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010130ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTITRIGINSTATUS", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CTIX_CTITRIGOUTSTATUS(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87a008010134ll + 0x80000ll * ((a) & 0x7);
    __bdk_csr_fatal("CTIX_CTITRIGOUTSTATUS", 1, a, 0, 0, 0, 0, 0);
}
