...
#define BDK_NPA_AURA_ERR_INT_E_POOL_DIS (3)
...
#define BDK_NPA_INPQ_E_BPHY (7)
#define BDK_NPA_INPQ_E_DPI (6)
#define BDK_NPA_INPQ_E_DPI0 (6)
#define BDK_NPA_INPQ_E_DPI1 (7)
 ...
 */
#define BDK_NPA_NDC0_PORT_E_AURA0 (0)
#define BDK_NPA_NDC0_PORT_E_AURA1 (1)
#define BDK_NPA_NDC0_PORT_E_POOL0 (2)
#define BDK_NPA_NDC0_PORT_E_POOL1 (3)
#define BDK_NPA_NDC0_PORT_E_STACK0 (4)
#define BDK_NPA_NDC0_PORT_E_STACK1 (5)
...
#define BDK_NPA_POOL_ERR_INT_E_PERR (2)
...
union bdk_npa_aura_s
{
    ...
    /* struct bdk_npa_aura_s_s cn9; */
    /* struct bdk_npa_aura_s_s cn96xxp1; */
    struct bdk_npa_aura_s_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t pool_addr             : 64; /**< [ 63:  0] AF IOVA of the associated pool's NPA_POOL_HW_S structure in NDC/LLC/DRAM. The
                                                                 size of the structure is 1 \<\< NPA_AF_CONST1[POOL_LOG2BYTES] bytes.
    ...
    /* struct bdk_npa_aura_s_cn96xxp3 cn98xx; */
    /* struct bdk_npa_aura_s_s cnf95xxp1; */
    /* struct bdk_npa_aura_s_cn96xxp3 cnf95xxp2; */
    /* struct bdk_npa_aura_s_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_NPA_AF_ACTIVE_CYCLES_PC_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_ACTIVE_CYCLES_PC", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_ACTIVE_CYCLES_PC 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_AQ_BASE_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_AQ_BASE", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_AQ_BASE 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_AQ_CFG_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_AQ_CFG", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_AQ_CFG 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_AQ_DONE_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_AQ_DONE", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_AQ_DONE 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_AQ_DONE_ACK_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_AQ_DONE_ACK", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_AQ_DONE_ACK 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_AQ_DONE_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_AQ_DONE_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_AQ_DONE_ENA_W1C 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_AQ_DONE_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_AQ_DONE_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_AQ_DONE_ENA_W1S 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_AQ_DONE_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_AQ_DONE_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_AQ_DONE_INT 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_AQ_DONE_INT_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_AQ_DONE_INT_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_AQ_DONE_INT_W1S 0x0 /* RVU_BAR0 */
 ...
 */
union bdk_npa_af_aq_done_timer
{
    uint64_t u;
    struct bdk_npa_af_aq_done_timer_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_npa_af_aq_done_timer_s cn; */
};
typedef union bdk_npa_af_aq_done_timer bdk_npa_af_aq_done_timer_t;

#define BDK_NPA_AF_AQ_DONE_TIMER BDK_NPA_AF_AQ_DONE_TIMER_FUNC()
static inline uint64_t BDK_NPA_AF_AQ_DONE_TIMER_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_NPA_AF_AQ_DONE_TIMER_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x840030000670ll;
    __bdk_csr_fatal("NPA_AF_AQ_DONE_TIMER", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_BDK_NPA_AF_AQ_DONE_TIMER bdk_npa_af_aq_done_timer_t
#define bustype_BDK_NPA_AF_AQ_DONE_TIMER BDK_CSR_TYPE_RVU_PF_BAR0
#define basename_BDK_NPA_AF_AQ_DONE_TIMER "NPA_AF_AQ_DONE_TIMER"
#define device_bar_BDK_NPA_AF_AQ_DONE_TIMER 0x0 /* RVU_BAR0 */
#define busnum_BDK_NPA_AF_AQ_DONE_TIMER 0
#define arguments_BDK_NPA_AF_AQ_DONE_TIMER -1,-1,-1,-1
...
static inline uint64_t BDK_NPA_AF_AQ_DONE_WAIT_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_AQ_DONE_WAIT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_AQ_DONE_WAIT 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_AQ_DOOR_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_AQ_DOOR", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_AQ_DOOR 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_AQ_STATUS_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_AQ_STATUS", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_AQ_STATUS 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_AVG_DELAY_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_AVG_DELAY", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_AVG_DELAY 0x0 /* RVU_BAR0 */
 ...
 */
union bdk_npa_af_bar2_aliasx
{
    uint64_t u;
    struct bdk_npa_af_bar2_aliasx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_npa_af_bar2_aliasx_s cn; */
};
typedef union bdk_npa_af_bar2_aliasx bdk_npa_af_bar2_aliasx_t;

static inline uint64_t BDK_NPA_AF_BAR2_ALIASX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_NPA_AF_BAR2_ALIASX(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && (a<=131071))
        return 0x840039100000ll + 8ll * ((a) & 0x1ffff);
    __bdk_csr_fatal("NPA_AF_BAR2_ALIASX", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_NPA_AF_BAR2_ALIASX(a) bdk_npa_af_bar2_aliasx_t
#define bustype_BDK_NPA_AF_BAR2_ALIASX(a) BDK_CSR_TYPE_RVU_PF_BAR0
#define basename_BDK_NPA_AF_BAR2_ALIASX(a) "NPA_AF_BAR2_ALIASX"
#define device_bar_BDK_NPA_AF_BAR2_ALIASX(a) 0x0 /* RVU_BAR0 */
#define busnum_BDK_NPA_AF_BAR2_ALIASX(a) (a)
#define arguments_BDK_NPA_AF_BAR2_ALIASX(a) (a),-1,-1,-1
 ...
 * Not implemented. Placeholder for bug33464.
 */
union bdk_npa_af_bar2_sel
{
    uint64_t u;
    struct bdk_npa_af_bar2_sel_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_17_63        : 47;
    ...
    /* struct bdk_npa_af_bar2_sel_s cn; */
};
typedef union bdk_npa_af_bar2_sel bdk_npa_af_bar2_sel_t;

#define BDK_NPA_AF_BAR2_SEL BDK_NPA_AF_BAR2_SEL_FUNC()
static inline uint64_t BDK_NPA_AF_BAR2_SEL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_NPA_AF_BAR2_SEL_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x840039000000ll;
    __bdk_csr_fatal("NPA_AF_BAR2_SEL", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_BDK_NPA_AF_BAR2_SEL bdk_npa_af_bar2_sel_t
#define bustype_BDK_NPA_AF_BAR2_SEL BDK_CSR_TYPE_RVU_PF_BAR0
#define basename_BDK_NPA_AF_BAR2_SEL "NPA_AF_BAR2_SEL"
#define device_bar_BDK_NPA_AF_BAR2_SEL 0x0 /* RVU_BAR0 */
#define busnum_BDK_NPA_AF_BAR2_SEL 0
#define arguments_BDK_NPA_AF_BAR2_SEL -1,-1,-1,-1
...
static inline uint64_t BDK_NPA_AF_BLK_RST_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_BLK_RST", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_BLK_RST 0x0 /* RVU_BAR0 */
...
union bdk_npa_af_bp_test
{
    ...
    /* struct bdk_npa_af_bp_test_s cn9; */
    /* struct bdk_npa_af_bp_test_s cn96xxp1; */
    struct bdk_npa_af_bp_test_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t enable                : 16; /**< [ 63: 48](R/W) Enable test mode. For diagnostic use only.
                                                                 Internal:
    ...
    /* struct bdk_npa_af_bp_test_cn96xxp3 cn98xx; */
    /* struct bdk_npa_af_bp_test_s cnf95xxp1; */
    /* struct bdk_npa_af_bp_test_cn96xxp3 cnf95xxp2; */
    /* struct bdk_npa_af_bp_test_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_NPA_AF_BP_TEST_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_BP_TEST", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_BP_TEST 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_CONST_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_CONST", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_CONST 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_CONST1_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_CONST1", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_CONST1 0x0 /* RVU_BAR0 */
 ...
 */
union bdk_npa_af_dtx_filter_ctl
{
    uint64_t u;
    struct bdk_npa_af_dtx_filter_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_npa_af_dtx_filter_ctl_s cn; */
};
typedef union bdk_npa_af_dtx_filter_ctl bdk_npa_af_dtx_filter_ctl_t;

#define BDK_NPA_AF_DTX_FILTER_CTL BDK_NPA_AF_DTX_FILTER_CTL_FUNC()
static inline uint64_t BDK_NPA_AF_DTX_FILTER_CTL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_NPA_AF_DTX_FILTER_CTL_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x840030010040ll;
    __bdk_csr_fatal("NPA_AF_DTX_FILTER_CTL", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_BDK_NPA_AF_DTX_FILTER_CTL bdk_npa_af_dtx_filter_ctl_t
#define bustype_BDK_NPA_AF_DTX_FILTER_CTL BDK_CSR_TYPE_RVU_PF_BAR0
#define basename_BDK_NPA_AF_DTX_FILTER_CTL "NPA_AF_DTX_FILTER_CTL"
#define device_bar_BDK_NPA_AF_DTX_FILTER_CTL 0x0 /* RVU_BAR0 */
#define busnum_BDK_NPA_AF_DTX_FILTER_CTL 0
#define arguments_BDK_NPA_AF_DTX_FILTER_CTL -1,-1,-1,-1
...
static inline uint64_t BDK_NPA_AF_ECO_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_ECO", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_ECO 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_ERR_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_ERR_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_ERR_INT 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_ERR_INT_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_ERR_INT_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_ERR_INT_ENA_W1C 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_ERR_INT_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_ERR_INT_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_ERR_INT_ENA_W1S 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_ERR_INT_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_ERR_INT_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_ERR_INT_W1S 0x0 /* RVU_BAR0 */
...
union bdk_npa_af_gen_cfg
{
    ...
    struct bdk_npa_af_gen_cfg_s
    {
        ...
        uint64_t ratem1                : 4;  /**< [ 15: 12](R/W) Issue rate minus one. Limit peak alloc/frees to once per [RATEM1]+1
                                                                 clock cycles to ensure all alloc/frees are visible to OCLA. */
...
static inline uint64_t BDK_NPA_AF_GEN_CFG_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_GEN_CFG", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_GEN_CFG 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_GEN_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_GEN_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_GEN_INT 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_GEN_INT_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_GEN_INT_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_GEN_INT_ENA_W1C 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_GEN_INT_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_GEN_INT_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_GEN_INT_ENA_W1S 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_GEN_INT_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_GEN_INT_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_GEN_INT_W1S 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_INP_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_INP_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_INP_CTL 0x0 /* RVU_BAR0 */
...
union bdk_npa_af_lfx_auras_cfg
{
    ...
    struct bdk_npa_af_lfx_auras_cfg_s
    {
        ...
        uint64_t be                    : 1;  /**< [ 35: 35](R/W) LF big-endian select. Selects the endianness of aura flow control stores to
                                                                 LF IOVA NPA_AURA_S[FC_ADDR] and pool flow control writes to LF IOVA
                                                                 NPA_POOL_S[FC_ADDR].

                                                                 0 = Little-endian. Aura/pool counts are stored in byte invariant
                                                                 little-endian format (LE8) with the following byte ordering: \<7:0\> at byte
                                                                 address 0, \<15:8\> at address 1, ..., \<63:56\> at address 0x7.

                                                                 1 = Big-endian. Aura/pool counts are stored in byte invariant big-endian
    ...
    /* struct bdk_npa_af_lfx_auras_cfg_s cn9; */
    struct bdk_npa_af_lfx_auras_cfg_cn96xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_61_63        : 3;
        uint64_t rmt_lf                : 7;  /**< [ 60: 54](R/W) Reserved.
    ...
    /* struct bdk_npa_af_lfx_auras_cfg_s cn96xxp3; */
    /* struct bdk_npa_af_lfx_auras_cfg_s cn98xx; */
    /* struct bdk_npa_af_lfx_auras_cfg_s cnf95xx; */
    /* struct bdk_npa_af_lfx_auras_cfg_s loki; */
};
...
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && (a<=127))
        return 0x840030004000ll + 0x40000ll * ((a) & 0x7f);
    __bdk_csr_fatal("NPA_AF_LFX_AURAS_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_LFX_AURAS_CFG(a) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_LFX_LOC_AURAS_BASE(unsigned long a)
{
    ...
    __bdk_csr_fatal("NPA_AF_LFX_LOC_AURAS_BASE", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_LFX_LOC_AURAS_BASE(a) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_LFX_QINTS_BASE(unsigned long a)
{
    ...
    __bdk_csr_fatal("NPA_AF_LFX_QINTS_BASE", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_LFX_QINTS_BASE(a) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_LFX_QINTS_CFG(unsigned long a)
{
    ...
    __bdk_csr_fatal("NPA_AF_LFX_QINTS_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_LFX_QINTS_CFG(a) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_LF_RST_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_LF_RST", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_LF_RST 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_NDC_CFG_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_NDC_CFG", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_NDC_CFG 0x0 /* RVU_BAR0 */
 ...
 */
union bdk_npa_af_ndc_sync
{
    uint64_t u;
    struct bdk_npa_af_ndc_sync_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_13_63        : 51;
    ...
    /* struct bdk_npa_af_ndc_sync_s cn; */
};
typedef union bdk_npa_af_ndc_sync bdk_npa_af_ndc_sync_t;

#define BDK_NPA_AF_NDC_SYNC BDK_NPA_AF_NDC_SYNC_FUNC()
static inline uint64_t BDK_NPA_AF_NDC_SYNC_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_NPA_AF_NDC_SYNC_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x840030000050ll;
    __bdk_csr_fatal("NPA_AF_NDC_SYNC", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_BDK_NPA_AF_NDC_SYNC bdk_npa_af_ndc_sync_t
#define bustype_BDK_NPA_AF_NDC_SYNC BDK_CSR_TYPE_RVU_PF_BAR0
#define basename_BDK_NPA_AF_NDC_SYNC "NPA_AF_NDC_SYNC"
#define device_bar_BDK_NPA_AF_NDC_SYNC 0x0 /* RVU_BAR0 */
#define busnum_BDK_NPA_AF_NDC_SYNC 0
#define arguments_BDK_NPA_AF_NDC_SYNC -1,-1,-1,-1
...
static inline uint64_t BDK_NPA_AF_RAS_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_RAS", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_RAS 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_RAS_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_RAS_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_RAS_ENA_W1C 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_RAS_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_RAS_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_RAS_ENA_W1S 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_RAS_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_RAS_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_RAS_W1S 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_RVU_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_RVU_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_RVU_INT 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_RVU_INT_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_RVU_INT_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_RVU_INT_ENA_W1C 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_RVU_INT_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_RVU_INT_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_RVU_INT_ENA_W1S 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_RVU_INT_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_RVU_INT_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_RVU_INT_W1S 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_AF_RVU_LF_CFG_DEBUG_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_AF_RVU_LF_CFG_DEBUG", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_AF_RVU_LF_CFG_DEBUG 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_LF_AURA_OP_ALLOCX(unsigned long a)
{
    ...
    __bdk_csr_fatal("NPA_LF_AURA_OP_ALLOCX", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_AURA_OP_ALLOCX(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_AURA_OP_CNT_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_AURA_OP_CNT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_AURA_OP_CNT 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_AURA_OP_FREE0_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_AURA_OP_FREE0", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_AURA_OP_FREE0 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_AURA_OP_FREE1_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_AURA_OP_FREE1", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_AURA_OP_FREE1 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_AURA_OP_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_AURA_OP_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_AURA_OP_INT 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_AURA_OP_LIMIT_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_AURA_OP_LIMIT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_AURA_OP_LIMIT 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_AURA_OP_THRESH_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_AURA_OP_THRESH", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_AURA_OP_THRESH 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_ERR_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_ERR_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_ERR_INT 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_ERR_INT_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_ERR_INT_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_ERR_INT_ENA_W1C 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_ERR_INT_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_ERR_INT_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_ERR_INT_ENA_W1S 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_ERR_INT_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_ERR_INT_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_ERR_INT_W1S 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_POOL_OP_AVAILABLE_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_POOL_OP_AVAILABLE", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_POOL_OP_AVAILABLE 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_POOL_OP_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_POOL_OP_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_POOL_OP_INT 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_POOL_OP_PC_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_POOL_OP_PC", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_POOL_OP_PC 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_POOL_OP_PTR_END0_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_POOL_OP_PTR_END0", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_POOL_OP_PTR_END0 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_POOL_OP_PTR_END1_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_POOL_OP_PTR_END1", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_POOL_OP_PTR_END1 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_POOL_OP_PTR_START0_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_POOL_OP_PTR_START0", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_POOL_OP_PTR_START0 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_POOL_OP_PTR_START1_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_POOL_OP_PTR_START1", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_POOL_OP_PTR_START1 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_POOL_OP_THRESH_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_POOL_OP_THRESH", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_POOL_OP_THRESH 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_QINTX_CNT(unsigned long a)
{
    ...
    __bdk_csr_fatal("NPA_LF_QINTX_CNT", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_QINTX_CNT(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_QINTX_ENA_W1C(unsigned long a)
{
    ...
    __bdk_csr_fatal("NPA_LF_QINTX_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_QINTX_ENA_W1C(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_QINTX_ENA_W1S(unsigned long a)
{
    ...
    __bdk_csr_fatal("NPA_LF_QINTX_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_QINTX_ENA_W1S(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_QINTX_INT(unsigned long a)
{
    ...
    __bdk_csr_fatal("NPA_LF_QINTX_INT", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_QINTX_INT(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_QINTX_INT_W1S(unsigned long a)
{
    ...
    __bdk_csr_fatal("NPA_LF_QINTX_INT_W1S", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_QINTX_INT_W1S(a) 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_RAS_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_RAS", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_RAS 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_RAS_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_RAS_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_RAS_ENA_W1C 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_RAS_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_RAS_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_RAS_ENA_W1S 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_LF_RAS_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_LF_RAS_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_LF_RAS_W1S 0x2 /* RVU_BAR2 */
...
static inline uint64_t BDK_NPA_PRIV_AF_INT_CFG_FUNC(void)
{
    ...
    __bdk_csr_fatal("NPA_PRIV_AF_INT_CFG", 0, 0, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_PRIV_AF_INT_CFG 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_PRIV_LFX_CFG(unsigned long a)
{
    ...
    __bdk_csr_fatal("NPA_PRIV_LFX_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_PRIV_LFX_CFG(a) 0x0 /* RVU_BAR0 */
...
static inline uint64_t BDK_NPA_PRIV_LFX_INT_CFG(unsigned long a)
{
    ...
    __bdk_csr_fatal("NPA_PRIV_LFX_INT_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
#define device_bar_BDK_NPA_PRIV_LFX_INT_CFG(a) 0x0 /* RVU_BAR0 */
