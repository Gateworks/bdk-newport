 ...
 */
union bdk_dap_cab_addr_s
{
    uint64_t u;
    struct bdk_dap_cab_addr_s_s
    {
    ...
    /* struct bdk_dap_cab_addr_s_s cn; */
};
...
static inline uint64_t BDK_DAP_CONST_FUNC(void)
{
    ...
    __bdk_csr_fatal("DAP_CONST", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_dap_hwpoll_cnt
{
    ...
    /* struct bdk_dap_hwpoll_cnt_s cn; */
};
...
union bdk_dap_imp_dar
{
    ...
    /* struct bdk_dap_imp_dar_cn9 cn96xxp1; */
    struct bdk_dap_imp_dar_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_30_31        : 2;
        uint32_t distracefeature       : 1;  /**< [ 29: 29](R/W) Reserved.
    ...
    /* struct bdk_dap_imp_dar_cn96xxp3 cn98xx; */
    /* struct bdk_dap_imp_dar_cn96xxp3 cnf95xx; */
    /* struct bdk_dap_imp_dar_cn96xxp3 loki; */
};
...
union bdk_dap_owb_to
{
    ...
    /* struct bdk_dap_owb_to_s cn8; */
    struct bdk_dap_owb_to_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t to_dis                : 1;  /**< [ 31: 31](R/W) Disable timeout mechanism. */
        uint32_t reserved_16_30        : 15;
...
static inline uint64_t BDK_DAP_OWB_TO_STATUS_FUNC(void)
{
    ...
    __bdk_csr_fatal("DAP_OWB_TO_STATUS", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_dap_rst_on_warm
{
    ...
    /* struct bdk_dap_rst_on_warm_s cn8; */
    struct bdk_dap_rst_on_warm_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
