...
#define BDK_CCS_RID_E_CLU4_PIC (0x12)
#define BDK_CCS_RID_E_CLU4_TAD0 (0x10)
#define BDK_CCS_RID_E_CLU4_TAD1 (0x11)
#define BDK_CCS_RID_E_CLU5_PIC (0x16)
#define BDK_CCS_RID_E_CLU5_TAD0 (0x14)
#define BDK_CCS_RID_E_CLU5_TAD1 (0x15)
#define BDK_CCS_RID_E_IOB0 (0x24)
#define BDK_CCS_RID_E_IOB1 (0x25)
#define BDK_CCS_RID_E_IOB2 (0x26)
...
static inline uint64_t BDK_CCS_ADR_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("CCS_ADR_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CCS_ADR_MCSX(unsigned long a)
{
    ...
    __bdk_csr_fatal("CCS_ADR_MCSX", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_ccs_adr_tdsx
{
    ...
    /* struct bdk_ccs_adr_tdsx_s cn9; */
    /* struct bdk_ccs_adr_tdsx_s cn96xx; */
    struct bdk_ccs_adr_tdsx_cn98xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_43_63        : 21;
        uint64_t en                    : 35; /**< [ 42:  8](R/W) Enable for each bit that is to participate (1 means participate, 0 means does
    ...
    struct bdk_ccs_adr_tdsx_cnf95xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_43_63        : 21;
    ...
    /* struct bdk_ccs_adr_tdsx_cnf95xx loki; */
};
...
static inline uint64_t BDK_CCS_ADR_TDSX(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=1))
        return 0x87e087104000ll + 8ll * ((a) & 0x1);
    __bdk_csr_fatal("CCS_ADR_TDSX", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_ccs_asc_regionx_attr
{
    ...
    /* struct bdk_ccs_asc_regionx_attr_s cn9; */
    /* struct bdk_ccs_asc_regionx_attr_s cn96xx; */
    struct bdk_ccs_asc_regionx_attr_cn98xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_9_63         : 55;
        uint64_t write_through         : 1;  /**< [  8:  8](R/W) When set addresses in the region are treated as write-through. All modifications
    ...
    struct bdk_ccs_asc_regionx_attr_cnf95xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_9_63         : 55;
        uint64_t write_through         : 1;  /**< [  8:  8](R/W) When set addresses in the region are treated as write-through. All modifications
    ...
    /* struct bdk_ccs_asc_regionx_attr_cnf95xx loki; */
};
...
static inline uint64_t BDK_CCS_ASC_REGIONX_ATTR(unsigned long a)
{
    ...
    __bdk_csr_fatal("CCS_ASC_REGIONX_ATTR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CCS_ASC_REGIONX_END(unsigned long a)
{
    ...
    __bdk_csr_fatal("CCS_ASC_REGIONX_END", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CCS_ASC_REGIONX_OFFSET(unsigned long a)
{
    ...
    __bdk_csr_fatal("CCS_ASC_REGIONX_OFFSET", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CCS_ASC_REGIONX_START(unsigned long a)
{
    ...
    __bdk_csr_fatal("CCS_ASC_REGIONX_START", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_ccs_bcst_rsp
{
    ...
    /* struct bdk_ccs_bcst_rsp_s cn9; */
    /* struct bdk_ccs_bcst_rsp_s cn96xx; */
    /* struct bdk_ccs_bcst_rsp_s cn98xx; */
    struct bdk_ccs_bcst_rsp_cnf95xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
    ...
    /* struct bdk_ccs_bcst_rsp_cnf95xx loki; */
};
...
static inline uint64_t BDK_CCS_BCST_RSP_FUNC(void)
{
    ...
    __bdk_csr_fatal("CCS_BCST_RSP", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CCS_CCPI_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("CCS_CCPI_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CCS_CONST_FUNC(void)
{
    ...
    __bdk_csr_fatal("CCS_CONST", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CCS_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("CCS_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CCS_MLC_CONST_FUNC(void)
{
    ...
    __bdk_csr_fatal("CCS_MLC_CONST", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CCS_MPARX_MASK(unsigned long a)
{
    ...
    __bdk_csr_fatal("CCS_MPARX_MASK", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CCS_PIC_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("CCS_PIC_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CCS_QUICK_DIDX(unsigned long a)
{
    ...
    __bdk_csr_fatal("CCS_QUICK_DIDX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CCS_QUICK_HUGE_FUNC(void)
{
    ...
    __bdk_csr_fatal("CCS_QUICK_HUGE", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CCS_SCRATCH_FUNC(void)
{
    ...
    __bdk_csr_fatal("CCS_SCRATCH", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CCS_TAD_CONST_FUNC(void)
{
    ...
    __bdk_csr_fatal("CCS_TAD_CONST", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_CCS_TAD_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("CCS_TAD_CTL", 0, 0, 0, 0, 0, 0, 0);
}
