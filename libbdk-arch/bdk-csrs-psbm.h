 ...
 */
#define BDK_PSBM_AP_CHAIN_E_APX(a) (0 + (a))
 ...
 */
#define BDK_PSBM_SYS_CHAIN_E_CPT (0xb)
#define BDK_PSBM_SYS_CHAIN_E_CPTX(a) (0xd + (a))
#define BDK_PSBM_SYS_CHAIN_E_DCPX_CN96XX(a) (4 + (a))
#define BDK_PSBM_SYS_CHAIN_E_DCPX_CN98XX(a) (6 + (a))
#define BDK_PSBM_SYS_CHAIN_E_DCPX_CNF95XX(a) (1 + (a))
#define BDK_PSBM_SYS_CHAIN_E_DCPX_LOKI(a) (1 + (a))
#define BDK_PSBM_SYS_CHAIN_E_GSERX_CN96XX(a) (7 + (a))
#define BDK_PSBM_SYS_CHAIN_E_GSERX_CN98XX(a) (9 + (a))
#define BDK_PSBM_SYS_CHAIN_E_GSERX_CNF95XX(a) (3 + (a))
#define BDK_PSBM_SYS_CHAIN_E_GSERX_LOKI(a) (3 + (a))
#define BDK_PSBM_SYS_CHAIN_E_IOB_CN96XX (6)
#define BDK_PSBM_SYS_CHAIN_E_IOB_CN98XX (8)
#define BDK_PSBM_SYS_CHAIN_E_IOBX(a) (2 + (a))
 ...
 */
#define BDK_PSBM_SYS_MAP_E_CPTX_CN96XX(a) (0xd + (a))
#define BDK_PSBM_SYS_MAP_E_CPTX_CN98XX(a) (0x17 + (a))
#define BDK_PSBM_SYS_MAP_E_GSERX_CN96XX(a) (5 + (a))
#define BDK_PSBM_SYS_MAP_E_GSERX_CN98XX(a) (9 + (a))
#define BDK_PSBM_SYS_MAP_E_GSERX_CNF95XX(a) (3 + (a))
#define BDK_PSBM_SYS_MAP_E_GSERX_LOKI(a) (3 + (a))
#define BDK_PSBM_SYS_MAP_E_GSERRX_CN96XX(a) (0xa + (a))
#define BDK_PSBM_SYS_MAP_E_GSERRX_CN98XX(a) (0x12 + (a))
#define BDK_PSBM_SYS_MAP_E_IOBX_CN96XX(a) (3 + (a))
#define BDK_PSBM_SYS_MAP_E_IOBX_CN98XX(a) (6 + (a))
#define BDK_PSBM_SYS_MAP_E_IOBX_CNF95XX(a) (2 + (a))
#define BDK_PSBM_SYS_MAP_E_IOBX_LOKI(a) (2 + (a))
#define BDK_PSBM_SYS_MAP_E_LMCX_CN96XX(a) (0 + (a))
#define BDK_PSBM_SYS_MAP_E_LMCX_CN98XX(a) (0 + (a))
#define BDK_PSBM_SYS_MAP_E_LMCX_CNF95XX(a) (0x00 | a>>1)
#define BDK_PSBM_SYS_MAP_E_LMCX_LOKI(a) (0x00 | a>>1)
...
union bdk_psbm_apx_datax
{
    ...
    /* struct bdk_psbm_apx_datax_s cn9; */
    /* struct bdk_psbm_apx_datax_s cn96xxp1; */
    struct bdk_psbm_apx_datax_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t data                  : 32; /**< [ 31:  0](R/W/H) Data read from the specified AP slave's register.
    ...
    /* struct bdk_psbm_apx_datax_cn96xxp3 cn98xx; */
    /* struct bdk_psbm_apx_datax_cn96xxp3 cnf95xx; */
    /* struct bdk_psbm_apx_datax_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_PSBM_APX_DATAX(unsigned long a, unsigned long b)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=5) && (b<=5)))
        return 0x87e0de010000ll + 0x100ll * ((a) & 0x7) + 0x10ll * ((b) & 0x7);
    __bdk_csr_fatal("PSBM_APX_DATAX", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PSBM_APX_HDR(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x87e0de018000ll + 0x10ll * ((a) & 0x7);
    __bdk_csr_fatal("PSBM_APX_HDR", 1, a, 0, 0, 0, 0, 0);
}
 ...
 */
union bdk_psbm_chain_dbg
{
    uint32_t u;
    struct bdk_psbm_chain_dbg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_psbm_chain_dbg_s cn9; */
    struct bdk_psbm_chain_dbg_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_psbm_chain_dbg_s cn98xx; */
    struct bdk_psbm_chain_dbg_cnf95xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_psbm_chain_dbg_cnf95xx loki; */
};
typedef union bdk_psbm_chain_dbg bdk_psbm_chain_dbg_t;

#define BDK_PSBM_CHAIN_DBG BDK_PSBM_CHAIN_DBG_FUNC()
static inline uint64_t BDK_PSBM_CHAIN_DBG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_PSBM_CHAIN_DBG_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x87e0de000100ll;
    __bdk_csr_fatal("PSBM_CHAIN_DBG", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_BDK_PSBM_CHAIN_DBG bdk_psbm_chain_dbg_t
#define bustype_BDK_PSBM_CHAIN_DBG BDK_CSR_TYPE_NCB32b
#define basename_BDK_PSBM_CHAIN_DBG "PSBM_CHAIN_DBG"
#define device_bar_BDK_PSBM_CHAIN_DBG 0x0 /* PF_BAR0 */
#define busnum_BDK_PSBM_CHAIN_DBG 0
#define arguments_BDK_PSBM_CHAIN_DBG -1,-1,-1,-1
...
static inline uint64_t BDK_PSBM_CONST_FUNC(void)
{
    ...
    __bdk_csr_fatal("PSBM_CONST", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PSBM_CONST1_FUNC(void)
{
    ...
    __bdk_csr_fatal("PSBM_CONST1", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PSBM_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("PSBM_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PSBM_ECO_FUNC(void)
{
    ...
    __bdk_csr_fatal("PSBM_ECO", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PSBM_LINT_FUNC(void)
{
    ...
    __bdk_csr_fatal("PSBM_LINT", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PSBM_LINT_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("PSBM_LINT_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PSBM_LINT_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("PSBM_LINT_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PSBM_LINT_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("PSBM_LINT_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN96XX) && ((a<=13) && (b<=5)))
        return 0x87e0de020000ll + 0x100ll * ((a) & 0xf) + 0x10ll * ((b) & 0x7);
    if (bdk_is_model(OCTEONTX_CN98XX) && ((a<=24) && (b<=5)))
        return 0x87e0de020000ll + 0x100ll * ((a) & 0x1f) + 0x10ll * ((b) & 0x7);
    if (bdk_is_model(OCTEONTX_CNF95XX) && ((a<=4) && (b<=5)))
        return 0x87e0de020000ll + 0x100ll * ((a) & 0x7) + 0x10ll * ((b) & 0x7);
    if (bdk_is_model(OCTEONTX_LOKI) && ((a<=4) && (b<=5)))
        return 0x87e0de020000ll + 0x100ll * ((a) & 0x7) + 0x10ll * ((b) & 0x7);
    __bdk_csr_fatal("PSBM_SYSX_DATAX", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PSBM_SYSX_HDR(unsigned long a)
{
    ...
    if (bdk_is_model(OCTEONTX_LOKI) && (a<=4))
        return 0x87e0de028000ll + 0x10ll * ((a) & 0x7);
    __bdk_csr_fatal("PSBM_SYSX_HDR", 1, a, 0, 0, 0, 0, 0);
}
