...
#define BDK_FUSF_FUSE_NUM_E_RSVD17X(a) (0x11 + (a))
...
#define BDK_FUSF_FUSE_NUM_E_SCAN_DISABLE (0x10)
...
static inline uint64_t BDK_FUSF_BNK_DATX(unsigned long a)
{
    ...
    __bdk_csr_fatal("FUSF_BNK_DATX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_FUSF_CONST_FUNC(void)
{
    ...
    __bdk_csr_fatal("FUSF_CONST", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_fusf_ctl
{
    ...
    /* struct bdk_fusf_ctl_cn96xxp3 cn98xx; */
    /* struct bdk_fusf_ctl_cn96xxp3 cnf95xx; */
    /* struct bdk_fusf_ctl_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_FUSF_ECO_FUNC(void)
{
    ...
    __bdk_csr_fatal("FUSF_ECO", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_FUSF_EKX(unsigned long a)
{
    ...
    __bdk_csr_fatal("FUSF_EKX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_FUSF_HUKX(unsigned long a)
{
    ...
    __bdk_csr_fatal("FUSF_HUKX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_FUSF_ROTPKX(unsigned long a)
{
    ...
    __bdk_csr_fatal("FUSF_ROTPKX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_FUSF_SSKX(unsigned long a)
{
    ...
    __bdk_csr_fatal("FUSF_SSKX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_FUSF_SWX(unsigned long a)
{
    ...
    __bdk_csr_fatal("FUSF_SWX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_FUSF_WADR_FUNC(void)
{
    ...
    __bdk_csr_fatal("FUSF_WADR", 0, 0, 0, 0, 0, 0, 0);
}
