...
static inline uint64_t BDK_SMI_X_CLK(unsigned long a)
{
    ...
    __bdk_csr_fatal("SMI_X_CLK", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_SMI_X_CLKEN(unsigned long a)
{
    ...
    __bdk_csr_fatal("SMI_X_CLKEN", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_SMI_X_CMD(unsigned long a)
{
    ...
    __bdk_csr_fatal("SMI_X_CMD", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_smi_x_eco
{
    ...
    /* struct bdk_smi_x_eco_s cn; */
};
typedef union bdk_smi_x_eco bdk_smi_x_eco_t;

static inline uint64_t BDK_SMI_X_ECO(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t BDK_SMI_X_ECO(unsigned long a)
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && (a<=1))
        return 0x87e005003828ll + 0x80ll * ((a) & 0x1);
    __bdk_csr_fatal("SMI_X_ECO", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_BDK_SMI_X_ECO(a) bdk_smi_x_eco_t
#define bustype_BDK_SMI_X_ECO(a) BDK_CSR_TYPE_RSL
#define basename_BDK_SMI_X_ECO(a) "SMI_X_ECO"
#define device_bar_BDK_SMI_X_ECO(a) 0x0 /* PF_BAR0 */
#define busnum_BDK_SMI_X_ECO(a) (a)
#define arguments_BDK_SMI_X_ECO(a) (a),-1,-1,-1
...
static inline uint64_t BDK_SMI_X_EN(unsigned long a)
{
    ...
    __bdk_csr_fatal("SMI_X_EN", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_SMI_X_RD_DAT(unsigned long a)
{
    ...
    __bdk_csr_fatal("SMI_X_RD_DAT", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_SMI_X_WR_DAT(unsigned long a)
{
    ...
    __bdk_csr_fatal("SMI_X_WR_DAT", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_SMI_DRV_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("SMI_DRV_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_SMI_DRV_RSVD_FUNC(void)
{
    ...
    __bdk_csr_fatal("SMI_DRV_RSVD", 0, 0, 0, 0, 0, 0, 0);
}
