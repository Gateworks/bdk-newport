...
static inline uint64_t BDK_PBUS_DEBUG_FUNC(void)
{
    ...
    __bdk_csr_fatal("PBUS_DEBUG", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PBUS_DMA_ADRX(unsigned long a)
{
    ...
    __bdk_csr_fatal("PBUS_DMA_ADRX", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_pbus_dma_cfgx
{
    ...
    /* struct bdk_pbus_dma_cfgx_s cn8; */
    struct bdk_pbus_dma_cfgx_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t en                    : 1;  /**< [ 63: 63](R/W/H) DMA engine enable.  This bit is automatically cleared when the DMA is completed.
...
static inline uint64_t BDK_PBUS_DMA_CFGX(unsigned long a)
{
    ...
    __bdk_csr_fatal("PBUS_DMA_CFGX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PBUS_DMA_TIMX(unsigned long a)
{
    ...
    __bdk_csr_fatal("PBUS_DMA_TIMX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PBUS_MSIX_PBAX(unsigned long a)
{
    ...
    __bdk_csr_fatal("PBUS_MSIX_PBAX", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_pbus_msix_vecx_addr
{
    ...
    /* struct bdk_pbus_msix_vecx_addr_s cn96xxp1; */
    struct bdk_pbus_msix_vecx_addr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
    ...
    /* struct bdk_pbus_msix_vecx_addr_cn96xxp3 cn98xx; */
    /* struct bdk_pbus_msix_vecx_addr_cn96xxp3 cnf95xx; */
    /* struct bdk_pbus_msix_vecx_addr_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_PBUS_MSIX_VECX_ADDR(unsigned long a)
{
    ...
    __bdk_csr_fatal("PBUS_MSIX_VECX_ADDR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PBUS_MSIX_VECX_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("PBUS_MSIX_VECX_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PBUS_REGX_CFG(unsigned long a)
{
    ...
    __bdk_csr_fatal("PBUS_REGX_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_PBUS_REGX_TIM(unsigned long a)
{
    ...
    __bdk_csr_fatal("PBUS_REGX_TIM", 1, a, 0, 0, 0, 0, 0);
}
