...
static inline uint64_t BDK_BCH_ACTIVE_PC_FUNC(void)
{
    ...
    __bdk_csr_fatal("BCH_ACTIVE_PC", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_BIST_RESULT_FUNC(void)
{
    ...
    __bdk_csr_fatal("BCH_BIST_RESULT", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_BUSY_FUNC(void)
{
    ...
    __bdk_csr_fatal("BCH_BUSY", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_CONST_FUNC(void)
{
    ...
    __bdk_csr_fatal("BCH_CONST", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_ERR_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("BCH_ERR_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_ERR_INT_ENA_W1C_FUNC(void)
{
    ...
    __bdk_csr_fatal("BCH_ERR_INT_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_ERR_INT_ENA_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("BCH_ERR_INT_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_ERR_INT_W1S_FUNC(void)
{
    ...
    __bdk_csr_fatal("BCH_ERR_INT_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_PF_MSIX_PBAX(unsigned long a)
{
    ...
    __bdk_csr_fatal("BCH_PF_MSIX_PBAX", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_bch_pf_msix_vecx_addr
{
    ...
    /* struct bdk_bch_pf_msix_vecx_addr_s cn96xxp1; */
    struct bdk_bch_pf_msix_vecx_addr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
    ...
    /* struct bdk_bch_pf_msix_vecx_addr_cn96xxp3 cn98xx; */
    /* struct bdk_bch_pf_msix_vecx_addr_cn96xxp3 cnf95xx; */
    /* struct bdk_bch_pf_msix_vecx_addr_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_BCH_PF_MSIX_VECX_ADDR(unsigned long a)
{
    ...
    __bdk_csr_fatal("BCH_PF_MSIX_VECX_ADDR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_PF_MSIX_VECX_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("BCH_PF_MSIX_VECX_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_PF_POISON_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x871000000088ll;
    __bdk_csr_fatal("BCH_PF_POISON", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_PF_POISON_ENA_W1C_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x8710000000a0ll;
    __bdk_csr_fatal("BCH_PF_POISON_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_PF_POISON_ENA_W1S_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x8710000000a8ll;
    __bdk_csr_fatal("BCH_PF_POISON_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_PF_POISON_W1S_FUNC(void)
{
    if (bdk_is_model(OCTEONTX_CN9XXX))
        return 0x871000000090ll;
    __bdk_csr_fatal("BCH_PF_POISON_W1S", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_bch_pf_qx_gmctl
{
    ...
    /* struct bdk_bch_pf_qx_gmctl_s cn8; */
    /* struct bdk_bch_pf_qx_gmctl_s cn81xx; */
    struct bdk_bch_pf_qx_gmctl_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
...
static inline uint64_t BDK_BCH_PF_QX_GMCTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("BCH_PF_QX_GMCTL", 1, a, 0, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN9XXX) && ((a==0) && (b==0)))
        return 0x8710018f0000ll + 0x100000ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __bdk_csr_fatal("BCH_VFX_MSIX_PBAX", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_VFX_MSIX_VECX_ADDR(unsigned long a, unsigned long b)
{
    ...
    __bdk_csr_fatal("BCH_VFX_MSIX_VECX_ADDR", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_VFX_MSIX_VECX_CTL(unsigned long a, unsigned long b)
{
    ...
    __bdk_csr_fatal("BCH_VFX_MSIX_VECX_CTL", 2, a, b, 0, 0, 0, 0);
}
...
union bdk_bch_vqx_cmd_buf
{
    ...
    /* struct bdk_bch_vqx_cmd_buf_s cn8; */
    /* struct bdk_bch_vqx_cmd_buf_s cn81xx; */
    struct bdk_bch_vqx_cmd_buf_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_60_63        : 4;
...
static inline uint64_t BDK_BCH_VQX_CMD_BUF(unsigned long a)
{
    ...
    __bdk_csr_fatal("BCH_VQX_CMD_BUF", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_VQX_CMD_PTR(unsigned long a)
{
    ...
    __bdk_csr_fatal("BCH_VQX_CMD_PTR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_VQX_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("BCH_VQX_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_VQX_DOORBELL(unsigned long a)
{
    ...
    __bdk_csr_fatal("BCH_VQX_DOORBELL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_VQX_INT(unsigned long a)
{
    ...
    __bdk_csr_fatal("BCH_VQX_INT", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_VQX_INT_ENA_W1C(unsigned long a)
{
    ...
    __bdk_csr_fatal("BCH_VQX_INT_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_VQX_INT_ENA_W1S(unsigned long a)
{
    ...
    __bdk_csr_fatal("BCH_VQX_INT_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_BCH_VQX_INT_W1S(unsigned long a)
{
    ...
    __bdk_csr_fatal("BCH_VQX_INT_W1S", 1, a, 0, 0, 0, 0, 0);
}
