 ...
 */
#define BDK_UAA_BAR_E_UAAX_PF_BAR0_CN8(a) (0x87e028000000ll + 0x1000000ll * (a))
#define BDK_UAA_BAR_E_UAAX_PF_BAR0_CN8_SIZE 0x100000ull
...
#define BDK_UAA_BAR_E_UAAX_PF_BAR4(a) (0x87e028f00000ll + 0x1000000ll * (a))
#define BDK_UAA_BAR_E_UAAX_PF_BAR4_SIZE 0x100000ull
...
static inline uint64_t BDK_UAAX_CIDR0(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_CIDR0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_CIDR1(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_CIDR1", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_CIDR2(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_CIDR2", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_CIDR3(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_CIDR3", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_CR(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_CR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_DR(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_DR", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_uaax_fbrd
{
    ...
    /* struct bdk_uaax_fbrd_s cn8; */
    struct bdk_uaax_fbrd_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_6_31         : 26;
...
static inline uint64_t BDK_UAAX_FBRD(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_FBRD", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_FR(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_FR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_IBRD(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_IBRD", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_ICR(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_ICR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_IFLS(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_IFLS", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_IMSC(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_IMSC", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_IO_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_IO_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_LCR_H(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_LCR_H", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_MIS(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_MIS", 1, a, 0, 0, 0, 0, 0);
}
...
{
    if (bdk_is_model(OCTEONTX_CN8XXX) && ((a<=3) && (b==0)))
        return 0x87e028ff0000ll + 0x1000000ll * ((a) & 0x3) + 8ll * ((b) & 0x0);
    if (bdk_is_model(OCTEONTX_CN9XXX) && ((a<=7) && (b==0)))
        return 0x87e028ff0000ll + 0x1000000ll * ((a) & 0x7) + 8ll * ((b) & 0x0);
    __bdk_csr_fatal("UAAX_MSIX_PBAX", 2, a, b, 0, 0, 0, 0);
}
...
union bdk_uaax_msix_vecx_addr
{
    ...
    struct bdk_uaax_msix_vecx_addr_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct bdk_uaax_msix_vecx_addr_cn9 cn96xxp1; */
    struct bdk_uaax_msix_vecx_addr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
    ...
    /* struct bdk_uaax_msix_vecx_addr_cn96xxp3 cn98xx; */
    /* struct bdk_uaax_msix_vecx_addr_cn96xxp3 cnf95xx; */
    /* struct bdk_uaax_msix_vecx_addr_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_UAAX_MSIX_VECX_ADDR(unsigned long a, unsigned long b)
{
    ...
    __bdk_csr_fatal("UAAX_MSIX_VECX_ADDR", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_MSIX_VECX_CTL(unsigned long a, unsigned long b)
{
    ...
    __bdk_csr_fatal("UAAX_MSIX_VECX_CTL", 2, a, b, 0, 0, 0, 0);
}
...
union bdk_uaax_pidr0
{
    ...
    /* struct bdk_uaax_pidr0_s cn8; */
    struct bdk_uaax_pidr0_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t partnum0              : 8;  /**< [  7:  0](RO) Part number \<7:0\>.  ARM-assigned PL011 compatible. */
    ...
    /* struct bdk_uaax_pidr0_cn9 cn96xxp1; */
    /* struct bdk_uaax_pidr0_s cn96xxp3; */
    /* struct bdk_uaax_pidr0_s cn98xx; */
    /* struct bdk_uaax_pidr0_s cnf95xx; */
    /* struct bdk_uaax_pidr0_s loki; */
};
...
static inline uint64_t BDK_UAAX_PIDR0(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_PIDR0", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_uaax_pidr1
{
    ...
    /* struct bdk_uaax_pidr1_s cn8; */
    struct bdk_uaax_pidr1_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t idcode                : 4;  /**< [  7:  4](RO) ARM identification. */
    ...
    /* struct bdk_uaax_pidr1_cn9 cn96xxp1; */
    /* struct bdk_uaax_pidr1_s cn96xxp3; */
    /* struct bdk_uaax_pidr1_s cn98xx; */
    /* struct bdk_uaax_pidr1_s cnf95xx; */
    /* struct bdk_uaax_pidr1_s loki; */
};
...
static inline uint64_t BDK_UAAX_PIDR1(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_PIDR1", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_uaax_pidr2
{
    ...
    /* struct bdk_uaax_pidr2_s cn8; */
    struct bdk_uaax_pidr2_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) UART architectural revision.
    ...
    /* struct bdk_uaax_pidr2_cn9 cn96xxp1; */
    /* struct bdk_uaax_pidr2_s cn96xxp3; */
    /* struct bdk_uaax_pidr2_s cn98xx; */
    /* struct bdk_uaax_pidr2_s cnf95xx; */
    /* struct bdk_uaax_pidr2_s loki; */
};
...
static inline uint64_t BDK_UAAX_PIDR2(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_PIDR2", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_PIDR3(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_PIDR3", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_PIDR4(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_PIDR4", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_PIDR5(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_PIDR5", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_PIDR6(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_PIDR6", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_PIDR7(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_PIDR7", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_REDIRECT(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_REDIRECT", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_RIS(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_RIS", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_RSR_ECR(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_RSR_ECR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_UCTL_CSCLK_ACTIVE_PC(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_UCTL_CSCLK_ACTIVE_PC", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_UCTL_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_UCTL_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_UCTL_SPARE0(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_UCTL_SPARE0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_UAAX_UCTL_SPARE1(unsigned long a)
{
    ...
    __bdk_csr_fatal("UAAX_UCTL_SPARE1", 1, a, 0, 0, 0, 0, 0);
}
