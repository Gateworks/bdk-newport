...
#define BDK_GTI_BAR_E_GTI_PF_BAR0_CN9 (0x802000000000ll)
#define BDK_GTI_BAR_E_GTI_PF_BAR0_CN9_SIZE 0x100000ull
#define BDK_GTI_BAR_E_GTI_PF_BAR4_CN8 (0x84400f000000ll)
#define BDK_GTI_BAR_E_GTI_PF_BAR4_CN8_SIZE 0x100000ull
#define BDK_GTI_BAR_E_GTI_PF_BAR4_CN9 (0x80200f000000ll)
#define BDK_GTI_BAR_E_GTI_PF_BAR4_CN9_SIZE 0x100000ull
...
static inline uint64_t BDK_GTI_BP_TEST_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BP_TEST", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_BZ_CIDR0_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BZ_CIDR0", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_BZ_CIDR1_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BZ_CIDR1", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_BZ_CIDR2_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BZ_CIDR2", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_bz_cidr3
{
    ...
    /* struct bdk_gti_bz_cidr3_s cn8; */
    struct bdk_gti_bz_cidr3_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t preamble              : 8;  /**< [  7:  0](RO) Preamble identification value. */
...
static inline uint64_t BDK_GTI_BZ_CIDR3_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BZ_CIDR3", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_BZ_CNTP_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BZ_CNTP_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_BZ_CNTP_CVAL_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BZ_CNTP_CVAL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_BZ_CNTP_TVAL_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BZ_CNTP_TVAL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_BZ_PIDR0_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BZ_PIDR0", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_bz_pidr1
{
    ...
    /* struct bdk_gti_bz_pidr1_s cn8; */
    /* struct bdk_gti_bz_pidr1_s cn9; */
    /* struct bdk_gti_bz_pidr1_s cn96xxp1; */
    struct bdk_gti_bz_pidr1_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct bdk_gti_bz_pidr1_cn96xxp3 cn98xx; */
    /* struct bdk_gti_bz_pidr1_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_bz_pidr1_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_BZ_PIDR1_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BZ_PIDR1", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_bz_pidr2
{
    ...
    /* struct bdk_gti_bz_pidr2_s cn8; */
    struct bdk_gti_bz_pidr2_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by ARM. */
    ...
    /* struct bdk_gti_bz_pidr2_cn9 cn96xxp1; */
    struct bdk_gti_bz_pidr2_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by Arm. */
    ...
    /* struct bdk_gti_bz_pidr2_cn96xxp3 cn98xx; */
    /* struct bdk_gti_bz_pidr2_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_bz_pidr2_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_BZ_PIDR2_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BZ_PIDR2", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_BZ_PIDR3_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BZ_PIDR3", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_bz_pidr4
{
    ...
    /* struct bdk_gti_bz_pidr4_s cn8; */
    /* struct bdk_gti_bz_pidr4_s cn9; */
    /* struct bdk_gti_bz_pidr4_s cn96xxp1; */
    struct bdk_gti_bz_pidr4_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t pagecnt               : 4;  /**< [  7:  4](RO) Number of log-2 4 KB blocks occupied. */
    ...
    /* struct bdk_gti_bz_pidr4_cn96xxp3 cn98xx; */
    /* struct bdk_gti_bz_pidr4_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_bz_pidr4_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_BZ_PIDR4_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BZ_PIDR4", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_BZ_PIDR5_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BZ_PIDR5", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_BZ_PIDR6_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BZ_PIDR6", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_BZ_PIDR7_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_BZ_PIDR7", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CIDR0_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CIDR0", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CIDR1_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CIDR1", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CIDR2_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CIDR2", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CIDR3_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CIDR3", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CNTADD_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CNTADD", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CNTCR_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CNTCR", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CNTCV_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CNTCV", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CNTFID0_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CNTFID0", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CNTFID1_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CNTFID1", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CNTMB_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CNTMB", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CNTMB_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CNTMB_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CNTMB_INT_ENA_CLR_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CNTMB_INT_ENA_CLR", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CNTMB_INT_ENA_SET_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CNTMB_INT_ENA_SET", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CNTMB_INT_SET_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CNTMB_INT_SET", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_cc_cntmbts
{
    ...
    /* struct bdk_gti_cc_cntmbts_s cn8; */
...
static inline uint64_t BDK_GTI_CC_CNTMBTS_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CNTMBTS", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CNTRACC_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CNTRACC", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CNTRATE_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CNTRATE", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_CNTSR_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_CNTSR", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_cc_imp_ctl
{
    ...
    /* struct bdk_gti_cc_imp_ctl_s cn8; */
    /* struct bdk_gti_cc_imp_ctl_s cn9; */
    /* struct bdk_gti_cc_imp_ctl_s cn96xxp1; */
    struct bdk_gti_cc_imp_ctl_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
        uint64_t clk_src               : 1;  /**< [  0:  0](SR/W) Count source clock for GTI_CC_CNTRATE.
    ...
    /* struct bdk_gti_cc_imp_ctl_cn96xxp3 cn98xx; */
    /* struct bdk_gti_cc_imp_ctl_s cnf95xxp1; */
    /* struct bdk_gti_cc_imp_ctl_cn96xxp3 cnf95xxp2; */
    /* struct bdk_gti_cc_imp_ctl_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_CC_IMP_CTL_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_IMP_CTL", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_PIDR0_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_PIDR0", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_cc_pidr1
{
    ...
    /* struct bdk_gti_cc_pidr1_s cn8; */
    /* struct bdk_gti_cc_pidr1_s cn9; */
    /* struct bdk_gti_cc_pidr1_s cn96xxp1; */
    struct bdk_gti_cc_pidr1_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct bdk_gti_cc_pidr1_cn96xxp3 cn98xx; */
    /* struct bdk_gti_cc_pidr1_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_cc_pidr1_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_CC_PIDR1_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_PIDR1", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_cc_pidr2
{
    ...
    /* struct bdk_gti_cc_pidr2_s cn8; */
    struct bdk_gti_cc_pidr2_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](SRO) Architectural revision, as assigned by ARM. */
    ...
    /* struct bdk_gti_cc_pidr2_cn9 cn96xxp1; */
    struct bdk_gti_cc_pidr2_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](SRO) Architectural revision, as assigned by Arm. */
    ...
    /* struct bdk_gti_cc_pidr2_cn96xxp3 cn98xx; */
    /* struct bdk_gti_cc_pidr2_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_cc_pidr2_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_CC_PIDR2_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_PIDR2", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_PIDR3_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_PIDR3", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_cc_pidr4
{
    ...
    /* struct bdk_gti_cc_pidr4_s cn8; */
    /* struct bdk_gti_cc_pidr4_s cn9; */
    /* struct bdk_gti_cc_pidr4_s cn96xxp1; */
    struct bdk_gti_cc_pidr4_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t pagecnt               : 4;  /**< [  7:  4](SRO) Number of log-2 4 KB blocks occupied. */
    ...
    /* struct bdk_gti_cc_pidr4_cn96xxp3 cn98xx; */
    /* struct bdk_gti_cc_pidr4_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_cc_pidr4_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_CC_PIDR4_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_PIDR4", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_PIDR5_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_PIDR5", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_PIDR6_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_PIDR6", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CC_PIDR7_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CC_PIDR7", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CONST_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CONST", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CTL_CIDR0_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_CIDR0", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CTL_CIDR1_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_CIDR1", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CTL_CIDR2_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_CIDR2", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_ctl_cidr3
{
    ...
    /* struct bdk_gti_ctl_cidr3_s cn8; */
    struct bdk_gti_ctl_cidr3_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t preamble              : 8;  /**< [  7:  0](RO) Preamble identification value. */
...
static inline uint64_t BDK_GTI_CTL_CIDR3_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_CIDR3", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CTL_CNTACR0_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_CNTACR0", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CTL_CNTFRQ_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_CNTFRQ", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CTL_CNTNSAR_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_CNTNSAR", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CTL_CNTTIDR_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_CNTTIDR", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CTL_PIDR0_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_PIDR0", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_ctl_pidr1
{
    ...
    /* struct bdk_gti_ctl_pidr1_s cn8; */
    /* struct bdk_gti_ctl_pidr1_s cn9; */
    /* struct bdk_gti_ctl_pidr1_s cn96xxp1; */
    struct bdk_gti_ctl_pidr1_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t idcode                : 4;  /**< [  7:  4](RO) JEP106 identification code \<3:0\>. Marvell (Cavium) code is 0x4C. */
    ...
    /* struct bdk_gti_ctl_pidr1_cn96xxp3 cn98xx; */
    /* struct bdk_gti_ctl_pidr1_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_ctl_pidr1_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_CTL_PIDR1_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_PIDR1", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_ctl_pidr2
{
    ...
    /* struct bdk_gti_ctl_pidr2_s cn8; */
    struct bdk_gti_ctl_pidr2_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by ARM. */
    ...
    /* struct bdk_gti_ctl_pidr2_cn9 cn96xxp1; */
    struct bdk_gti_ctl_pidr2_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by Arm. */
    ...
    /* struct bdk_gti_ctl_pidr2_cn96xxp3 cn98xx; */
    /* struct bdk_gti_ctl_pidr2_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_ctl_pidr2_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_CTL_PIDR2_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_PIDR2", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CTL_PIDR3_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_PIDR3", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_ctl_pidr4
{
    ...
    /* struct bdk_gti_ctl_pidr4_s cn8; */
    /* struct bdk_gti_ctl_pidr4_s cn9; */
    /* struct bdk_gti_ctl_pidr4_s cn96xxp1; */
    struct bdk_gti_ctl_pidr4_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t pagecnt               : 4;  /**< [  7:  4](RO) Number of log-2 4 KB blocks occupied. */
    ...
    /* struct bdk_gti_ctl_pidr4_cn96xxp3 cn98xx; */
    /* struct bdk_gti_ctl_pidr4_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_ctl_pidr4_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_CTL_PIDR4_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_PIDR4", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CTL_PIDR5_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_PIDR5", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CTL_PIDR6_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_PIDR6", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CTL_PIDR7_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CTL_PIDR7", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CWD_DEL3T_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CWD_DEL3T", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CWD_DEL3T_ENA_CLR_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CWD_DEL3T_ENA_CLR", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CWD_DEL3T_ENA_SET_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CWD_DEL3T_ENA_SET", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CWD_DEL3T_SET_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CWD_DEL3T_SET", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CWD_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CWD_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CWD_INT_ENA_CLR_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CWD_INT_ENA_CLR", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CWD_INT_ENA_SET_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CWD_INT_ENA_SET", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_CWD_INT_SET_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_CWD_INT_SET", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_cwd_pokex
{
    ...
    /* struct bdk_gti_cwd_pokex_s cn8; */
    struct bdk_gti_cwd_pokex_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t zero                  : 18; /**< [ 63: 46](WO) Reserved. */
        uint64_t gstop                 : 1;  /**< [ 45: 45](RO/H) Global-stop enable. */
...
static inline uint64_t BDK_GTI_CWD_WDOGX(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_CWD_WDOGX", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_ERR_BIST_STATUS_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_ERR_BIST_STATUS", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_ERR_ECC_DISABLE_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_ERR_ECC_DISABLE", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_ERR_ECC_FLIP_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_ERR_ECC_FLIP", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_ERR_INT_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_ERR_INT", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_ERR_INT_ENA_CLR_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_ERR_INT_ENA_CLR", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_ERR_INT_ENA_SET_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_ERR_INT_ENA_SET", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_ERR_INT_SET_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_ERR_INT_SET", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_FORCE_CLKEN_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_FORCE_CLKEN", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_IMP_CONST_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_IMP_CONST", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_MSIX_PBAX(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_MSIX_PBAX", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_gti_msix_vecx_addr
{
    ...
    /* struct bdk_gti_msix_vecx_addr_s cn96xxp1; */
    struct bdk_gti_msix_vecx_addr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
    ...
    /* struct bdk_gti_msix_vecx_addr_cn96xxp3 cn98xx; */
    /* struct bdk_gti_msix_vecx_addr_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_msix_vecx_addr_cn96xxp3 loki; */
};
...
{
    if (bdk_is_model(OCTEONTX_CN8XXX) && (a<=105))
        return 0x84400f000000ll + 0x10ll * ((a) & 0x7f);
    if (bdk_is_model(OCTEONTX_CN9XXX) && (a<=117))
        return 0x80200f000000ll + 0x10ll * ((a) & 0x7f);
    __bdk_csr_fatal("GTI_MSIX_VECX_ADDR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_MSIX_VECX_CTL(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_MSIX_VECX_CTL", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_RD_CIDR0_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_RD_CIDR0", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_RD_CIDR1_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_RD_CIDR1", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_RD_CIDR2_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_RD_CIDR2", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_rd_cidr3
{
    ...
    /* struct bdk_gti_rd_cidr3_s cn8; */
    struct bdk_gti_rd_cidr3_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t preamble              : 8;  /**< [  7:  0](RO) Preamble identification value. */
...
static inline uint64_t BDK_GTI_RD_CIDR3_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_RD_CIDR3", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_RD_CNTCV_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_RD_CNTCV", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_RD_PIDR0_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_RD_PIDR0", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_rd_pidr1
{
    ...
    /* struct bdk_gti_rd_pidr1_s cn8; */
    /* struct bdk_gti_rd_pidr1_s cn9; */
    /* struct bdk_gti_rd_pidr1_s cn96xxp1; */
    struct bdk_gti_rd_pidr1_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t idcode                : 4;  /**< [  7:  4](RO) JEP106 identification code \<3:0\>. Marvell (Cavium) code is 0x4C. */
    ...
    /* struct bdk_gti_rd_pidr1_cn96xxp3 cn98xx; */
    /* struct bdk_gti_rd_pidr1_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_rd_pidr1_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_RD_PIDR1_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_RD_PIDR1", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_rd_pidr2
{
    ...
    /* struct bdk_gti_rd_pidr2_s cn8; */
    struct bdk_gti_rd_pidr2_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by ARM. */
    ...
    /* struct bdk_gti_rd_pidr2_cn9 cn96xxp1; */
    struct bdk_gti_rd_pidr2_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by Arm. */
    ...
    /* struct bdk_gti_rd_pidr2_cn96xxp3 cn98xx; */
    /* struct bdk_gti_rd_pidr2_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_rd_pidr2_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_RD_PIDR2_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_RD_PIDR2", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_RD_PIDR3_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_RD_PIDR3", 0, 0, 0, 0, 0, 0, 0);
}
...
union bdk_gti_rd_pidr4
{
    ...
    /* struct bdk_gti_rd_pidr4_s cn8; */
    /* struct bdk_gti_rd_pidr4_s cn9; */
    /* struct bdk_gti_rd_pidr4_s cn96xxp1; */
    struct bdk_gti_rd_pidr4_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t pagecnt               : 4;  /**< [  7:  4](RO) Number of log-2 4 KB blocks occupied. */
    ...
    /* struct bdk_gti_rd_pidr4_cn96xxp3 cn98xx; */
    /* struct bdk_gti_rd_pidr4_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_rd_pidr4_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_RD_PIDR4_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_RD_PIDR4", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_RD_PIDR5_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_RD_PIDR5", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_RD_PIDR6_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_RD_PIDR6", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_RD_PIDR7_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_RD_PIDR7", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_SCRATCH_FUNC(void)
{
    ...
    __bdk_csr_fatal("GTI_SCRATCH", 0, 0, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WCX_CIDR0(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_CIDR0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WCX_CIDR1(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_CIDR1", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WCX_CIDR2(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_CIDR2", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_gti_wcx_cidr3
{
    ...
    /* struct bdk_gti_wcx_cidr3_s cn8; */
    struct bdk_gti_wcx_cidr3_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t preamble              : 8;  /**< [  7:  0](RO) Preamble identification value. */
...
static inline uint64_t BDK_GTI_WCX_CIDR3(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_CIDR3", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WCX_PIDR0(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_PIDR0", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_gti_wcx_pidr1
{
    ...
    /* struct bdk_gti_wcx_pidr1_s cn8; */
    /* struct bdk_gti_wcx_pidr1_s cn9; */
    /* struct bdk_gti_wcx_pidr1_s cn96xxp1; */
    struct bdk_gti_wcx_pidr1_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t idcode                : 4;  /**< [  7:  4](RO) JEP106 identification code \<3:0\>. Marvell (Cavium) code is 0x4C. */
    ...
    /* struct bdk_gti_wcx_pidr1_cn96xxp3 cn98xx; */
    /* struct bdk_gti_wcx_pidr1_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_wcx_pidr1_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_WCX_PIDR1(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_PIDR1", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_gti_wcx_pidr2
{
    ...
    /* struct bdk_gti_wcx_pidr2_s cn8; */
    struct bdk_gti_wcx_pidr2_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by ARM. */
    ...
    /* struct bdk_gti_wcx_pidr2_cn9 cn96xxp1; */
    struct bdk_gti_wcx_pidr2_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by Arm. */
    ...
    /* struct bdk_gti_wcx_pidr2_cn96xxp3 cn98xx; */
    /* struct bdk_gti_wcx_pidr2_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_wcx_pidr2_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_WCX_PIDR2(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_PIDR2", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WCX_PIDR3(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_PIDR3", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_gti_wcx_pidr4
{
    ...
    /* struct bdk_gti_wcx_pidr4_s cn8; */
    /* struct bdk_gti_wcx_pidr4_s cn9; */
    /* struct bdk_gti_wcx_pidr4_s cn96xxp1; */
    struct bdk_gti_wcx_pidr4_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t pagecnt               : 4;  /**< [  7:  4](RO) Number of log-2 4 KB blocks occupied. */
    ...
    /* struct bdk_gti_wcx_pidr4_cn96xxp3 cn98xx; */
    /* struct bdk_gti_wcx_pidr4_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_wcx_pidr4_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_WCX_PIDR4(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_PIDR4", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WCX_PIDR5(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_PIDR5", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WCX_PIDR6(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_PIDR6", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WCX_PIDR7(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_PIDR7", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_gti_wcx_w_iidr
{
    ...
    /* struct bdk_gti_wcx_w_iidr_s cn8; */
    /* struct bdk_gti_wcx_w_iidr_s cn9; */
    /* struct bdk_gti_wcx_w_iidr_s cn96xxp1; */
    struct bdk_gti_wcx_w_iidr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t productid             : 8;  /**< [ 31: 24](RO) An implementation defined product number for the device.
                                                                 In CNXXXX, enumerated by PCC_PROD_E. */
    ...
    /* struct bdk_gti_wcx_w_iidr_cn96xxp3 cn98xx; */
    /* struct bdk_gti_wcx_w_iidr_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_wcx_w_iidr_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_WCX_W_IIDR(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_W_IIDR", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_gti_wcx_wcs
{
    ...
    /* struct bdk_gti_wcx_wcs_s cn8; */
    struct bdk_gti_wcx_wcs_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_3_31         : 29;
        uint32_t ws1                   : 1;  /**< [  2:  2](RO/H) WS1. */
...
static inline uint64_t BDK_GTI_WCX_WCS(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_WCS", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WCX_WCV(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_WCV", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WCX_WOR(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WCX_WOR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WRX_CIDR0(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WRX_CIDR0", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WRX_CIDR1(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WRX_CIDR1", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WRX_CIDR2(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WRX_CIDR2", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_gti_wrx_cidr3
{
    ...
    /* struct bdk_gti_wrx_cidr3_s cn8; */
    struct bdk_gti_wrx_cidr3_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t preamble              : 8;  /**< [  7:  0](RO) Preamble identification value. */
...
static inline uint64_t BDK_GTI_WRX_CIDR3(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WRX_CIDR3", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WRX_PIDR0(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WRX_PIDR0", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_gti_wrx_pidr1
{
    ...
    /* struct bdk_gti_wrx_pidr1_s cn8; */
    /* struct bdk_gti_wrx_pidr1_s cn9; */
    /* struct bdk_gti_wrx_pidr1_s cn96xxp1; */
    struct bdk_gti_wrx_pidr1_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t idcode                : 4;  /**< [  7:  4](RO) JEP106 identification code \<3:0\>. Marvell (Cavium) code is 0x4C. */
    ...
    /* struct bdk_gti_wrx_pidr1_cn96xxp3 cn98xx; */
    /* struct bdk_gti_wrx_pidr1_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_wrx_pidr1_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_WRX_PIDR1(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WRX_PIDR1", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_gti_wrx_pidr2
{
    ...
    /* struct bdk_gti_wrx_pidr2_s cn8; */
    struct bdk_gti_wrx_pidr2_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by ARM. */
    ...
    /* struct bdk_gti_wrx_pidr2_cn9 cn96xxp1; */
    struct bdk_gti_wrx_pidr2_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by Arm. */
    ...
    /* struct bdk_gti_wrx_pidr2_cn96xxp3 cn98xx; */
    /* struct bdk_gti_wrx_pidr2_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_wrx_pidr2_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_WRX_PIDR2(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WRX_PIDR2", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WRX_PIDR3(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WRX_PIDR3", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_gti_wrx_pidr4
{
    ...
    /* struct bdk_gti_wrx_pidr4_s cn8; */
    /* struct bdk_gti_wrx_pidr4_s cn9; */
    /* struct bdk_gti_wrx_pidr4_s cn96xxp1; */
    struct bdk_gti_wrx_pidr4_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t pagecnt               : 4;  /**< [  7:  4](RO) Number of log-2 4 KB blocks occupied. */
    ...
    /* struct bdk_gti_wrx_pidr4_cn96xxp3 cn98xx; */
    /* struct bdk_gti_wrx_pidr4_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_wrx_pidr4_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_WRX_PIDR4(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WRX_PIDR4", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WRX_PIDR5(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WRX_PIDR5", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WRX_PIDR6(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WRX_PIDR6", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WRX_PIDR7(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WRX_PIDR7", 1, a, 0, 0, 0, 0, 0);
}
...
union bdk_gti_wrx_w_iidr
{
    ...
    /* struct bdk_gti_wrx_w_iidr_s cn8; */
    /* struct bdk_gti_wrx_w_iidr_s cn9; */
    /* struct bdk_gti_wrx_w_iidr_s cn96xxp1; */
    struct bdk_gti_wrx_w_iidr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t productid             : 8;  /**< [ 31: 24](RO) An implementation defined product number for the device.
                                                                 In CNXXXX, enumerated by PCC_PROD_E. */
    ...
    /* struct bdk_gti_wrx_w_iidr_cn96xxp3 cn98xx; */
    /* struct bdk_gti_wrx_w_iidr_cn96xxp3 cnf95xx; */
    /* struct bdk_gti_wrx_w_iidr_cn96xxp3 loki; */
};
...
static inline uint64_t BDK_GTI_WRX_W_IIDR(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WRX_W_IIDR", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t BDK_GTI_WRX_WRR(unsigned long a)
{
    ...
    __bdk_csr_fatal("GTI_WRX_WRR", 1, a, 0, 0, 0, 0, 0);
}
